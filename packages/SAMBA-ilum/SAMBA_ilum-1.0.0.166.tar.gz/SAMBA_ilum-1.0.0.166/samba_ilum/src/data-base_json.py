...
if os.path.isfile('output/POSCAR'):
   ...
   if (VTemp[0] == 'SAMBA'):
      ...
      #------------------------------------------
      if (n_materials > 1):
         rotate_materials = [];  mismatch_materials = [];  matrix_transf = [];  id_materials = []
         passo = n_materials +1
...
for n in range(2):
    ...
    if (crit == 1):
       ...
       #----------------------------------------------------------------------------------------------------------------------------------------------
       e_vmb = '--';  e_cbm = '--';  e_fermi = '--';  e_vacuum = '--';  work_function = '--';  total_energy = '--';  e_binding = '--';  e_slide = '--'
       ...
       dados0 = {
                ...
                "thickness": thickness  if n_materials > 1 else None,
