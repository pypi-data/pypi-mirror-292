...
if (n_Lattice == 2): check_list.write(f'{Lattice1.replace('.vasp', '')} {Lattice2.replace('.vasp', '')}')
if (n_Lattice == 3): check_list.write(f'{Lattice1.replace('.vasp', '')} {Lattice2.replace('.vasp', '')} {Lattice3.replace('.vasp', '')}')
check_list.close()
