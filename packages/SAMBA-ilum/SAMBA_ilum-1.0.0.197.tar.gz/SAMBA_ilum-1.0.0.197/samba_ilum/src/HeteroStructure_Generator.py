...
for k in range(n_Lattice):
    ...
    cell_Lattice = open(diret + 'Cells_Lattice' + str(k+1) + '_temp.dat', "w")
    #----------------------------------------------------------------------------------------------------
    ...
    #=================================================================================
    def compare_6_decimal(a, b): return np.round(a, 6) == np.round(b, 6)                                 # Função para comparar valores até a 6ª casa decimal
    ...
    for row in data:
        ...
        #---------------------------------------------------------------
        if key1 not in unique_combinations and key2 not in unique_combinations:
           unique_combinations[key1] = row
    # --------------------------------------
