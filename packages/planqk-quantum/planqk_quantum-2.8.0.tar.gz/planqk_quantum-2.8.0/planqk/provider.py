...
from planqk.aws.quera_aquila_device import PlanqkQueraAquilaDevice
from planqk.client.backend_dtos import PROVIDER
...
class PlanqkQuantumProvider:
    def __init__(self, access_token: str = None, organization_id: str = None):
        ...
        """
        self._client = _PlanqkClient(access_token=access_token, organization_id=organization_id)
    ...
    def backends(self, provider: PROVIDER = None, **kwargs):
       ...
       Returns:
           List[Backend]: a list of Backends that match the filtering criteria.
        """
    ...
    def retrieve_job(self, backend: PlanqkQiskitBackend, job_id: str):
        ...
        """
        return PlanqkQiskitJob(backend=backend, job_id=job_id, planqk_client=self._client)
    ...
    def jobs(self) -> List[PlanqkQiskitJob]:
        ...
        return [PlanqkQiskitJob(backend=None, job_id=job_dto.id, job_details=job_dto, planqk_client=self._client) for job_dto
                in job_dtos]
