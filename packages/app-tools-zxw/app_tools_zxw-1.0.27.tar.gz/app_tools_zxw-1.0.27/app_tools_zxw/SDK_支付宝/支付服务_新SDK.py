...
class 支付服务:
    ...
    def __init__(self, app_id: str,
        ...
        #
        # 设置证书路径
        alipay_config.app_private_key_path = key应用私钥路径_pem后缀
        alipay_config.alipay_public_key_cert_path = key支付宝公钥路径_crt后缀
        # alipay_config.app_cert_path = "path/to/your/app_cert.crt"
        # alipay_config.alipay_root_cert_path = "path/to/your/alipay_root_cert.crt"
