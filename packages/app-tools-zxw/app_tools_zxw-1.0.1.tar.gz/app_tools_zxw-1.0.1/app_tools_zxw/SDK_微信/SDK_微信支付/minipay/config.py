...
from config import WeChatMini, WeChatPay
...
class MiniAppsConfig:
    ...
    PAYMENT_NOTIFY_URL = WeChatPay.PAYMENT_NOTIFY_URL
    REFUND_NOTIFY_URL = WeChatPay.REFUND_NOTIFY_URL
    ...
    CERT = 'comm公用SDK/SDK_微信支付/apiclient_cert.pem'
    CERT_KEY = 'comm公用SDK/SDK_微信支付/apiclient_key.pem'
