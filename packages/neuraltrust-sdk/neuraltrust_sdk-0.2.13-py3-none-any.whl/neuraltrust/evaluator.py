...
class Evaluator(BaseEvaluator):
    ...
    _answer_relevancy_failure_threshold: Optional[float] = 0.6
    _faithfulness_failure_threshold: Optional[float] = 0.6
    ...
    def __init__(
        ...
        self._ragas_metric = [answer_correctness, answer_similarity, answer_relevancy, faithfulness]
    ...
    def is_failure(self, metrics) -> bool:
        ...
        threshold_mapping = {
            ...
            MetricType.RAGAS_ANSWER_RELEVANCY.value: self._answer_relevancy_failure_threshold,
            MetricType.RAGAS_FAITHFULNESS.value: self._faithfulness_failure_threshold
        }
