...
from ragas.metrics import answer_correctness, answer_similarity, answer_relevancy, faithfulness, context_recall, context_precision
...
class Evaluator(BaseEvaluator):
    ...
    _answer_relevancy: Optional[float] = 0.6
    _faithfulness: Optional[float] = 0.6
    _context_recall: Optional[float] = 0.6
    _context_precision: Optional[float] = 0.6
    ...
    def __init__(
        ...
        self._ragas_metric = [answer_correctness, answer_similarity, answer_relevancy, faithfulness, context_recall, context_precision]
    ...
    def metric_ids(self) -> List[str]:
        return [
            ...
            MetricType.RAGAS_ANSWER_RELEVANCY.value,
            MetricType.RAGAS_FAITHFULNESS.value,
            MetricType.RAGAS_CONTEXT_RECALL.value,
            MetricType.RAGAS_CONTEXT_PRECISION.value
        ]
    ...
    def generate_data_to_evaluate(self, id, query, response, expected_response, context, metadata, **kwargs) -> dict:
        """
    ...
    def is_failure(self, metrics) -> bool:
        ...
        threshold_mapping = {
            ...
            MetricType.RAGAS_ANSWER_RELEVANCY.value: self._answer_relevancy,
            MetricType.RAGAS_FAITHFULNESS.value: self._faithfulness,
            MetricType.RAGAS_CONTEXT_RECALL.value: self._context_recall,
            MetricType.RAGAS_CONTEXT_PRECISION.value: self._context_precision
        }
