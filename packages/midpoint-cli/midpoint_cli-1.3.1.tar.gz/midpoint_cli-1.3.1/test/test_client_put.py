...
from midpoint_cli.client import MidpointClient, RestApiClient, MidpointUnsupportedOperation, MidpointClientConfiguration
...
class RestApiClientMockup(RestApiClient):
    def __init__(self):
        super().__init__(MidpointClientConfiguration(url='http://mockup/midpoint/',
                                                     username='username',
                                                     password='password'))
