...
import pandas as pd
from delta_sharing import Schema, Share, SharingClient, Table  # type: ignore
...
class TemaAIShareAPI:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.connection_name = load_parameter(connection_name, CONNECTION_KEY)
        self.kwargs = kwargs
        self.host = host
    ...
    def table_schema(self, table: Table, **kwargs: Any) -> List[Column]:
        ...
        """
        with self._table_with_credentials(table) as table:
            return get_table_schema(table, **kwargs)
    ...
    def table_files(self, table: Table, **kwargs: Any) -> List[File]:
        ...
        """
        with self._table_with_credentials(table) as table:
            return get_files_in_table(table, **kwargs)
    ...
    def table_to_pandas(self, table: Table, **kwargs: Any) -> pd.DataFrame:
        ...
        """
        with self._table_with_credentials(table) as table:
            return load_as_pandas(table, **kwargs)
