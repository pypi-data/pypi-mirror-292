...
class SingleUseTemaAIDeltaSharingToken:
    ...
    def __init__(
        ...
        self.host = load_parameter(host, HOST_KEY)
        self.client_id = load_parameter(client_id, CLIENT_ID_KEY)
        self.client_secret = load_parameter(client_secret, CLIENT_SECRET_KEY)
