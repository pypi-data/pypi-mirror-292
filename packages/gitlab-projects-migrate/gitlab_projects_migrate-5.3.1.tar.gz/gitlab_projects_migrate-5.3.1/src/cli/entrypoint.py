...
class Entrypoint:
    ...
    def cli(
        ...
        output_gitlab_id: str = f'{output_gitlab_splits.netloc}'
        output_gitlab_url: str = f'{output_gitlab_splits.scheme}://{output_gitlab_splits.netloc}'
        output_gitlab_namespace: str = output_gitlab_splits.path.lstrip('/')
