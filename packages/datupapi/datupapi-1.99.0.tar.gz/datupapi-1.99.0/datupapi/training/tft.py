                ...
                if self.use_location:
                    ...
                    for column in Qdisc.columns[3:]:
                        if Qdisc[column].dtype == 'O':
                            ...
                            unknown.append(column)
                    data1 = pd.merge_ordered(data1, Qdisc, on=["timestamp", "item_id", "location"], suffixes=["", "-disc"], fill_method=None, how="left")
                else:
                    for column in Qdisc.columns[2:]:
                        if Qdisc[column].dtype == 'O':
                            categorical.append(column)
                            ...
                            unknown.append(column)
                    data1 = pd.merge_ordered(data1, Qdisc, on=["timestamp", "item_id"], suffixes=["", "-disc"], fill_method=None, how="left")
