...
class Lang(LangBase):
    ...
    * Le séparateur lui-même doit commencer par `#` et avoir au moins 6 caractères (hors espaces).
    ...
    """###
    unforgettable: Tr = Msg("N'oubliez pas de faire une validation !")    ###
    """
