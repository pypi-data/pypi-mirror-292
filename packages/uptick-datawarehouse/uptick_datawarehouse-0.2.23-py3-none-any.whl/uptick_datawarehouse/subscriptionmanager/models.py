...
class RollForwardSummary(models.Model):
    ...
    subscription_guid = models.UUIDField()
    currency = models.CharField(max_length=3)
    won_mrr = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    contracted_mrr = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    user_expansion = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    user_expansion_mom = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    upgrade = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    downgrade = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    upgrade_or_downgrade = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    churn_from_live = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    churn_from_not_live = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    billable_mrr = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    mmr_transfered = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    contracted_discount_mrr = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    delayed_onboarding_mrr = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    other_credit_mrr = models.DecimalField(max_digits=10, decimal_places=2, default=decimal.Decimal("0.00"))
    note = models.TextField(blank=True)
