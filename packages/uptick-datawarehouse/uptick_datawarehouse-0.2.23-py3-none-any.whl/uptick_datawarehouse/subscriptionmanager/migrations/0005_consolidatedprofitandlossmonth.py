    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporting_fx_rate', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=10)),
                ('reporting_subtotal', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=10)),
