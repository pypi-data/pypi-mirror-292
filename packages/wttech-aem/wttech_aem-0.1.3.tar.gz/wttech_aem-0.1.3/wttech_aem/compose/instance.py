...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 client: Optional[pulumi.Input[Union['ClientArgs', 'ClientArgsDict']]] = None,
                 compose: Optional[pulumi.Input[Union['ComposeArgs', 'ComposeArgsDict']]] = None,
                 files: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 system: Optional[pulumi.Input[Union['SystemArgs', 'SystemArgsDict']]] = None,
                 __props__=None):
        """
        Create a Instance resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Union['ClientArgs', 'ClientArgsDict']] client: Connection settings used to access the machine on which the AEM instance will be running.
        :param pulumi.Input[Union['ComposeArgs', 'ComposeArgsDict']] compose: AEM Compose CLI configuration. See documentation(https://github.com/wttech/aemc#configuration).
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] files: Files or directories to be copied into the machine.
        :param pulumi.Input[Union['SystemArgs', 'SystemArgsDict']] system: Operating system configuration for the machine on which AEM instance will be running.
        """
        ...
    @overload
    def __init__(__self__,
