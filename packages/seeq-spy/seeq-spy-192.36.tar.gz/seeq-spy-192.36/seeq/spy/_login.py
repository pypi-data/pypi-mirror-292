...
def _retrieve_default_request_origin(session: Session, status: Status) -> Optional[RequestOrigin]:
    ...
    if not request_origin_url:
        ...
        status.warn('request_origin_url argument was not specified. Please add this argument to your spy.login() '
                    f'call:\nrequest_origin_url="{unique_id}"). Do not reuse this unique ID for multiple scripts.')
