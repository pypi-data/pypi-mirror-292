...
[aiobotocore.PaymentCryptographyControlPlane 2.13.3](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/payment-cryptography.html#PaymentCryptographyControlPlane)
