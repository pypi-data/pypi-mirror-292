...
class MLOpsScoringDeployment:
    ...
    def _get_raw_info(self) -> Any:
        for (
            ...
            if deployment.id == self.uid:
                return MLOpsScoringDeployment._patch_single_deployment(deployment)
    ...
    @staticmethod
    def _patch_single_deployment(deployment: Any) -> Any:
        single_deployment = deployment.single_deployment
        ...
        deployment.single_deployment = single_deployment
        return deployment
