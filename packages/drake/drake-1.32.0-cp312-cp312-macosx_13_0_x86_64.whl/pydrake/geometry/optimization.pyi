...
class GraphOfConvexSets:
    class Edge:
        ...
        @overload
        def AddCost(self, e: pydrake.symbolic.Expression, use_in_transcription: set[GraphOfConvexSets.Transcription] = ...) -> tuple[pydrake.symbolic.Variable, pydrake.solvers.BindingTCostU]: ...
        @overload
        def AddCost(self, binding: pydrake.solvers.BindingTCostU, use_in_transcription: set[GraphOfConvexSets.Transcription] = ...) -> tuple[pydrake.symbolic.Variable, pydrake.solvers.BindingTCostU]: ...
