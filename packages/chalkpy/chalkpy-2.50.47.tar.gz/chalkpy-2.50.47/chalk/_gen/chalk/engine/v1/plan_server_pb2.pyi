...
class GetPlanRequest(_message.Message):
    ...
    def __init__(
        self,
        online_query_request: _Optional[
            _Union[_online_query_pb2.OnlineQueryRequest, _Mapping]
        ] = ...,
    ) -> None: ...
...
class GetPlanResponse(_message.Message):
    ...
    plan: _plan_pb2.Plan
    def __init__(
        self, plan: _Optional[_Union[_plan_pb2.Plan, _Mapping]] = ...
    ) -> None: ...
...
class ExecuteQueryResponse(_message.Message):
    ...
    def __init__(
        self,
        online_query_response: _Optional[
            _Union[_online_query_pb2.OnlineQueryResponse, _Mapping]
        ] = ...,
    ) -> None: ...
