...
class MetadataSettings(_message.Message):
    ...
    missing: str
    def __init__(
        self, name: _Optional[str] = ..., missing: _Optional[str] = ...
    ) -> None: ...
...
class FeatureSettings(_message.Message):
    ...
    def __init__(
        self, metadata: _Optional[_Iterable[_Union[MetadataSettings, _Mapping]]] = ...
    ) -> None: ...
...
class ChalkpyInfo(_message.Message):
    ...
    python: str
    def __init__(
        self, version: _Optional[str] = ..., python: _Optional[str] = ...
    ) -> None: ...
