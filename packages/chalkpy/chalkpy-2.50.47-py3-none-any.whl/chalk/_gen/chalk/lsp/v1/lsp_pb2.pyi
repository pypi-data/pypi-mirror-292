...
class LSP(_message.Message):
    ...
    def __init__(
        self,
        diagnostics: _Optional[
            _Iterable[_Union[PublishDiagnosticsParams, _Mapping]]
        ] = ...,
...
class Diagnostic(_message.Message):
    ...
    related_information: _containers.RepeatedCompositeFieldContainer[
    ...
    def __init__(
        ...
        related_information: _Optional[
            _Iterable[_Union[DiagnosticRelatedInformation, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class Range(_message.Message):
    ...
    def __init__(
        self,
        start: _Optional[_Union[Position, _Mapping]] = ...,
        end: _Optional[_Union[Position, _Mapping]] = ...,
    ) -> None: ...
...
class Position(_message.Message):
    ...
    character: int
    def __init__(
        self, line: _Optional[int] = ..., character: _Optional[int] = ...
    ) -> None: ...
...
class WorkspaceEdit(_message.Message):
    ...
    def __init__(
        self,
        document_changes: _Optional[
            _Iterable[_Union[TextDocumentEdit, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class Location(_message.Message):
    ...
    range: Range
    def __init__(
        self, uri: _Optional[str] = ..., range: _Optional[_Union[Range, _Mapping]] = ...
    ) -> None: ...
