...
class OfflineQueryRecomputeFeatures(_message.Message):
    ...
    def __init__(
        self,
        all_or_none: bool = ...,
        feature_list: _Optional[
            _Union[OfflineQueryRecomputeFeatures.FeatureList, _Mapping]
        ] = ...,
    ) -> None: ...
...
class OfflineQueryExplain(_message.Message):
    ...
    def __init__(
        self,
        truthy: bool = ...,
        only: _Optional[_Union[OfflineQueryExplain.Only, _Mapping]] = ...,
    ) -> None: ...
...
class OfflineQueryRequest(_message.Message):
    ...
    filters: _containers.RepeatedCompositeFieldContainer[
        _expression_pb2.LogicalExprNode
    ]
    max_samples: int
    ...
    def __init__(
        ...
        recompute_features: _Optional[
            _Union[OfflineQueryRecomputeFeatures, _Mapping]
        ] = ...,
        store_plan_stages: bool = ...,
        filters: _Optional[
            _Iterable[_Union[_expression_pb2.LogicalExprNode, _Mapping]]
        ] = ...,
...
class ColumnMetadataList(_message.Message):
    ...
    def __init__(
        self,
        metadata: _Optional[
            _Iterable[_Union[ColumnMetadataList.ColumnMetadata, _Mapping]]
        ] = ...,
    ) -> None: ...
