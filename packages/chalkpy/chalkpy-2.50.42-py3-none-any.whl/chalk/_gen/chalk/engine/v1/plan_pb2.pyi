...
class HasManyFeatureKey(_message.Message):
    ...
    def __init__(
        self,
        root_fqn: _Optional[str] = ...,
        df: _Optional[_Union[DataFrame, _Mapping]] = ...,
    ) -> None: ...
...
class DataFrame(_message.Message):
    ...
    def __init__(
        ...
        optional_columns: _Optional[
            _Iterable[_Union[FeatureColumnKey, _Mapping]]
        ] = ...,
...
class PyArrowSchema(_message.Message):
    ...
    class TableSchema(_message.Message):
        ...
        class SchemaEntry(_message.Message):
            ...
            def __init__(
                self,
                key: _Optional[str] = ...,
                value: _Optional[_Union[_arrow_pb2.ArrowType, _Mapping]] = ...,
            ) -> None: ...
    ...
    def __init__(
        self,
        scalars: _Optional[
            _Iterable[_Union[PyArrowSchema.ColumnSchema, _Mapping]]
        ] = ...,
...
class Node(_message.Message):
    ...
    def __init__(
        self,
        children_indices: _Optional[_Iterable[int]] = ...,
        impl: _Optional[_Union[NodeImpl, _Mapping]] = ...,
    ) -> None: ...
...
class GivensScan(_message.Message):
    ...
    def __init__(
        self, fields: _Optional[_Iterable[_Union[Key, _Mapping]]] = ...
    ) -> None: ...
...
class ChalkProject(_message.Message):
    ...
    def __init__(
        self,
        fields: _Optional[_Iterable[_Union[Key, _Mapping]]] = ...,
        promote_ts_to_feature_time: bool = ...,
    ) -> None: ...
...
class DefaultInjector(_message.Message):
    ...
    def __init__(
        self, defaulting_features: _Optional[_Iterable[_Union[Key, _Mapping]]] = ...
    ) -> None: ...
