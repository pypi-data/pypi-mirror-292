...
class PagerDutyEventV2Link(_message.Message):
    ...
    text: str
    def __init__(
        self, href: _Optional[str] = ..., text: _Optional[str] = ...
    ) -> None: ...
...
class GetPagerDutyIntegrationResponse(_message.Message):
    ...
    def __init__(
        self, integration: _Optional[_Union[PagerDutyIntegration, _Mapping]] = ...
    ) -> None: ...
...
class TestPagerDutyIntegrationResponse(_message.Message):
    ...
    message: str
    def __init__(
        self, status: _Optional[str] = ..., message: _Optional[str] = ...
    ) -> None: ...
...
class AddPagerDutyIntegrationRequest(_message.Message):
    ...
    token: str
    def __init__(
        self, name: _Optional[str] = ..., token: _Optional[str] = ...
    ) -> None: ...
...
class GetAllPagerDutyIntegrationsResponse(_message.Message):
    ...
    def __init__(
        ...
        integrations: _Optional[
            _Iterable[_Union[PagerDutyIntegration, _Mapping]]
        ] = ...,
    ) -> None: ...
