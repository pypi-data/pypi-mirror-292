...
class GetQueryValuesRequest(_message.Message):
    ...
    def __init__(
        self,
        operation_id_identifier: _Optional[
            _Union[OperationIdTableIdentifier, _Mapping]
        ] = ...,
        table_name_identifier: _Optional[
            _Union[TableNameTableIdentifier, _Mapping]
        ] = ...,
...
class GetQueryValuesResponse(_message.Message):
    ...
    parquet: bytes
    def __init__(
        self, next_page_token: _Optional[str] = ..., parquet: _Optional[bytes] = ...
    ) -> None: ...
