...
class DatasetFeatureOperand(_message.Message):
    ...
    feature: str
    def __init__(
        self, dataset: _Optional[str] = ..., feature: _Optional[str] = ...
    ) -> None: ...

class MetricFormula(_message.Message):
    __slots__ = (
        "kind",
        "single_series_operands",
        "multi_series_operands",
        "dataset_feature_operands",
        "name",
    )
    ...
    def __init__(
        ...
        dataset_feature_operands: _Optional[
            _Union[DatasetFeatureOperand, _Mapping]
        ] = ...,
        name: _Optional[str] = ...,
    ) -> None: ...
