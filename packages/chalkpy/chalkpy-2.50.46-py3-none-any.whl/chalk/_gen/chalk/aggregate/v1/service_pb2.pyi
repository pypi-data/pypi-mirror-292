...
class GetAggregateBackfillJobsResponse(_message.Message):
    ...
    jobs: _containers.RepeatedCompositeFieldContainer[
        _backfill_pb2.AggregateBackfillJob
    ]
    cursor: str
    def __init__(
        self,
        jobs: _Optional[
            _Iterable[_Union[_backfill_pb2.AggregateBackfillJob, _Mapping]]
        ] = ...,
...
class GetAggregateBackfillJobResponse(_message.Message):
    ...
    def __init__(
        self, job: _Optional[_Union[_backfill_pb2.AggregateBackfillJob, _Mapping]] = ...
    ) -> None: ...
