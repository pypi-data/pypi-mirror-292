...
_ETHERCAT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SetServoMaxMotorSpeed',
    full_name='Nrmk.IndyFramework.EtherCAT.SetServoMaxMotorSpeed',
    index=16,
    containing_service=None,
