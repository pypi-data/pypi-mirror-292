...
class YtChannel(BaseModel):
    ...
    video_count: Optional[StrictInt] = None
    view_count: Optional[StrictInt] = None
    thumbnails: Optional[Dict[str, YtThumbnail]] = None
    __properties: ClassVar[List[str]] = ["id", "title", "description", "url", "banner_url", "comment_count", "subscriber_count", "video_count", "view_count", "thumbnails"]
