...
def SubscriberFun(debug, localHostUDP_IP, subscriberUDP_PORT, subscriberUDP_PORT2, my_id, numMuscles, ids_dict, stopEvent, tcpDataSub):
    def log(msg):
        if debug:
            print(msg)
...
def createPromptGUI():
    ...
    def connect():
        ...
        if localTesting:
            ...
            processes.append(Process(target=SubscriberFun, args=(debug, localHostUDP_IP, subscriberUDP_PORT,subscriberUDP_PORT2, name, numMuscles, checkbox_dict, stopEvent, tcpDataSub)))
