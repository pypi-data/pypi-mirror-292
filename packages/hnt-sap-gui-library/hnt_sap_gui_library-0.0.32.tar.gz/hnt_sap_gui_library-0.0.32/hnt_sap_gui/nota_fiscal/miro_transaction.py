...
class MiroTransaction:
    ...
    def execute(self, sapGuiLib, data, numero_pedido):
        ...
        for i, sintese_item in enumerate(data['sintese']):
            sapGuiLib.session.findById(f"wnd[0]/usr/tabsTABSTRIP1/tabpTAB1/ssubHEADER_TAB:SAPLJ1BB2:2100/tblSAPLJ1BB2ITEM_CONTROL/ctxtJ_1BDYLIN-CFOP[9,{i}]").Text = sintese_item['CFOP']  #CFOP
