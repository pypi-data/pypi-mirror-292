...
| **init**            | Initialize navamai in any folder. Copies `navamai.yml` default config and quick start intents. Checks before overwriting. Other user with --force option.                         | `navamai init`                  |
