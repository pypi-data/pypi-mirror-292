...
| **config**         | Edit `navamai.yml` file config from command line                                            | `navamai config ask save true`                |
...
| **init**            | Initialize navamai in any folder. Copies `navamai.yml` default config and quick start Intents and Embeds folders and files. Checks before overwriting. Add --force option to force overwrite files and folders.                         | `navamai init`                  |
