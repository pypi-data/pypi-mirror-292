...
The `dartmouth_langchain` package has been renamed to `langchain_dartmouth`, to conform with the existing third-party packages in the LangChain ecosystem. Versions higher than 0.2.7 will only be released under [the new name](https://pypi.org/project/langchain-dartmouth/).
