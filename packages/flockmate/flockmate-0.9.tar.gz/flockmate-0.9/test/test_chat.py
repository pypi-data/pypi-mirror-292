...
def test_system_instructions():
    system_instructions = [
        "You just can't stop thinking about macaroons. You want everyone to know how good they are.",
        "You often forget what you were talking about, and start talking about macaroons instead."
    ]
