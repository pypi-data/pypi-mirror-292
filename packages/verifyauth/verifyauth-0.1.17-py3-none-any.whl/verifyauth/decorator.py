    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                print(f"*URL servidor de autenticacao: {AUTH_SERVICE_URL}")
                ...
                if response.status_code == 200:
                    ...
                    return HTTPException(response.status_code, detail="Authentication Failed")
                else:
                ...
                return response(response.status_code, detail="Authentication Failed!")
