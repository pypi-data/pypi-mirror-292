...
/* harmony import */ var _style_icons_slack_svg__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../style/icons/slack.svg */ "./style/icons/slack.svg");
...
const slackIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
    ...
    svgstr: _style_icons_slack_svg__WEBPACK_IMPORTED_MODULE_13__
});
...
/* harmony export */   slackIcon: () => (/* reexport safe */ _icons__WEBPACK_IMPORTED_MODULE_10__.slackIcon),
    ...
    render() {
        ...
        const AlertBox = () => {
            ...
            return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { role: "alert", className: "mt-5 rounded-xl border border-gray-100 bg-white p-4" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flex items-start gap-4" },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", { className: "text-primary" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flex-1" },
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("h2", { className: "block font-bold text-black-900" }, "About"),
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "mt-1 text-sm text-gray-700" },
                            ...
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { href: "https://github.com/amphi-ai/amphi-etl", target: "_blank", className: "text-primary underline" }, "Learn more."))),
        ...
        return (react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "jp-Launcher-body" },
            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "jp-Launcher-content" },
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("h1", { className: "mt-8 text-2xl font-bold sm:text-3xl flex items-center text-gray-900" }, "Amphi ETL"),
                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "mt-12 grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8" },
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "rounded-sm bg-white p-4" },
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flex items-center gap-4" },
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", null,
                                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("h3", { className: "text-xl font-bold text-gray-900 sm:text-3xl" }, "Start"),
                                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flow-root" },
                                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("ul", { className: "-m-1 flex flex-wrap" },
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("li", { className: "p-1 leading-none" },
                                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { href: "https://docs.amphi.ai/category/getting-started", target: "_blank", className: "text-xs font-medium text-primary" }, "Getting Started")))))),
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("ul", { className: "mt-4 space-y-2" },
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("li", null,
                                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { href: "#", onClick: handleNewPipelineClick, className: "block h-full rounded-sm border border-gray-100 p-4 hover:border-pastel hover:bg-grey flex items-center gap-4" },
                                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flex items-center justify-center w-16 h-16 rounded-full" },
                                    ...
                                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", null,
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("strong", { className: "font-bold text-primary" }, "New pipeline"),
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "mt-1 text-xs font-medium" }, "Open a new untitled pipeline and drag and drop components to design and develop your data flow.")))))),
                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "rounded-sm bg-white p-4" },
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flex items-center gap-4" },
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", null,
                                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("h3", { className: "text-xl font-bold text-gray-900 sm:text-3xl" }, "Resources"),
                                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flow-root" },
                                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("ul", { className: "-m-1 flex flex-wrap" },
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("li", { className: "p-1 leading-none" },
                                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { href: "https://docs.amphi.ai/", target: "_blank", className: "text-xs font-medium text-primary" }, "Documentation")))))),
                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("ul", { className: "mt-4 space-y-2" },
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("li", null,
                                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { href: "https://github.com/amphi-ai/amphi-etl", target: "_blank", className: "block h-full rounded-sm border border-gray-100 p-4 hover:border-pastel hover:bg-grey flex items-center gap-4" },
                                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flex items-center justify-center w-16 h-16 rounded-full" },
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_icons__WEBPACK_IMPORTED_MODULE_3__.githubIcon.react, null)),
                                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", null,
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("strong", { className: "font-bold text-primary" }, "Issues and feature requests"),
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "mt-1 text-xs font-medium" }, "Report issues and suggest features on GitHub. Don't hesitate to star the repository to watch the repository.")))),
                            react__WEBPACK_IMPORTED_MODULE_2___default().createElement("li", null,
                                react__WEBPACK_IMPORTED_MODULE_2___default().createElement("a", { href: "https://join.slack.com/t/amphi-ai/shared_invite/zt-2ci2ptvoy-FENw8AW4ISDXUmz8wcd3bw", target: "_blank", className: "block h-full rounded-sm border border-gray-100 p-4 hover:border-pastel hover:bg-grey flex items-center gap-4" },
                                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", { className: "flex items-center justify-center w-16 h-16 rounded-full" },
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_icons__WEBPACK_IMPORTED_MODULE_3__.slackIcon.react, null)),
                                    react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", null,
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("strong", { className: "font-bold text-primary" }, "Join the Community"),
                                        react__WEBPACK_IMPORTED_MODULE_2___default().createElement("p", { className: "mt-1 text-xs font-medium" }, "Join Amphi's community on Slack: seek help, ask questions and share your experience."))))))))));
    }
}
...
//# sourceMappingURL=lib_index_js.ebc6eeefe30febf7d4cf.js.map