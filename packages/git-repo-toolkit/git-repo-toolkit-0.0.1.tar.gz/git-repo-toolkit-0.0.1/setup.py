...
setup(
    name='git-repo-toolkit',
    version='0.0.1',
    packages=['git_repo_toolkit'],
    install_requires=load_requirements('requirements/base.in'),
    author='Farhan',
    author_email='mfarhan133@gmail.com',
    description='git-repo-toolkit is your all-in-one solution for optimizing GitHub workflows',
    url='https://github.com/farhan/git-repo-toolkit',
    classifiers=[
