...
class DatalakeClient:
    ...
    def get_item_details(self, unique_name: str, filter: dict,chat_id:str):
        ...
        payload = {"uniqueFileName": unique_name, "requiredMetaObj": filter, "conversationId": chat_id}
    ...
    """
    def find_elements_from_docs(self, unique_name_list: List[str], user_question: str, is_target_documents_available: bool, chat_id: str):
        payload = {
    ...
    """
    def extract_doc_content(self, doc_elements: dict, extraction_keys: List[dict], user_question: str,chat_id: str):
        payload = {
            "userQuestion": user_question,
