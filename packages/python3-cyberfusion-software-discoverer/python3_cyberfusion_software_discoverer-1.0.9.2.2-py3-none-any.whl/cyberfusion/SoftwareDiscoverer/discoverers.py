...
class Fail2banDiscoverer(Discoverer):
    ...
    def discover(self) -> bool:
        """Discover."""
        return os.path.exists(os.path.join(paths.PATH_USR_BIN, "fail2ban-server"))
...
class FastRedirectDiscoverer(Discoverer):
    ...
    def discover(self) -> bool:
        """Discover."""
        return os.path.exists(
            os.path.join(os.path.sep, "opt", "fast-redirect", "bin", "fast-redirect")
        )
...
class NullmailerDiscoverer(Discoverer):
    ...
    def discover(self) -> bool:
        """Discover."""
        return os.path.exists(os.path.join(paths.PATH_USR_SBIN, "nullmailer-send"))
...
class RabbitMQConsumeDiscoverer(Discoverer):
    ...
    def discover(self) -> bool:
        """Discover."""
        return os.path.exists(os.path.join(paths.PATH_USR_BIN, "rabbitmq-consumer"))
...
class SambaDiscoverer(Discoverer):
    ...
    def discover(self) -> bool:
        """Discover."""
        return os.path.exists(os.path.join(os.path.sep, "etc", "samba", "smb.conf"))
    ...
    def _has_is_active_directory_domain_controller_trait(self) -> bool:
        ...
        return config["global"]["server role"] == "active directory domain controller"
