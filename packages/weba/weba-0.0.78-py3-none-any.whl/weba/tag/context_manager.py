...
class TagContextManager(TagMixins):
    ...
    def _tag_context_manager(self, tag: Tag) -> "TagContextManager":
        return tag if self._weba_html_context._context_stack else TagContextManager(tag, self._weba_html_context, self._component)  # type: ignore (we need to access private property)
