...
class MongodbatlasProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#alias MongodbatlasProvider#alias}
        :param assume_role: assume_role block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#assume_role MongodbatlasProvider#assume_role}
        :param aws_access_key_id: AWS API Access Key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#aws_access_key_id MongodbatlasProvider#aws_access_key_id}
        :param aws_secret_access_key: AWS API Access Secret Key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#aws_secret_access_key MongodbatlasProvider#aws_secret_access_key}
        :param aws_session_token: AWS Security Token Service provided session token. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#aws_session_token MongodbatlasProvider#aws_session_token}
        :param base_url: MongoDB Atlas Base URL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#base_url MongodbatlasProvider#base_url}
        :param is_mongodbgov_cloud: MongoDB Atlas Base URL default to gov. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#is_mongodbgov_cloud MongodbatlasProvider#is_mongodbgov_cloud}
        :param private_key: MongoDB Atlas Programmatic Private Key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#private_key MongodbatlasProvider#private_key}
        :param public_key: MongoDB Atlas Programmatic Public Key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#public_key MongodbatlasProvider#public_key}
        :param realm_base_url: MongoDB Realm Base URL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#realm_base_url MongodbatlasProvider#realm_base_url}
        :param region: Region where secret is stored as part of AWS Secret Manager. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#region MongodbatlasProvider#region}
        :param secret_name: Name of secret stored in AWS Secret Manager. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#secret_name MongodbatlasProvider#secret_name}
        :param sts_endpoint: AWS Security Token Service endpoint. Required for cross-AWS region or cross-AWS account secrets. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#sts_endpoint MongodbatlasProvider#sts_endpoint}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing MongodbatlasProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#import import section} in the documentation of this resource for the id to use
...
class MongodbatlasProviderAssumeRole:
    def __init__(
        ...
        *,
        ...
        '''
        :param duration: The duration, between 15 minutes and 12 hours, of the role session. Valid time units are ns, us (or µs), ms, s, h, or m. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#duration MongodbatlasProvider#duration}
        :param external_id: A unique identifier that might be required when you assume a role in another account. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#external_id MongodbatlasProvider#external_id}
        :param policy: IAM Policy JSON describing further restricting permissions for the IAM Role being assumed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#policy MongodbatlasProvider#policy}
        :param policy_arns: Amazon Resource Names (ARNs) of IAM Policies describing further restricting permissions for the IAM Role being assumed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#policy_arns MongodbatlasProvider#policy_arns}
        :param role_arn: Amazon Resource Name (ARN) of an IAM Role to assume prior to making API calls. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#role_arn MongodbatlasProvider#role_arn}
        :param session_name: An identifier for the assumed role session. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#session_name MongodbatlasProvider#session_name}
        :param source_identity: Source identity specified by the principal assuming the role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#source_identity MongodbatlasProvider#source_identity}
        :param tags: Assume role session tags. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#tags MongodbatlasProvider#tags}
        :param transitive_tag_keys: Assume role session tag keys to pass to any subsequent sessions. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.1/docs#transitive_tag_keys MongodbatlasProvider#transitive_tag_keys}
        '''
        if __debug__:
