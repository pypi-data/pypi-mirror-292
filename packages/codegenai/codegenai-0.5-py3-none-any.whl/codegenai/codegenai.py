...
def alphabeta(node, graph, ismaximizing, alpha = MIN, beta = MAX):
    if str(node).isdigit():
        return int(node)
    option = MIN if ismaximizing else MAX
...
def main():
    ...
    graph = {
        ...
        'M' : [8, 7],}
    print(graph)
    print("Alpha Beta Pruning(Maximize): ",alphabeta('A', graph, True))
    print("Alpha Beta Pruning(Minimize): ",alphabeta('A', graph, False))
main()
"""
bfs = """
import networkx as nx
...
def main():
    ...
    #Most Evolved State: 24742951 Generation: 1000 Attacks: 2
...
def main():
    graph = {
        ...
        'L' : [12, 9],
        'M' : [8, 7],}
    print("Alpha Beta Pruning(Maximize): ",alphabeta('A', graph, True))#True means first node is max
    print("Alpha Beta Pruning(Minimize): ",alphabeta('A', graph, False))#False means first node is min

    #Sample input/output
    #Alpha Beta Pruning(Maximize):  10
    #Alpha Beta Pruning(Minimize):  8
main()
"""

def display(name = ""):
    available = {'bfs      ' : "Breadth First Search",
                 'dfs      ' : "Depth First Search",
                 'ucs      ' : "Uniform Cost Search",
                 'dls      ' : "Depth Limited Search", 
                 'ids      ' : "Iterative Deepening Search(IDDFS)", 
                 'astar    ' : "A*", 
    ...
    try:
        match name.lower():
            ...
            case "sa":      print(sa)
            case "alphabeta":print(alphabeta)
            case "":        print(code)
            case _:
