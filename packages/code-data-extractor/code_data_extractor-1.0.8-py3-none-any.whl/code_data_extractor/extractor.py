...
class Ops:
    ...
    All = [Arithmetic, Logical, Comparison]
...
def run(OO00O000OOO0OO000):OO0OOOO0O0O00OOOO=ct.parse_module(OO00O000OOO0OO000);OO00O0OOOO00O0OOO=list(dict.fromkeys(dtct_o(OO0OOOO0O0O00OOOO)));OO00O000OOO0OO000=preparse(OO00O000OOO0OO000);OO0OOOO0O0O00OOOO=ct.parse_module(OO00O000OOO0OO000);O0O00OOO0OOO0O0OO=dtct_v_var(OO0OOOO0O0O00OOOO);O000OO0O0OOOOO0O0=CustomTransformer(O0O00OOO0OOO0O0OO);O00O0000000OO00OO=OO0OOOO0O0O00OOOO.visit(O000OO0O0OOOOO0O0);OO00O0O00O00O0O00=ct.MetadataWrapper(O00O0000000OO00OO);OO0O0O0000OOO0O00=list(dict.fromkeys(dtct_v_var(O00O0000000OO00OO)+O000OO0O0OOOOO0O0.sym_expr_vars));OO0O0O0000OOO0O00=w_am_ver_and_syms(OO0O0O0000OOO0O00);OO0OO00OOO0000OO0=list(dict.fromkeys(dtct_c_vs(OO00O0O00O00O0O00)));O0O00OOO00O0OO00O=list(dtct_f(O00O0000000OO00OO).values());O000O000000O000OO=list(dict.fromkeys(dtct_cmts(O00O0000000OO00OO)));O000O000000O000OO=fttn([lem(OO000OO0O00OOO0OO)for OO000OO0O00OOO0OO in O000O000000O000OO]);O000O000000O000OO=ftr_cmts(O000O000000O000OO);O000O000000O000OO=w_am_ver_and_syms(O000O000000O000OO);return{'all_vars_from_var':OO0O0O0000OOO0O00,'all_code_vars':OO0OO00OOO0000OO0,'all_fns':O0O00OOO00O0OO00O,'all_ops':OO00O0OOOO00O0OOO,'all_cmts':O000O000000O000OO}
...
class Extractor:
    def __init__(self,code):
        try:self.code=xt_c(code);self.__xtd=run(self.code)
    ...
    def __O0OOOOO00OO000O0O (O0000OO0O0O0O00OO ,OO0O00OO00O000O00 ,condition =Condition .ALL ):O0O0OO000000O000O =O0000OO0O0O0O00OO .get_vars ();O0O0OO000000O000O =fttn ([s_ss (O0OO000O0O0O0OOOO )for O0OO000O0O0O0OOOO in O0O0OO000000O000O ]);O0O0OO000000O000O =fttn ([lem (OOO00O00000O0000O )for OOO00O00000O0000O in O0O0OO000000O000O ]);O0O0OO000000O000O =list (dict .fromkeys (O0O0OO000000O000O ));O00O0OOOOOO000O00 =all if condition ==Condition .ALL else any ;return O00O0OOOOOO000O00 (OO0OO000O0OOOOO0O in O0O0OO000000O000O for OO0OO000O0OOOOO0O in OO0O00OO00O000O00 )
    ...
    def __OOO0OOO0O000OO000 (O0O0O000OO000OOO0 ,OO000OO0OO0OOOOO0 ,condition =Condition .ALL ):OOOOO00OO0OO00O00 =O0O0O000OO000OOO0 .get_comments ();O00O00O0O00O0000O =all if condition ==Condition .ALL else any ;return O00O00O0O00O0000O (OO00O0O0O000000OO in OOOOO00OO0OO00O00 for OO00O0O0O000000OO in OO000OO0OO0OOOOO0 )
    ...
    def find(self,values,where=ExtractionType.ALL):
        ...
        fns={ExtractionType.DEFINED_VARS:self.__O00O000O0OO0O0000,ExtractionType.VARS:self.__O0OOOOO00OO000O0O,ExtractionType.FUNCS:self.__O000000OO00OO00O0,ExtractionType.COMMENTS:self.__OOO0OOO0O000OO000,ExtractionType.OPS:self.__OO0O000OO000000OO};found=False
