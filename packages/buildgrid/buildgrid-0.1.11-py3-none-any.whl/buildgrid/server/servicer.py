...
from typing import Any, Callable, ClassVar, Dict, Generic, Optional, TypeVar, cast
...
class InstancedServicer(ABC, Generic[_Instance]):
    ...
    def cast(self, instance: Instance) -> Optional[_Instance]:
        """
        ...
        Returns:
            Optional[_Instance]: The validated instance or None if invalid.
        """
