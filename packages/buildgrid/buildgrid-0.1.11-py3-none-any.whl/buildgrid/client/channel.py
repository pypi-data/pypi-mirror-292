...
from buildgrid.client.authentication import AuthMetadataClientInterceptorBase, load_tls_channel_credentials
from buildgrid.client.interceptors import (
...
def setup_channel(
    ...
    auth_token_loader: Optional[AuthTokenLoader] = None
    if auth_token:
