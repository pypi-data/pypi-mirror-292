...
class Context:
    def __init__(self) -> None:
        ...
        self.cas_channel: Optional[grpc.Channel] = None
        self.operations_channel: Optional[grpc.Channel] = None
        self.cache_channel: Optional[grpc.Channel] = None
...
def setup_logging(verbosity: int = 0, debug_mode: bool = False) -> None:
