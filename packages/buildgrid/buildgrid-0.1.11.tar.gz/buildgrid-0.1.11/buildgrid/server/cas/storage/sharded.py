...
from typing import IO, Callable, Dict, Iterable, Iterator, List, Optional, Tuple, TypeVar
...
class ShardedStorage(StorageABC):
    ...
    def __init__(self, storages: Dict[str, StorageABC], thread_pool_size: Optional[int] = None):
