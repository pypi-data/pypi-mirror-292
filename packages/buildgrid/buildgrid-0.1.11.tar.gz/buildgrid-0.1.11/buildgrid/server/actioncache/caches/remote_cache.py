...
class RemoteActionCache(ActionCacheABC):
    def __init__(
        ...
        self._action_cache: Optional[ActionCacheClient] = None
    ...
    def start(self) -> None:
        ...
        if self._action_cache is None:
            self._action_cache = ActionCacheClient(
                self._channel, self._remote_instance_name, self._retries, self._max_backoff
            )
    ...
    def update_action_result(self, action_digest: Digest, action_result: ActionResult) -> None:
        ...
        self._action_cache.update(action_digest, action_result)
