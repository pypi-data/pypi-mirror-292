...
class AiModelMockManager:
    ...
    @staticmethod
    def get_direct_call_function_path_as_string(subclass: type[AiModel]) -> str:
    ...
    @staticmethod
    def mock_ai_model_direct_call_with_2_errors_then_success(mocker: Mock, subclass: type[AiModel]) -> Mock:
        mock_function = mocker.patch(AiModelMockManager.get_direct_call_function_path_as_string(subclass))
    ...
    @staticmethod
    def mock_ai_model_direct_call_with_long_wait(mocker: Mock, subclass: type[AiModel]) -> Mock:
        ...
        def wait_longer_than_timeout(*args, **kwargs) -> Any:
            ...
            return subclass._get_mock_return_for_direct_call_to_model_using_cheap_input()
    ...
    @staticmethod
    def mock_ai_model_direct_call_with_predefined_mock_value(mocker: Mock, subclass: type[AiModel]) -> Mock:
        input_value = subclass._get_mock_return_for_direct_call_to_model_using_cheap_input()
        mock_function = AiModelMockManager.mock_ai_model_direct_call_with_value(mocker, subclass, input_value)
        return mock_function


    @staticmethod
    def mock_ai_model_direct_call_with_value(mocker: Mock, subclass: type[AiModel], value: Any) -> Mock:
        ...
        full_function_path = AiModelMockManager.get_direct_call_function_path_as_string(subclass)
    ...
    @staticmethod
    def mock_ai_model_direct_call_with_only_errors(mocker: Mock, subclass: type[AiModel]) -> Mock:
    ...
    @staticmethod
    def mock_input_to_tokens_with_value(mocker: Mock, subclass: type[TokensAreCalculatable], mock_value: int = 1) -> Mock:
        ...
        mock_function = mocker.patch(f"{subclass.input_to_tokens.__module__}.{subclass.input_to_tokens.__qualname__}")
        mock_function.return_value = mock_value
        return mock_function


    @staticmethod
    def mock_function_that_throws_error_if_test_limit_reached(mocker: Mock) -> Mock:
        mock_function = mocker.patch(f"{AiModel._increment_calls_then_error_if_testing_call_limit_reached.__module__}.{AiModel._increment_calls_then_error_if_testing_call_limit_reached.__qualname__}")
        return mock_function


    @staticmethod
    def mock_function_that_deactivates_langchain_tracing(mocker: Mock) -> Mock:
        mock_function = mocker.patch(f"{AiModel._deactivate_langchain_traces_if_in_testing_mode.__module__}.{AiModel._deactivate_langchain_traces_if_in_testing_mode.__qualname__}")
        return mock_function


    @staticmethod
    def reinitialize_limiters(subclass: type[RequestLimitedModel | TokenLimitedModel]) -> None:
