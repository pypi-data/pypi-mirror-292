    ...
    def query(self, query: str, n_retries: int = 3) -> Dict[str, Any]:
        ...
        for attempt in range(n_retries):
            ...
            try:
                ...
                sql_query = llm_sql_result.get('sql_query')  # Corrected key here
                if not sql_query:
                    print("No SQL query generated. Updating custom prompt and retrying...")
                    custom_prompt = (
                ...
                print(f"No data returned. Updating custom prompt for next attempt...")
