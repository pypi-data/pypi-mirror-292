...
class InFy(MBaseModel):
    matlcode: str = dataclass_field(default='KS-Civil(S)', description="Material code")
    matlname: str = dataclass_field(default='SS400', description="Material name")
...
# fy_value = call_getfy(InFy())
# print("Result from GetFy:", fy_value)