...
class HealthChecksClient(object):
    ...
    def change_http_monitor_compartment(self, monitor_id, change_http_monitor_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/change_http_monitor_compartment.py.html>`__ to see an example of how to use change_http_monitor_compartment API.
        """
    ...
    def change_ping_monitor_compartment(self, monitor_id, change_ping_monitor_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/change_ping_monitor_compartment.py.html>`__ to see an example of how to use change_ping_monitor_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId']
    ...
    def create_http_monitor(self, create_http_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/create_http_monitor.py.html>`__ to see an example of how to use create_http_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_on_demand_http_probe(self, create_on_demand_http_probe_details, **kwargs):
        ...
        *Note:* On-demand probe configurations are not saved.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/create_on_demand_http_probe.py.html>`__ to see an example of how to use create_on_demand_http_probe API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_on_demand_ping_probe(self, create_on_demand_ping_probe_details, **kwargs):
        ...
        *Note:* The on-demand probe configuration is not saved.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/create_on_demand_ping_probe.py.html>`__ to see an example of how to use create_on_demand_ping_probe API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_ping_monitor(self, create_ping_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/create_ping_monitor.py.html>`__ to see an example of how to use create_ping_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_http_monitor(self, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/delete_http_monitor.py.html>`__ to see an example of how to use delete_http_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId']
    ...
    def delete_ping_monitor(self, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/delete_ping_monitor.py.html>`__ to see an example of how to use delete_ping_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId']
    ...
    def get_http_monitor(self, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/get_http_monitor.py.html>`__ to see an example of how to use get_http_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId']
        resource_path = "/httpMonitors/{monitorId}"
    ...
    def get_ping_monitor(self, monitor_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/get_ping_monitor.py.html>`__ to see an example of how to use get_ping_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId']
        resource_path = "/pingMonitors/{monitorId}"
    ...
    def list_health_checks_vantage_points(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/list_health_checks_vantage_points.py.html>`__ to see an example of how to use list_health_checks_vantage_points API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def list_http_monitors(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/list_http_monitors.py.html>`__ to see an example of how to use list_http_monitors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_http_probe_results(self, probe_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/list_http_probe_results.py.html>`__ to see an example of how to use list_http_probe_results API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_ping_monitors(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/list_ping_monitors.py.html>`__ to see an example of how to use list_ping_monitors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/pingMonitors"
    ...
    def list_ping_probe_results(self, probe_configuration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/list_ping_probe_results.py.html>`__ to see an example of how to use list_ping_probe_results API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['probeConfigurationId']
    ...
    def update_http_monitor(self, monitor_id, update_http_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/update_http_monitor.py.html>`__ to see an example of how to use update_http_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId']
        resource_path = "/httpMonitors/{monitorId}"
    ...
    def update_ping_monitor(self, monitor_id, update_ping_monitor_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.133.0/healthchecks/update_ping_monitor.py.html>`__ to see an example of how to use update_ping_monitor API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['monitorId']
        resource_path = "/pingMonitors/{monitorId}"
