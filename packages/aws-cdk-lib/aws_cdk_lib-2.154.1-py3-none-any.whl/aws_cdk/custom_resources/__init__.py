...
class CustomResourceConfig(
    ...
    def add_log_retention_lifetime(self, rentention: _RetentionDays_070f99f0) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument rentention", value=rentention, expected_type=type_hints["rentention"])
        return typing.cast(None, jsii.invoke(self, "addLogRetentionLifetime", [rentention]))
