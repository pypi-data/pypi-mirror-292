"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[9173],{54070:(e,t,a)=>{a.d(t,{w:()=>l});var s=a(58593),r=a(83379),n=a(61988),i=a(35944);const l=({user:e,date:t})=>{const a=(0,i.tZ)("span",{className:"no-wrap",children:t});if(e){const t=(0,r.Z)(e),l=(0,n.t)("Modified by: %s",t);return(0,i.tZ)(s.u,{title:l,placement:"bottom",children:a})}return a}},27989:(e,t,a)=>{a.d(t,{Z:()=>m});var s=a(67294),r=a(51995),n=a(61988),i=a(35932),l=a(74069),o=a(4715),d=a(34858),c=a(60972),u=a(35944);const h=r.iK.div`
  display: block;
...
`,o=s.iK.span`
  color: ${({theme:e})=>e.colors.grayscale.base};
`;function d({actions:e}){return(0,i.tZ)(l,{className:"actions",children:e.map(((e,t)=>{const a=n.Z[e.icon];return e.tooltip?(0,i.tZ)(r.u,{id:`${e.label}-tooltip`,title:e.tooltip,placement:e.placement,children:(0,i.tZ)(o,{role:"button",tabIndex:0,className:"action-button",onClick:e.onClick,children:(0,i.tZ)(a,{})})},t):(0,i.tZ)(o,{role:"button",tabIndex:0,className:"action-button",onClick:e.onClick,children:(0,i.tZ)(a,{})},t)}))})}},99075:(e,t,a)=>{a.d(t,{J:()=>n});var s=a(19181),r=a(35944);const n=e=>(0,r.tZ)(s.Z,{...e})},25772:(e,t,a)=>{a.d(t,{P:()=>s.Z});var s=a(65477);a(8420)},33726:(e,t,a)=>{a.d(t,{Y:()=>r});var s=a(61988);const r={name:(0,s.t)("SQL"),tabs:[{name:"Saved queries",label:(0,s.t)("Saved queries"),url:"/savedqueryview/list/",usesRouter:!0},{name:"Query history",label:(0,s.t)("Query history"),url:"/sqllab/history/",usesRouter:!0}]}},6189:(e,t,a)=>{a.d(t,{Z:()=>g});var s=a(51995),r=a(61988),n=a(33743),i=a(49889),l=a(53459),o=a(22489),d=a(120),c=a(90854),u=a(13322),h=a(10222),p=a(35944);c.Z.registerLanguage("sql",n.Z),c.Z.registerLanguage("markdown",l.Z),c.Z.registerLanguage("html",i.Z),c.Z.registerLanguage("json",o.Z);const m=s.iK.div`
  margin-top: -24px;
...
`;function g({addDangerToast:e,addSuccessToast:t,children:a,...s}){return(0,p.BX)(m,{children:[(0,p.tZ)(u.Z.Copy,{tabIndex:0,role:"button",onClick:s=>{var n;s.preventDefault(),s.currentTarget.blur(),n=a,(0,h.Z)((()=>Promise.resolve(n))).then((()=>{t&&t((0,r.t)("SQL Copied!"))})).catch((()=>{e&&e((0,r.t)("Sorry, your browser does not support copying."))}))}}),(0,p.tZ)(c.Z,{style:d.Z,...s,children:a})]})}},86185:(e,t,a)=>{a.d(t,{Z:()=>r});var s=a(67294);function r({queries:e,fetchData:t,currentQueryId:a}){const r=e.findIndex((e=>e.id===a)),[n,i]=(0,s.useState)(r),[l,o]=(0,s.useState)(!1),[d,c]=(0,s.useState)(!1);function u(){o(0===n),c(n===e.length-1)}function h(a){const s=n+(a?-1:1);s>=0&&s<e.length&&(t(e[s].id),i(s),u())}return(0,s.useEffect)((()=>{u()})),{handleKeyPress:function(t){n>=0&&n<e.length&&("ArrowDown"===t.key||"k"===t.key?(t.preventDefault(),h(!1)):"ArrowUp"!==t.key&&"j"!==t.key||(t.preventDefault(),h(!0)))},handleDataChange:h,disablePrevious:l,disableNext:d}}},7742:(e,t,a)=>{a.r(t),a.d(t,{default:()=>M});var s=a(61988),r=a(51995),n=a(31069),i=a(93185),l=a(67294),o=a(16550),d=a(73727),c=a(15926),u=a.n(c),h=a(40768),p=a(28216),m=a(99075),g=a(14114),y=a(34858),v=a(19259),b=a(32228),f=a(86074),w=a(93139),Z=a(38703),S=a(17198),x=a(29848),_=a(25772),T=a(58593),k=a(33726),q=a(12),$=a(10222),C=a(27989),P=a(54070),N=a(60718),B=a(13322),H=a(74069),D=a(35932),E=a(6189),K=a(86185),I=a(35944);const L=r.iK.div`
