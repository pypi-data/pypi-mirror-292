"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[6284],{99075:(e,t,r)=>{r.d(t,{J:()=>s});var a=r(19181),i=r(35944);const s=e=>(0,i.tZ)(a.Z,{...e})},33726:(e,t,r)=>{r.d(t,{Y:()=>i});var a=r(61988);const i={name:(0,a.t)("SQL"),tabs:[{name:"Saved queries",label:(0,a.t)("Saved queries"),url:"/savedqueryview/list/",usesRouter:!0},{name:"Query history",label:(0,a.t)("Query history"),url:"/sqllab/history/",usesRouter:!0}]}},6189:(e,t,r)=>{r.d(t,{Z:()=>m});var a=r(51995),i=r(61988),s=r(33743),n=r(49889),l=r(53459),o=r(22489),c=r(120),d=r(90854),u=r(13322),h=r(10222),g=r(35944);d.Z.registerLanguage("sql",s.Z),d.Z.registerLanguage("markdown",l.Z),d.Z.registerLanguage("html",n.Z),d.Z.registerLanguage("json",o.Z);const p=a.iK.div`
  margin-top: -24px;
...
`;function m({addDangerToast:e,addSuccessToast:t,children:r,...a}){return(0,g.BX)(p,{children:[(0,g.tZ)(u.Z.Copy,{tabIndex:0,role:"button",onClick:a=>{var s;a.preventDefault(),a.currentTarget.blur(),s=r,(0,h.Z)((()=>Promise.resolve(s))).then((()=>{t&&t((0,i.t)("SQL Copied!"))})).catch((()=>{e&&e((0,i.t)("Sorry, your browser does not support copying."))}))}}),(0,g.tZ)(d.Z,{style:c.Z,...a,children:r})]})}},86185:(e,t,r)=>{r.d(t,{Z:()=>i});var a=r(67294);function i({queries:e,fetchData:t,currentQueryId:r}){const i=e.findIndex((e=>e.id===r)),[s,n]=(0,a.useState)(i),[l,o]=(0,a.useState)(!1),[c,d]=(0,a.useState)(!1);function u(){o(0===s),d(s===e.length-1)}function h(r){const a=s+(r?-1:1);a>=0&&a<e.length&&(t(e[a].id),n(a),u())}return(0,a.useEffect)((()=>{u()})),{handleKeyPress:function(t){s>=0&&s<e.length&&("ArrowDown"===t.key||"k"===t.key?(t.preventDefault(),h(!1)):"ArrowUp"!==t.key&&"j"!==t.key||(t.preventDefault(),h(!0)))},handleDataChange:h,disablePrevious:l,disableNext:c}}},36444:(e,t,r)=>{r.r(t),r.d(t,{default:()=>Y});var a=r(67294),i=r(16550),s=r(73727),n=r(51995),l=r(61988),o=r(31069),c=r(43716),d=r(30381),u=r.n(d),h=r(40768),g=r(14114),p=r(34858),m=r(37921),b=r(86074),y=r(99075),Z=r(33726),v=r(93139),f=r(58593),x=r(90854),S=r(33743),q=r(120),w=r(27600),T=r(12),k=r(13322),C=r(74069),$=r(93967),D=r.n($),H=r(35932),z=r(6189),L=r(86185),U=r(35944);const B=n.iK.div`
