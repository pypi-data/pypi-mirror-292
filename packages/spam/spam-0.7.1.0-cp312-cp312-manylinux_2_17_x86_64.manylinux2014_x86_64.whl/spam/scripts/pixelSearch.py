...
def script():
    ...
    if args.LAB1 is not None:
        ...
        PhiField, pixelSearchCC, error, returnStatus, deltaPhiNorm, iterations = spam.DIC.pixelSearchDiscrete(
            lab1, im1, im2, PhiField, searchRange, boundingBoxes, numberOfNodes, nodePositions, args.APPLY_F, args.LABEL_DILATE, args.LABEL_VOLUME_THRESHOLD, args.PROCESSES
        )
    else:
        # Local version of PS
