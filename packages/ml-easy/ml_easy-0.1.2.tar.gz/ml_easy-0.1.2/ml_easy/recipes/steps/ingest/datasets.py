...
from ml_easy._recipes.steps.transform.filters import EqualFilter, InFilter
...
class PolarsDataset(Dataset[pl.DataFrame | pl.LazyFrame]):
    ...
    def filter(self, filters: Dict[str, Optional[List[Union[EqualFilter[str], InFilter[str]]]]]) -> Self:
        from ml_easy._recipes.utils import is_instance_for_generic
    ...
    def get_mlflow_dataset(self, conf: SourceConfig) -> MLflowDataset:
        from ml_easy._recipes.utils import resolve_dataset_source
