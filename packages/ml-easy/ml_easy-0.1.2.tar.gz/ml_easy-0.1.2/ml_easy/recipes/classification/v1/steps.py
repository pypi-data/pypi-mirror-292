...
from ml_easy._recipes._classification.v1.config import (
...
from ml_easy._recipes.interfaces.config import Context
from ml_easy._recipes.steps.cards_config import Metric, StepMessage
from ml_easy._recipes.steps.evaluate.evaluate import EvaluateStep
from ml_easy._recipes.steps.ingest.datasets import Dataset
from ml_easy._recipes.steps.ingest.ingest import IngestStep
from ml_easy._recipes.steps.register.register_ import RegisterStep
from ml_easy._recipes.steps.register.registry import Registry
from ml_easy._recipes.steps.split.split import SplitStep
from ml_easy._recipes.steps.split.splitter import DatasetSplitter
from ml_easy._recipes.steps.train.models import Model
from ml_easy._recipes.steps.train.train import TrainStep
from ml_easy._recipes.steps.transform.transform import TransformStep
from ml_easy._recipes.utils import get_features_target, get_score_class
...
class ClassificationTransformStep(TransformStep[ClassificationTransformConfig]):
    ...
    def _run(self, message: StepMessage) -> StepMessage:
        from ml_easy._recipes.steps.transform.transformer import Transformer
