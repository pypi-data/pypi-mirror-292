...
class UserProfileProto(_message.Message):
    __slots__ = ("id", "first_name", "middle_name", "last_name", "company", "role", "primary_area_of_interest", "picture")
    ...
    picture: str
    def __init__(self, id: _Optional[str] = ..., first_name: _Optional[str] = ..., middle_name: _Optional[str] = ..., last_name: _Optional[str] = ..., company: _Optional[str] = ..., role: _Optional[_Union[_waiting_user_pb2.UserRoleProto, str]] = ..., primary_area_of_interest: _Optional[_Union[_waiting_user_pb2.AreaOfInterestProto, str]] = ..., picture: _Optional[str] = ...) -> None: ...
