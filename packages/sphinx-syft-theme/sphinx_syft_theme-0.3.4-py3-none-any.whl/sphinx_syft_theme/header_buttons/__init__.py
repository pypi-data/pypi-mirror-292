...
from sphinx_syft_theme.utils import config_provided_by_user, get_theme_options_dict

from .utils import get_svg_content
...
def add_header_buttons(app, pagename, templatename, context, doctree):
    ...
    if as_bool(opts.get("use_download_button", True)) and suff:
        ...
        # Directly get the SVG content
        download_svg = get_svg_content("assets/images/download.svg")
        ...
        header_buttons.append(
            {
                ...
                "args": {
                    "svg": download_svg,  # Embed the actual SVG content
                },
            }
        )

    # Directly get the SVG content
    fullscreen_svg = get_svg_content("assets/images/fullscreen.svg")
        ...
        header_buttons.append(
            {
                ...
                "args": {
                    "svg": fullscreen_svg,  # Embed the actual SVG content
                },
            }
        )
...
def update_context_with_repository_info(app):
    """Update Syft `html_context` options for source from `repository_url`.
