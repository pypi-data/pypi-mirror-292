...
def filter_ignored_violations(violations, url_pathname):
    ...
    if url_pathname == "/examples/syft.html":
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("/examples/syft.html", "#Syft-Library-Styles"),
        (
            "/user_guide/theme-elements.html",
...
def test_axe_core(
    ...
    # On the Syft Library Styles page, wait for ipywidget to load and for our
    ...
    # We expect notebook outputs on the Syft Library Styles page to have color
    # contrast failures.
    if url_pathname == "/examples/syft.html":
...
def test_notebook_output_tab_stop(page: Page, url_base: str) -> None:
    ...
    page.goto(urljoin(url_base, "/examples/syft.html"))
