"""This module provides the Banner directive for use with Banner Pages."""
...
class Banner(Directive):
    ...
    option_spec: ClassVar[typing.OptionSpec] = {
    ...
    def run(self):
        ...
        options = " ".join(f'{k!s}="{v!s}"' for k, v in self.options.items())
