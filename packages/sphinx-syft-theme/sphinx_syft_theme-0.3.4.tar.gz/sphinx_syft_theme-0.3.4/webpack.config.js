/**
 * Webpack configuration for sphinx-syft-theme.
 *
...
const localePath = resolve(__dirname, "src/sphinx_syft_theme/locale");
...
const scriptPath = resolve(__dirname, "src/sphinx_syft_theme/assets/scripts");
const staticPath = resolve(__dirname,"src/sphinx_syft_theme/theme/sphinx_syft_theme/static");
 ...
 */
 const theme_stylesheets = [
  ...
  "styles/sphinx-syft-theme.css", // all the css created for this specific theme
];
const theme_scripts = [
  "scripts/bootstrap.js",
  "scripts/header-buttons.js",
  "scripts/sphinx-syft-theme.js",
];
...
module.exports = {
  ...
  devtool: "source-map",
  entry: {
    "sphinx-syft-theme": resolve(scriptPath, "sphinx-syft-theme.js"),
    "header-buttons": resolve(scriptPath, "header-buttons.js"),
