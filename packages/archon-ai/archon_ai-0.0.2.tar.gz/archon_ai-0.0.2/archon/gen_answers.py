...
def main(args):
    ...
    # If output path exists, delete it to keep newest answers
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Percent of data to use of benchmark",
    )

    parser.add_argument("--debug_data", action="store_true")
    parser.add_argument("--debug", action="store_true")
    parser.add_argument("--debug_verifier", action="store_true")
    parser.add_argument("--debug_archon", action="store_true")
    parser.add_argument(
        "--dataset_sample",
        type=float,
