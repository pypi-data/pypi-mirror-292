...
def generate_together(
    ...
    output = None
    key = KEYS.get_current_key("TOGETHER_API_KEY")
...
def generate_openai(
    ...
    client = openai.OpenAI(
        api_key=KEYS.get_current_key("OPENAI_API_KEY"),
    )
...
def generate_anthropic(
    ...
    key = KEYS.get_current_key("ANTHROPIC_API_KEY")
