...
generator_class = SymmetryGenerator
...
used_test_data_dicts = [test_data_dict for test_data_dict in test_data_dicts if test_data_dict['name'] != 'C30']

@pytest.mark.parametrize('test_data_dict', used_test_data_dicts)
