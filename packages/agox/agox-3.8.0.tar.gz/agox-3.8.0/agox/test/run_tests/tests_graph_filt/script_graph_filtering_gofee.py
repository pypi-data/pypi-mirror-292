...
graph_descriptor = Voronoi(covalent_bond_scale_factor = 1.3, n_points = 8, angle_from_central_atom = 20, environment=environment)
voronoi = VoronoiFilter(max_number_of_children=5, descriptor = graph_descriptor)
sample_size = 2
sampler = KMeansSampler(
    descriptor=descriptor, database=database, sample_size=sample_size, filters=voronoi, 
)
