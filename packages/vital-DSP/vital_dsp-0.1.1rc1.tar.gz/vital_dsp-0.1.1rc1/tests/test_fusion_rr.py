...
def test_respiratory_cardiac_fusion():
    resp_signal, cardiac_signal = generate_multimodal_signals(sampling_rate=100, duration=60)
    rr_fusion = respiratory_cardiac_fusion(resp_signal, cardiac_signal, sampling_rate=100)
