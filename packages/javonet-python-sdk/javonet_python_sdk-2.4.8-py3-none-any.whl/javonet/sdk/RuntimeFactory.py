...
class RuntimeFactory(AbstractRuntimeFactory):
    ...
    def __init__(self, connection_type: ConnectionType, tcp_connection_data: TcpConnectionData):
        self.connection_type = connection_type
        self.tcp_connection_data = tcp_connection_data
    ...
    def clr(self):
        ...
        """
        return RuntimeContext.get_instance(RuntimeName.clr, self.connection_type, self.tcp_connection_data)
    ...
    def jvm(self):
        ...
        Refer to this `article on Javonet Guides <https://www.javonet.com/guides/v2/python/foundations/runtime-context>`_ for more information.
        """
        return RuntimeContext.get_instance(RuntimeName.jvm, self.connection_type, self.tcp_connection_data)
    ...
    def netcore(self):
        ...
        Refer to this `article on Javonet Guides <https://www.javonet.com/guides/v2/python/foundations/runtime-context>`_ for more information.
        """
        return RuntimeContext.get_instance(RuntimeName.netcore, self.connection_type, self.tcp_connection_data)
    ...
    def perl(self):
        ...
        Refer to this `article on Javonet Guides <https://www.javonet.com/guides/v2/python/foundations/runtime-context>`_ for more information.
        """
        return RuntimeContext.get_instance(RuntimeName.perl, self.connection_type, self.tcp_connection_data)
    ...
    def ruby(self):
        ...
        Refer to this `article on Javonet Guides <https://www.javonet.com/guides/v2/python/foundations/runtime-context>`_ for more information.
        """
        return RuntimeContext.get_instance(RuntimeName.ruby, self.connection_type, self.tcp_connection_data)
    ...
    def nodejs(self):
        ...
        Refer to this `article on Javonet Guides <https://www.javonet.com/guides/v2/python/foundations/runtime-context>`_ for more information.
        """
        return RuntimeContext.get_instance(RuntimeName.nodejs, self.connection_type, self.tcp_connection_data)
    ...
    def python(self):
        ...
        Refer to this `article on Javonet Guides <https://www.javonet.com/guides/v2/python/foundations/runtime-context>`_ for more information.
        """
        return RuntimeContext.get_instance(RuntimeName.python, self.connection_type, self.tcp_connection_data)