...
class TleEstimationRequest(BaseModel):
    ...
    input_measurements: InputMeasurements = Field(alias="inputMeasurements")
    data: Optional[Dict[str, StrictStr]] = Field(default=None, description="References to the data to be used during the computation")
    __properties: ClassVar[List[str]] = ["initialGuess", "estimateBStarFlag", "outlierFilter", "inputMeasurements", "data"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of input_measurements
        if self.input_measurements:
            _dict['inputMeasurements'] = self.input_measurements.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputMeasurements": InputMeasurements.from_dict(obj["inputMeasurements"]) if obj.get("inputMeasurements") is not None else None,
            "data": obj.get("data")
        })
        return _obj
