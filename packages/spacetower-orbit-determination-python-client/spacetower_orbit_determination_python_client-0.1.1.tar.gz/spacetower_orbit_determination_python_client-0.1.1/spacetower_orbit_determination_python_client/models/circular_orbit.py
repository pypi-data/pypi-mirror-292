...
class CircularOrbit(Orbit):
    ...
    __properties: ClassVar[List[str]] = ["orbitType", "date", "semiMajorAxis", "eccentricityVectorX", "eccentricityVectorY", "inclination", "raan", "argumentOfLatitude", "anomalyType", "meanOscType", "frameIdentifier"]
