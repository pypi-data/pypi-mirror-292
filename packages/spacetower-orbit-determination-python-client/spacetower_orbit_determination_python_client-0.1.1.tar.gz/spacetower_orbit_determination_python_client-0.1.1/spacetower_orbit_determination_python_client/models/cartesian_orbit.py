...
class CartesianOrbit(Orbit):
    ...
    frame_identifier: Optional[FrameIdentifier] = Field(default=None, alias="frameIdentifier")
    __properties: ClassVar[List[str]] = ["orbitType", "date", "position", "velocity", "frameIdentifier"]
