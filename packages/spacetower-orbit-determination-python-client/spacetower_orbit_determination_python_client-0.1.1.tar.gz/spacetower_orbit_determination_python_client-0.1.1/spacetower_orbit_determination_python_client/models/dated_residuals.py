...
class DatedResiduals(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'BATCH_FILTER': 'Residuals','UNSCENTED_KALMAN_FILTER': 'KalmanResiduals'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[Residuals, KalmanResiduals]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[Residuals, KalmanResiduals]]:
        """Create an instance of DatedResiduals from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'Residuals':
            return import_module("spacetower_orbit_determination_python_client.models.residuals").Residuals.from_dict(obj)
