...
class CartesianCovarianceMatrix(OrbitalCovarianceMatrix):
    ...
    """ # noqa: E501
    frame: CartesianCovarianceAllowedFrame
    ...
    __properties: ClassVar[List[str]] = ["covarianceType", "frame", "varPx", "varPy", "varPz", "varVx", "varVy", "varVz", "covVxVy", "covVxVz", "covVyVz", "covPxPy", "covPxPz", "covPyPz", "covPxVx", "covPxVy", "covPxVz", "covPyVx", "covPyVy", "covPyVz", "covPzVx", "covPzVy", "covPzVz"]
