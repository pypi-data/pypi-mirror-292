...
class IsotropicObject(SpaceObject):
    ...
    """ # noqa: E501
    drag_cross_section: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cross section area for drag computation. Units [m^2]", alias="dragCrossSection")
    ...
    radiation_cross_section: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Cross section area for radiation pressure computation. Units [m^2]", alias="radiationCrossSection")
    radiation_coefficients: Optional[RadiationCoefficients] = Field(default=None, alias="radiationCoefficients")
    __properties: ClassVar[List[str]] = ["mass", "solarArraySystem", "propulsionSystem", "spaceObjectType", "dragCrossSection", "dragCoefficient", "radiationCrossSection", "radiationCoefficients"]
