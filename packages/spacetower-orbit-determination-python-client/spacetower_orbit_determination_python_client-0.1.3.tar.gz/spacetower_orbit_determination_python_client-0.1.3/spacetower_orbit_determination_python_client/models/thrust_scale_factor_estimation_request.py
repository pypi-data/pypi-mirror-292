...
class ThrustScaleFactorEstimationRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    estimate_thrust_scales_flag: StrictBool = Field(alias="estimateThrustScalesFlag")
    ...
    __properties: ClassVar[List[str]] = ["estimateThrustScalesFlag", "scaleFactorXInitialStandardDeviation", "scaleFactorYInitialStandardDeviation", "scaleFactorZInitialStandardDeviation", "scaleFactorXProcessNoiseStandardDeviation", "scaleFactorYProcessNoiseStandardDeviation", "scaleFactorZProcessNoiseStandardDeviation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ThrustScaleFactorEstimationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ThrustScaleFactorEstimationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "estimateThrustScalesFlag": obj.get("estimateThrustScalesFlag") if obj.get("estimateThrustScalesFlag") is not None else False,
