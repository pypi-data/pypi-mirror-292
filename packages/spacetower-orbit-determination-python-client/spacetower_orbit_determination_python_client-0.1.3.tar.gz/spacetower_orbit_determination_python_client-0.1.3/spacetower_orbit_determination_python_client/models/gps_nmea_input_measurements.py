...
class GpsNmeaInputMeasurements(InputMeasurements):
    """
    Dated-weighted GPS NMEA measurement series with field descriptions with respect to a specified earth fixed frame and a specified ellipsoid model. Each set of measurement data contains the following ordered content: geodetic  latitude, longitude, geodetic altitude, earth fixed speed and measurement weight 
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dates", "description", "measurementType", "referenceFramesConfiguration", "standardDeviations", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GpsNmeaInputMeasurements from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GpsNmeaInputMeasurements from a dict"""
        if obj is None:
            return None
