...
class KalmanResult(BaseModel):
    ...
    """ # noqa: E501
    output_orbits: Optional[List[Orbit]] = Field(default=None, description="Array of generic orbits", alias="outputOrbits")
    ...
    output_residuals: Optional[DatedResiduals] = Field(default=None, alias="outputResiduals")
    __properties: ClassVar[List[str]] = ["outputOrbits", "outputDatedCovarianceMatrices", "outputModelParameters", "outputResiduals"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in output_orbits (list)
        _items = []
        if self.output_orbits:
            for _item in self.output_orbits:
                if _item:
                    _items.append(_item.to_dict())
            _dict['outputOrbits'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outputOrbits": [Orbit.from_dict(_item) for _item in obj["outputOrbits"]] if obj.get("outputOrbits") is not None else None,
            ...
            "outputResiduals": DatedResiduals.from_dict(obj["outputResiduals"]) if obj.get("outputResiduals") is not None else None
        })
        return _obj
