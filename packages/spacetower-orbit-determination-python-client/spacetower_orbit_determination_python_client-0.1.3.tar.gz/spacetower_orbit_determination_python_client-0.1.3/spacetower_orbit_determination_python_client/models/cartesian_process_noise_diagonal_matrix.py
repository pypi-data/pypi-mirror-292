...
class CartesianProcessNoiseDiagonalMatrix(BaseModel):
    ...
    """ # noqa: E501
    cartesian_covariance_frame: CartesianCovarianceAllowedFrame = Field(alias="cartesianCovarianceFrame")
    ...
    __properties: ClassVar[List[str]] = ["cartesianCovarianceFrame", "positionXCoefficient", "positionYCoefficient", "positionZCoefficient", "velocityXCoefficient", "velocityYCoefficient", "velocityZCoefficient"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cartesianCovarianceFrame": obj.get("cartesianCovarianceFrame"),
