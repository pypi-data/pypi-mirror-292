...
class UnscentedKalmanFilterOrbitDetermination(NumericalEstimationRequest):
    ...
    __properties: ClassVar[List[str]] = ["attitudeSequence", "estimatorType", "inputMeasurementsSet", "dynamicsAndFramesConfiguration", "estimationConfiguration", "postProcessConfiguration", "initialGuessConfiguration", "unscentedKalmanFilterConfiguration"]
