...
class TestBatchFilterInitialGuessConfiguration(unittest.TestCase):
    """BatchFilterInitialGuessConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchFilterInitialGuessConfiguration:
        """Test BatchFilterInitialGuessConfiguration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchFilterInitialGuessConfiguration`
        """
        model = BatchFilterInitialGuessConfiguration()
        if include_optional:
            return BatchFilterInitialGuessConfiguration(
    ...
    def testBatchFilterInitialGuessConfiguration(self):
        """Test BatchFilterInitialGuessConfiguration"""
