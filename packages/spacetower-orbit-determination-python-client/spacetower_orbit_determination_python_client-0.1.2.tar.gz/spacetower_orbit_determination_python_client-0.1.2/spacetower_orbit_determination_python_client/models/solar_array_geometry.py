...
class SolarArrayGeometry(BaseModel):
    ...
    """ # noqa: E501
    radiation_coefficients: ReflectionAbsorptionCoefficients = Field(alias="radiationCoefficients")
    drag_coefficient: Union[StrictFloat, StrictInt] = Field(description="Drag coefficient of the solar array panel. Units [-]", alias="dragCoefficient")
