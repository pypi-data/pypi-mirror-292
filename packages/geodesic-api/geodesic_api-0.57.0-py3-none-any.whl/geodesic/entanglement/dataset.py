    ...
    def join(
        ...
        **kwargs,
        ...
        Args:
            ...
            field: the name of the field in this dataset to join on. This key must exist for there to be output.
            ...
            use_geometry: which geometry to use in the join. "left" will use the left dataset's geometry, "right" will
                use the right dataset's geometry
            skip_initialize: if True, will not initialize the right provider. This is necessary if the right
                provider is particularly large - all joins will then be dynamic.
            feature_limit: the max size of a results page from a query/search
            project: the name of the project this will be assigned to
            middleware: configure any boson middleware to be applied to the new dataset.
            cache: configure caching for this dataset
