...
class SearchTransform(_Middleware):
    ...
    def compute_id() -> "SearchTransform":
        ...
        This middleware will compute an ID for each feature in the search response. The ID is computed by
        hashing the properties and geometry of the feature. This is useful for when you want to uniquely
        identify each feature in the search response when the features do not have an existing ID.
