...
def main():
    ...
    # New argument for roi_size_list
    parser.add_argument('-rsl', '--roi_size_list', type=str, required=True,
                        help='Comma-separated list of ROI sizes, or path to file containing the list of ROI sizes')

    args = parser.parse_args()
    args.output = os.path.abspath(args.output)

    # Process the roi_size_list argument
