...
from ollama_x_client.types import UNSET, Response, Unset


def _get_kwargs(
    *,
    server_id: str,
    server_url: Union[None, Unset, str] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}

    params["server_id"] = server_id

    json_server_url: Union[None, Unset, str]
    if isinstance(server_url, Unset):
        json_server_url = UNSET
    else:
        json_server_url = server_url
    params["server_url"] = json_server_url
...
def sync_detailed(
    *,
    ...
    Args:
        server_id (str):
        server_url (Union[None, Unset, str]):
