...
setup(
    ...
    url="https://gitlab.com/parob/graph-service-framework",
    download_url=f"https://gitlab.com/parob/graph-service-framework/-/"
    f"archive/master/graph-service-framework-v{version}.zip",
    keywords=["GraphQL"],
