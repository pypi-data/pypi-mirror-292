...
class JoinGame200Response(BaseModel):
    ...
    JoinGame200Response
    """ # noqa: E501
    player_token: Optional[StrictStr] = Field(default=None, description="Token assigned to the player")
    player_index: Optional[StrictInt] = Field(default=None, description="Index of the player in the game (1 or 2)")
    __properties: ClassVar[List[str]] = ["player_token", "player_index"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "player_token": obj.get("player_token"),
