"""
Pint units registry, utility functions for Pint package and units definitions
of parameters used in ASE calculators and algorithms
"""
...
# VASP units definitions have been deduced from:
...
scalar_pars['vasp'] = {
    ...
    'pstress': 'kbar',
    'sigma': 'eV',
    'smass': 'unified_atomic_mass_unit',
...
scalar_pars['turbomole'] = {
    ...
    'default eht atomic orbitals': 'dimensionless',
    ...
    'uhf': 'dimensionless',
    'use basis set library': 'dimensionless',
    'use dft': 'dimensionless',
    'use fermi smearing': 'dimensionless',
    'use redundant internals': 'dimensionless',
    'use resolution of identity': 'dimensionless',
...
calc_pars['emt'] = {'restart': None, 'asap_cutoff': None, 'fixed_cutoff': None}
