...
IMAGE_FILE = resource_filename(
    "bhagyashree", "assets/img/5a8d70ce78bd7e2f015f9e6bfe36363e.png"
)
...
def on_yes():
    x = messagebox.askyesno("yiiippeeeeeee", "OMMFGGGadfksdjfsijfdsfkjb really???!?!?")
    if x:
        x = messagebox.showinfo(
            "Info",
            "meet me after exam at 12:30 PM on 30/08/24 at ummm UB yes UB.",
            icon="info",
        )
        root.destroy()
        exit()
...
def on_no():
    messagebox.showerror("Error", "this is not possible wtf")
