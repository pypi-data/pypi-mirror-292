...
def add_page_objects_to_path():
    project_root = os.path.dirname(os.path.abspath(__file__))
    page_objects_path = os.path.join(project_root, '..', '..', 'PageObjects')
    sys.path.append(page_objects_path)
    global_logger.info("PageObjects directory added to the Python path: %s", page_objects_path)
