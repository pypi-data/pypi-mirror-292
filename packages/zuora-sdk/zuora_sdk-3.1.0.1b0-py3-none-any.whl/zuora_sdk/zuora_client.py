...
class ZuoraClient:
    def __init__(self, client_id: str, client_secret: str, env: ZuoraEnvironment):
        self.client_id = client_id
        self.client_secret = client_secret
        self.env = env

        self.configuration: Configuration = zuora_sdk.Configuration()
    ...
    def configuration_templates_api(self) -> ConfigurationTemplatesApi:
        return ConfigurationTemplatesApi(self.api_client)
    ...
    def mapping_api(self) -> MappingApi:
        return MappingApi(self.api_client)
    ...
    def signed_url_api(self) -> SignedUrlApi:
        return SignedUrlApi(self.api_client)

    def stage_error_api(self) -> StageErrorApi:
        return StageErrorApi(self.api_client)
    ...
    def upload_api(self) -> UploadApi:
        return UploadApi(self.api_client)
    ...
    def zuora_revenue_integration_api(self) -> ZuoraRevenueIntegrationApi:
        return ZuoraRevenueIntegrationApi(self.api_client)
