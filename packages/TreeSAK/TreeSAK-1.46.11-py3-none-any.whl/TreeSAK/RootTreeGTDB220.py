...
TreeSAK RootTreeGTDB220 -tree ar53.unrooted.tree -tax ar53.summary.tsv -db db_dir -d ar -o ar53.rooted.tree -add_root
...
def root_with_outgroup(input_tree, out_group_list, add_root_branch, tree_file_rooted):
    ...
    if mrca.edge_length is not None:
        ...
        if add_root_branch is True:
            ...
            tree_out_string = tree_out_string.replace(');', '):0.05);')
