...
class ParserXYCE:
    ...
    def __init__(self, circuit_data: DataModelCircuit = None, path_input: Path = None, output_path: str = '', verbose: bool = True):
        """
    ...
    def write_library(self, output_path: str, name: str, nodes: list, params: dict, Netlist: dict, verbose: bool = False):
