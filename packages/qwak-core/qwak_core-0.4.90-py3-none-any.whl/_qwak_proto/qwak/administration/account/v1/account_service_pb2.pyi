...
class UpdateAccountRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accepted_terms", b"accepted_terms", "account_id", b"account_id", "preferences", b"preferences", "tier", b"tier", "type", b"type"]) -> None: ...
