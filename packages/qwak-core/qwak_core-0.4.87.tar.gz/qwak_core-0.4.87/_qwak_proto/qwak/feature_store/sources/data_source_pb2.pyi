...
class DataSourceSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["batch_source", b"batch_source", "source_code_spec", b"source_code_spec", "stream_source", b"stream_source", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["batch_source", b"batch_source", "source_code_spec", b"source_code_spec", "stream_source", b"stream_source", "type", b"type"]) -> None: ...
