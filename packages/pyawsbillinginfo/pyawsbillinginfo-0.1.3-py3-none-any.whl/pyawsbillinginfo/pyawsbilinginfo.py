...
def aws_billing_info():
    ...
    parser.add_argument('--start-date', type=parse, default=default_start_date,
                        help=f'Start date for the billing data in YYYY-MM-DD format (default: {default_start_date})')
    parser.add_argument('--end-date', type=parse, default=default_end_date,
                        help=f'End date for the billing data in YYYY-MM-DD format (default: {default_end_date})')
