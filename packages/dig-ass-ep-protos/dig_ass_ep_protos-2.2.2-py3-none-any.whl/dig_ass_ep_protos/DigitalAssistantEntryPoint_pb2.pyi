...
class DigitalAssistantEntryPointResponse(_message.Message):
    ...
    def __init__(self, Text: _Optional[str] = ..., Results: _Optional[_Iterable[_Union[ResultItem, _Mapping]]] = ...) -> None: ...

class ResultItem(_message.Message):
    __slots__ = ("Diagnosis", "Doctors")
    DIAGNOSIS_FIELD_NUMBER: _ClassVar[int]
    DOCTORS_FIELD_NUMBER: _ClassVar[int]
    Diagnosis: str
    Doctors: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, Diagnosis: _Optional[str] = ..., Doctors: _Optional[_Iterable[str]] = ...) -> None: ...
