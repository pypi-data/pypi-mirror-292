...
pub const GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0x68, 0x48, 0x37, 0x6b, 0xc6, 0x16, 0x84, 0x0e, 0xb5, 0x07, 0x28, 0xea, 0xa3, 0xf2, 0xa3, 0x42, 0xb3, 0xac, 0xaf, 0x85, 0xb7,
        0xac, 0xc1, 0x28, 0xd7, 0x61, 0xe5, 0x3b, 0x6a, 0xb0, 0xaa, 0xc3,
    ]),
    version: 0,
    ...
    timestamp: 1724637058503,
    bits: 486652985,
    nonce: 0x4e616f72,
    daa_score: 23_881_469, // Checkpoint DAA score
    #[rustfmt::skip]
    coinbase_payload: &[
