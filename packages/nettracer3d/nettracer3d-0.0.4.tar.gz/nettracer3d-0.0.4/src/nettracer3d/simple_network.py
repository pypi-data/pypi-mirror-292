...
def show_community_network(excel_file_path, geometric = False, geo_info = None):
...
def show_simple_network(excel_file_path, geometric = False, geo_info = None):
...
def show_identity_network(excel_file_path, node_identities, geometric = False, geo_info = None):
