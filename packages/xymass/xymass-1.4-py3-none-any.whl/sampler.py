...
def abg(size,x_min,x_max,alpha,beta,gamma,xbreak):#sample coordinate from alpha/beta/gamma model
    ...
    def findx(x,uni):
        return  ((x_min/xbreak)**(1.-gamma)*scipy.special.hyp2f1(a,b,c,z1)-x**(1.-gamma)*scipy.special.hyp2f1(a,b,c,-x**alpha))/((x_min/xbreak)**(1.-gamma)*scipy.special.hyp2f1(a,b,c,z1)-(x_max/paramsxbreak)**(1.-gamma)*scipy.special.hyp2f1(a,b,c,z2))-uni
