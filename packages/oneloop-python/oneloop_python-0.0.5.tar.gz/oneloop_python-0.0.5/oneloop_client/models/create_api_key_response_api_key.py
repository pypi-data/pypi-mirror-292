...
class CreateApiKeyResponseApiKey(BaseModel):
    ...
    key: StrictStr = Field(...)
    __properties = ["id", "name", "maskedKey", "prefix", "expiresAt", "totalUsageLeft", "limitUsage", "scopes", "enabled", "customerId", "deleted", "createdAt", "updatedAt", "key"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateApiKeyResponseApiKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateApiKeyResponseApiKey:
        """Create an instance of CreateApiKeyResponseApiKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateApiKeyResponseApiKey.parse_obj(obj)

        _obj = CreateApiKeyResponseApiKey.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
