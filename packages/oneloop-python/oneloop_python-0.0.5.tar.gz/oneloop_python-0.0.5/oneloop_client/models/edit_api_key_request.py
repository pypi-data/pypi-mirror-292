...
class EditApiKeyRequest(BaseModel):
    ...
    scopes: Optional[conlist(ApiKeyScope)] = None
    __properties = ["name", "enabled", "scopes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EditApiKeyRequest:
        """Create an instance of EditApiKeyRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EditApiKeyRequest:
        """Create an instance of EditApiKeyRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EditApiKeyRequest.parse_obj(obj)

        _obj = EditApiKeyRequest.parse_obj({
            "name": obj.get("name"),
