...
class MysqlTableCompare:
    ...
    def compare_full_table(self):
        ...
        while True:
            ...
            print(f"query {query_statement}, params {query_params}")
            ...
            print(f"query source & target rows, source rows: {len(source_rows)}, target rows {len(target_rows)} {get_elapsed_time(_start1, 2)}s.")
...
# source_dsn = {"host": "172.23.8.58", "user": "ghost", "password": "54448hotINBOX"}
# target_dsn = {"host": "10.242.23.60", "user": "ghost", "password": "54448hotINBOX"}
# MysqlTableCompare(
#     source_dsn,
#     target_dsn,
#     "merchant_center_ouku_v1",
#     "__delete_mc_products_cms_20220415",
#     "merchant_center_ouku_v1",
#     "__delete_mc_products_cms_20220415",
#     1,
#     10000,
