...
class GithubWorkflow(
    ...
    def __init__(
        ...
        *,
        ...
        :param github: -
        :param name: -
        :param concurrency_options: (experimental) Concurrency ensures that only a single job or workflow using the same concurrency group will run at a time. Currently in beta. Default: - { group: undefined, cancelInProgress: false }
