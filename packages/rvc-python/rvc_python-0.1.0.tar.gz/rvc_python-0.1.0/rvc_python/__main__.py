...
def main():
    ...
    for subparser in [cli_parser, api_parser]:
        ...
        subparser.add_argument("-de", "--device", type=str, default="cuda:0", help="Device to use (e.g., cpu:0, cuda:0)")
        subparser.add_argument("-me", "--method", type=str, default="harvest", choices=['harvest', "crepe", "rmvpe", 'pm'], help="Pitch extraction algorithm")
        subparser.add_argument("-v", "--version", type=str, default="v2", choices=['v1', "v2"], help="Model version")
        subparser.add_argument("-ir", "--index_rate", type=float, default=0.5, help="Search feature ratio")
        ...
        subparser.add_argument("-pr", '--protect', type=float, default=0.33, help='Protect voiceless consonants and breath sounds')
