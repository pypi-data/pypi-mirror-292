...
@pytest.fixture
def input_sample():
    return PromptInput(input="This is a test input.", properties={})
...
def test_property_test_case_caching(input_sample):
    ...
    test_case.run()
    original_prompt_duration = test_case.prompt.completion.latency

    test_case.run()
    new_prompt_duration = test_case.prompt.completion.latency
