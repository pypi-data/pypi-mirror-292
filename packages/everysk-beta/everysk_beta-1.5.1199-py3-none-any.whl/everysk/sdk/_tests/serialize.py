...
class SerializeDumpsSDKTestCase(TestCase):
    ...
    def test_sdk_entities_objects_private(self):
        self.assertEqual(
            ...
            '{"%s": "everysk.sdk.entities.private_security.base.PrivateSecurity", "created_on": {"__datetime__": "2024-06-20T14:38:59.360554+00:00"}, "currency": null, "data": null, "description": null, "instrument_type": null, "name": null, "symbol": null, "tags": [], "updated_on": {"__datetime__": "2024-06-20T14:38:59.360554+00:00"}, "version": "v1"}' % CLASS_KEY
        )

    def test_sdk_entities_objects_query(self):
        self.assertEqual(
            dumps(Query(Portfolio), sort_keys=True),
            '{"%s": "everysk.sdk.entities.query.Query", "_clean_order": [], "_errors": null, "_find_or_fail": false, "_is_frozen": false, "_klass": "Portfolio", "_silent": false, "distinct_on": [], "filters": [], "limit": null, "offset": null, "order": [], "page_size": null, "page_token": null, "projection": null}' % CLASS_KEY
        )
    ...
    def test_sdk_entities_objects_script(self):
        self.assertEqual(
            ...
            '{"%s": "everysk.sdk.entities.script.Script", "_errors": null, "_is_frozen": false, "_klass": "Portfolio", "_silent": false}' % CLASS_KEY
        )
