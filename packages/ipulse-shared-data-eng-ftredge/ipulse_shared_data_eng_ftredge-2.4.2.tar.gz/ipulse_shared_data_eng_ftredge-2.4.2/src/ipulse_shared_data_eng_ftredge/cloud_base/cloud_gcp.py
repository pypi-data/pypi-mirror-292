    ...
    try:
        ...
        # Assuming action_status["action_execution_details"] already contains some JSON data
            ...
            merge_job_details = {
                    ...
                    "action_job_output_bytes": merge_job.total_bytes_processed if merge_job.total_bytes_processed else 0,
                    "action_job_output_rows": merge_job.total_bytes_billed if merge_job.total_bytes_billed else 0,
