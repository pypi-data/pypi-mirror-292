...
class ContextLog:
    ...
    def __init__(self, level: LogLevel, base_context: Optional[str] = None,
                 execution_domain:Optional[str]=None,collector_id: Optional[str] = None,
                context: Optional[str] = None, description: Optional[str] = None,
                e: Optional[Exception] = None, e_type: Optional[str] = None,
                e_message: Optional[str] = None, e_traceback: Optional[str] = None,
                log_status:Optional[Status] = Status.OPEN, subject: Optional[str] = None,
