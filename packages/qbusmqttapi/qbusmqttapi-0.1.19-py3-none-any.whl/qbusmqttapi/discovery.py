...
class QbusMqttControllerState:
    ...
    def id(self) -> str | None:
        """Return the id."""
        return self._state.get(KEY_CONTROLLER_ID)
    ...
    def properties(self) -> QbusMqttControllerStateProperties | None:
        ...
        if self._state.get(KEY_CONTROLLER_STATE_PROPERTIES):
            properties = QbusMqttControllerStateProperties(self._state[KEY_CONTROLLER_STATE_PROPERTIES])
