...
class QbusMqttControllerStateProperties:
    ...
    def __init__(self) -> None:
        ...
        self._connecatable = None
        
    def parse_connection_message(self, state_topic: str, payload: str  | bytes, qos: int, retain: bool
    ) -> bool:
        try:
        ...
        if 'connectable' in json_data:
            self._connecatable = json_data["connectable"]
            
        if 'connected' in json_data:
            self._connected = json_data["connected"]
