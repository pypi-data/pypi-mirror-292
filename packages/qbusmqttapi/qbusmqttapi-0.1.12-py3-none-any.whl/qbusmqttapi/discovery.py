...
class QbusMqttDevice:
    ...
    @property
    def state_message(self, device_id: str) -> json:
        deviceArray = []
        deviceArray.append(device_id)
        retMsg = {}
        retMsg["topic"] = "cloudapp/QBUSMQTTGW/getState"
        retMsg["payload"] = deviceArray
...
class QbusDiscovery:
    ...
    def get_state_message(self, device_id: str) -> json:
        deviceArray = []
        deviceArray.append(device_id)
        retMsg = {}
        retMsg["topic"] = "cloudapp/QBUSMQTTGW/getState"
