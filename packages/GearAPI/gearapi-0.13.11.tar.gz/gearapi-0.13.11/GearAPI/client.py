...
from GearAPI.resource import events_resource, inventory_resource, measurements_resource
...
class Client:
    ...
    def __init__(
        ...
        self.rest_adaptor = RestAdaptor(user=user,password=password,base_url=base_url,tenant_id=tenant_id)
