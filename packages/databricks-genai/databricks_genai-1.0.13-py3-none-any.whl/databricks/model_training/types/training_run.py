...
class TrainingRun(DeserializableModel):
    ...
    def _repr_html_(self) -> str:
        ...
        keys = [
            ...
            "train_data_path", "eval_data_path", "register_to", "eval_prompts", "custom_weights_path",
            "data_prep_cluster_id", "experiment_id", "experiment_path"
        ]
    ...
    def _get_mlflow_message_html(self) -> str:
        """
        ...
        return f'Logged a {self._get_mlflow_run_link_html("run")} to an ' \
            f'{self._get_mlflow_experiment_link_html("experiment")} in MLflow.'
