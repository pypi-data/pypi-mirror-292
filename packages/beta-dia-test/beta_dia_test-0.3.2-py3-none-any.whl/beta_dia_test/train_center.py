...
def main():
    ...
    folder = Path(r'/home/mantou/data_4d/HeLa_Train/model_center_13_50/hdf')
    ...
    for epoch in range(epochs):
        ...
        if (acc_last_last >= acc_last) and (acc_last_last >= acc):
            fname = 'deepcenter_epoch_' + str(epoch) + '_ok.pt'
        ...
        # save
        fname = 'deepcenter_epoch_' + str(epoch) + '.pt'
        save_dir = folder.parent / 'model' / fname
        torch.save(model.state_dict(), save_dir)
