...
def test_iter(warehouses):
    try:
        ...
        expected_warehouse_names = [warehouse_name_1, warehouse_name_2.upper(), warehouse_name_3.upper()]
        ...
        # TODO(SNOW-1360661) - Please change this assert to 3 once you have fixed
        # this bug and uncomment the first assert
