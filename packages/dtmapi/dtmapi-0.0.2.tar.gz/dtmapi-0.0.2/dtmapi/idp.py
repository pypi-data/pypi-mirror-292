...
IDP_ADMIN_0_API = os.getenv("IDP_ADMIN_0_API")
IDP_ADMIN_1_API = os.getenv("IDP_ADMIN_1_API")
IDP_ADMIN_2_API = os.getenv("IDP_ADMIN_2_API")

def fetch_idp_data(api_url: str, params: Dict[str, Any], to_pandas: bool) -> Union[pd.DataFrame, Dict[str, Any]]:
    """
