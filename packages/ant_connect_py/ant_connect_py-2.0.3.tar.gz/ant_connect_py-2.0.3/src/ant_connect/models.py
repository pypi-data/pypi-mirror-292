...
class Permission(ModelBaseClass):
	...
	@classmethod
	@preprocess_arguments
	def create(cls, table_id: str, role_id: str, create: Optional[bool] = None, read: Optional[bool] = None, update: Optional[bool] = None, delete: Optional[bool] = None, configure: Optional[bool] = None) -> Permission:
		"""Create permissions
...
class Record(ModelBaseClass):
	...
	@classmethod
	@preprocess_arguments
	def delete(cls, table_id: str, records: Optional[List] = None) -> BaseModel.deletedMessage:
...
class Task(ModelBaseClass):
	...
	@classmethod
	@preprocess_arguments
	def all(cls, license_id: str, advanced_filters: Optional[List[dict]] = None) -> list[Task]:
		"""Get tasks

		Args:
			license_id(str): ID of license
			advanced_filters(List): No example available at the moment
		"""
		parameters = {
	...
	@classmethod
	@preprocess_arguments
	def delete(cls, tasks: Optional[List[dict]] = None) -> MessageResponse:
