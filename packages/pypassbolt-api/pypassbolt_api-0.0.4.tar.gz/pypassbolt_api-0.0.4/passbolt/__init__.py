...
class PassboltAPI:
        ...
        if dict_config:
            ...
            self.config = {
                ...
                "base_url": os.environ.get(
                    "PASSBOLT_BASE_URL", "https://undefined"
                ),
                "private_key": os.environ.get(
                    "PASSBOLT_PRIVATE_KEY", "undefined"
                ),
                "passphrase": os.environ.get(
                    "PASSBOLT_PASSPHRASE", "undefined"
                ),
                "fingerprint": os.environ.get(
                    "PASSBOLT_FINGERPRINT", "undefined"
                ),
    ...
    def create_resource(self, resource):
        return self.session.post(
            f"{self.base_url}/resources.json", json=resource
        )
    ...
    def update_resource(self, resource, id_resource):
        return self.session.put(
            f'{self.base_url}/resources/{id_resource}.json', json=resource
        )

    def delete_resource(self, id_resource):
        return self.session.delete(
            f'{self.base_url}/resources/{id_resource}.json'
        )
