...
from Codexes2Gemini.classes.Utilities.utilities import configure_logger, get_pip_version
...
def display_image_row(cols, image_info):
    for col, info in zip(cols, image_info):
        with col:
            ...
            image_resource_path = resources.files('Codexes2Gemini.resources.images').joinpath(os.path.basename(info["path"]))
