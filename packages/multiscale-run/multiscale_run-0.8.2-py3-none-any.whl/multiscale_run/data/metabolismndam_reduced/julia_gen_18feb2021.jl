function metabolism(du,u,p,t)
    ...
    # glycolysis
    V_Glc_n = 0.26 # mM/s # 0.00026 #mM/ms #
    V_Glc_a = 0.25 # mM/s # 0.00025 #mM/ms #
    K_Glc_n = 4.6 # mM
    K_Glc_a = 3.1 # mM
    mu_Glc_n = 0.09
    mu_Glc_a = 0.09
    ...
    # Krebs
    V_TCA_n = 0.03 # mM/s # 0.00003 #mM/ms #
    V_TCA_a = 0.01 # mM/s # 0.00001 #mM/ms #
    K_TCA_n = 0.01 # mM
    K_TCA_a = 0.01 # mM
    mu_TCA_n = 0.01
    mu_TCA_a = 0.01
    ...
    IK = p[6] #current density, uA/cm2 in Calvetti  #gK*(n^4)*(V-VK) + gKleak*(V-VK)  # based on Calvetti2018 gKleak depends on ksi and glutamate activation
    ...
    h = u[3]
    n = u[4]
    ksi = p[2] # u[36] # placeholder for callback activation related to glu
