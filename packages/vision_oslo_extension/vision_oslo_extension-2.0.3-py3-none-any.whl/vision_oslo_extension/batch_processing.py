...
def substation_process(simname, option_select,time_start, time_end,time_windows,time_increment):
    ...
    if option_select == "2":
        ...
        if not os.path.isfile(file):
            SharedMethods.print_message("ERROR: Please select option 1 First to calculate the Summary First. Process terminated...","31")
            return False 
        ...
        feeder_list,sum_df_list = grid_power_processing(simname, grid_df,time_increment)
...
def grid_power_processing(simname, grid_df,time_increment):    # Group by Grid Feeder and list OSLO IDs for each feeder
...
if __name__ == "__main__":
    ...
    simname = "Kent_Baseline_021"  # Provide a simulation name or adjust as needed
