...
class BedrockClient(BaseClient):
    ...
    def delete_imported_model(self, *, modelIdentifier: str) -> Dict[str, Any]:
        """
    ...
    def get_imported_model(self, *, modelIdentifier: str) -> GetImportedModelResponseTypeDef:
        """
    ...
    def get_model_import_job(self, *, jobIdentifier: str) -> GetModelImportJobResponseTypeDef:
        """
    ...
    def stop_model_invocation_job(self, *, jobIdentifier: str) -> Dict[str, Any]:
        """
