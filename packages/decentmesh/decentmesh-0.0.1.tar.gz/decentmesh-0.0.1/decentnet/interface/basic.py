...
class BasicInterface:
    ...
    def init_sending(self, owner_sign_key_send_id: int, owner_enc_key_send_id: int):
        ...
        """
        beacon_a, beam_a = self._single_relay_connect(owner_sign_key_send_id, owner_enc_key_send_id)
    ...
    def init_receiving(self, owner_sign_key_receive_id: int, owner_enc_key_receive_id: int):
        ...
        Returns:
            bool: True if encryption initialization is complete, False otherwise.
        """
        beacon_b, beam_b = self._single_relay_connect(owner_sign_key_receive_id, owner_enc_key_receive_id)
    ...
    def _single_relay_connect(self, owner_key_id: int, owner_enc_key_id: int) -> Tuple[Beacon, Beam]:
        """
        Connect to a single relay and initialize encryption.
    ...
    def _init_encryption(self, beam: Beam, difficulty: Difficulty = BlockchainParams.low_diff):
        """
