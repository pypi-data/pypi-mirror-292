...
class PowerBiWebClient:
    def __init__(self, tenant: str, keep_browser_open: bool):
        ...
        self.import_timeout_seconds         = 60 * 60 * 30
        self.import_polling_seconds         = 60
        self.active_refresh_timeout_seconds = 60 * 60 * 20
        self.active_refresh_polling_seconds = 60

        self._azure_credential : DefaultAzureCredential = DefaultAzureCredential(
    ...
    def token_string(self):
        if self._has_token_expired():
            ...
            azure_open_browser_fn = azure_browser._open_browser
            try:
                ...
                azure_browser._open_browser = azure_open_browser_fn
    ...
    def ensure_dataset_ownership(self, group_id: str, dataset_id: str):
        ...
        if self._azure_credential.credentials[0]._auth_record.username == dataset['configuredBy']:
    ...
    def import_report(
        ...
        req = Request(url, data=generate_body(), headers=headers, method="POST")
        try:
    ...
    def deploy_report(
        ...
        # UPLOAD PBIX FILE!
        import_id    = self.import_report(group_id, upload_report_name, pbix_file_path)
