...
def createDeployment(name: str, needsCd: bool = False):
...
def generateMetadataYaml(name: str, userEmail: str):
  return f"""
owner: {userEmail}
runtimeInfo:
  mainFunction: {name}
...
def _assertDeploymentName(name: str, repoRoot: str):
...
def writeTextFile(path: str, contents: str):
