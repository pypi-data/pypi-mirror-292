...
class BatchMetadata(_message.Message):
    ...
    class Item(_message.Message):
        __slots__ = ["data_type", "effective_time", "name", "status"]
        ...
        def __init__(self, name: Optional[str] = ..., effective_time: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., data_type: Optional[Union[FeatureServerComplexDataType, Mapping]] = ..., status: Optional[Iterable[Union[Status, str]]] = ...) -> None: ...
...
class Metadata(_message.Message):
    ...
    class Item(_message.Message):
        __slots__ = ["data_type", "effective_time", "name", "status", "type"]
        DATA_TYPE_FIELD_NUMBER: ClassVar[int]
        EFFECTIVE_TIME_FIELD_NUMBER: ClassVar[int]
        NAME_FIELD_NUMBER: ClassVar[int]
        STATUS_FIELD_NUMBER: ClassVar[int]
        ...
        status: Status
        type: FeatureServerDataType
        def __init__(self, name: Optional[str] = ..., effective_time: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., type: Optional[Union[FeatureServerDataType, str]] = ..., data_type: Optional[Union[FeatureServerComplexDataType, Mapping]] = ..., status: Optional[Union[Status, str]] = ...) -> None: ...
    FEATURES_FIELD_NUMBER: ClassVar[int]
    JOIN_KEYS_FIELD_NUMBER: ClassVar[int]
