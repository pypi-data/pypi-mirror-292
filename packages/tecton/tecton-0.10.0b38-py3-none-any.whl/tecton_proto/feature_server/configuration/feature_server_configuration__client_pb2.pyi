...
class Column(_message.Message):
    __slots__ = ["batch_table_feature_view_index", "data_type", "feature_service_space_name", "feature_view_index", "feature_view_space_name"]
    ...
    def __init__(self, data_type: Optional[Union[_data_type__client_pb2.DataType, Mapping]] = ..., feature_view_space_name: Optional[str] = ..., feature_service_space_name: Optional[str] = ..., feature_view_index: Optional[int] = ..., batch_table_feature_view_index: Optional[int] = ...) -> None: ...
...
class RealtimeFeaturesPlan(_message.Message):
    __slots__ = ["args_from_request_context", "compact_transformations", "feature_set_inputs", "feature_view_id", "feature_view_name", "outputs", "pipeline", "transformations"]
