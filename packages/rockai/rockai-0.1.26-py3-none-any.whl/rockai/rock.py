...
@app.command()
def start(auth: Annotated[str, typer.Option(help="Bearer auth token of the API server")] = None):
    """
    start local development server
    """
    start_server(8000,auth)
