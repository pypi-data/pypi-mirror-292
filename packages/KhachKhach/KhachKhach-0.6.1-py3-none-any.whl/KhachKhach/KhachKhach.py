...
class DetectionAnnotation:
    def __init__(self, output_folder: str):
        ...
        """
        # Load the YOLO model with the fixed 'yolov8n.pt' model
...
class KeypointAnnotator:
    def __init__(self, image_dir_path, annotate_dir_path):
        """
        Initialize the KeypointAnnotator with image directory path and annotation directory path.
        ...
        """
        self.model = YOLO('yolov8n-pose.pt')  # Fixed model path to 'yolov8n-pose.pt'
    ...
    def annotate_images(self):
        """
        Annotate images with keypoints using the YOLOv8n-pose model.
        """
