...
class Application:
	...
	def Print(message : str, logType : LogType) -> None:
		...
		levelName = LogType.GetLevelName(logType)
		level = logType.value
		...
		# 메시지 출력.
		logger.Print(f"[{timestamp}][{levelName}]{message}", level)		
