...
# sys.path.append(str(Path("./mthellolib").absolute()))
# sys.path.append(str(Path("./mtmtrain").absolute()))
sys.path.insert(0, str(Path("./mthellolib").absolute()))
...
if not is_in_vercel():
    ...
    # from mtmai.trans.trans_api import app as trans_app
    # app.mount("/api/v1/trans", trans_app)
    # pass
...
def main():
    ...
    elif args.command == "111":
        from mthellolib.main import hello_mthelolib
