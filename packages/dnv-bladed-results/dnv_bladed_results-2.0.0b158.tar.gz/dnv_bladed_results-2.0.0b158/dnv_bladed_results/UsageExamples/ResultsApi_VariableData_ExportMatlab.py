...
############   Bladed Results API: Export data using Matlab (.mat) file format   ############

# export_all_variables_in_group:
# Demonstrates how to export data for all variables in an output group to a Matlab data file.

# export_selected_variables:
# Demonstrates how to export data for selected 1D and 2D variables to the same Matlab data file.


def export_all_variables_in_group(directory, run_name, group_name, mat_file_path):
    ...
    try:
        ...
        print("\nSuccessfully exported all variables in output group '" + group_name + "' to " + mat_file_path)
...
def export_selected_variables(directory, run_name, variable_name_1d, variable_name_2d, mat_file_path):
...
# 1D group
export_all_variables_in_group("./Runs/demo/powprod5MW", "powprod5MW", "Hub loads: rotating GL coordinates", output_directory + "Hub_Loads.mat")

# 2D group - numeric secondary axis
export_all_variables_in_group("./Runs/demo/powprod5MW", "powprod5MW", "Blade 1 Loads: Principal axes", output_directory + "Blade_1_Loads.mat")

# 2D group - labelled string secondary axis
export_all_variables_in_group("./Runs/demo/powprod5MW", "powprod5MW", "Tower member loads - local coordinates", output_directory + "Tower_Member_Loads.mat")

# 1D + 2D variables
export_selected_variables("./Runs/demo/powprod5MW", "powprod5MW", "Rotating hub Mx", "Tower Mx", output_directory + "RotatingHubMx_TowerMx.mat")
