...
r"""
    ...
    """
AXIS_TYPE_ID_INTERVAL_AXIS = _ResultsAPI_Python.AxisTypeId_IntervalAxis
r""" An axis with fixed numeric intervals."""
AXIS_TYPE_ID_LABELLED_VALUE_AXIS = _ResultsAPI_Python.AxisTypeId_LabelledValueAxis
r""" An axis with variable numeric intervals."""
AXIS_TYPE_ID_LABELLED_STRING_AXIS = _ResultsAPI_Python.AxisTypeId_LabelledStringAxis
r""" An axis with string intervals."""
TEFILE_CREATION_CREATE = _ResultsAPI_Python.TEFileCreation_Create
r""" Create a $TE file when writing Bladed output group"""
TEFILE_CREATION_DO_NOT_CREATE = _ResultsAPI_Python.TEFileCreation_DoNotCreate
r""" Do not create a $TE file when writing Bladed output group"""
...
r"""
    ...
    Use `ResultsApi_SearchSettings` to include unsupported calculation types in the results.
    """
...
class ResultsApi_CacheSettings(object):
    r""" Contains global settings for the Results API relating to how data is read and cached."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    @staticmethod
    def set_buffered_read_enabled(buffered_read_enabled):
        r"""
        Set whether to buffer output group data.

        When enabled, the raw data buffer for each output group is retained in memory in between requests for variables.

        Enabling buffered read makes successive requests for variables from the same output group faster.

        Buffered read is enabled by default.
        ...
        Notes
        -----
        - Applies to binary output groups only.
        - Disabling buffered read can be used to conserve RAM. However, it incurs a performance penalty when making successive requests for variables from the same output group.
        - When buffered read is disabled, all existing buffers are removed.
        """

        return _ResultsAPI_Python.ResultsApi_CacheSettings_set_buffered_read_enabled(buffered_read_enabled)

    @staticmethod
    def set_run_caching_enabled(run_caching_enabled):
        r"""
        Set whether to cache requested runs.

        When enabled, `Run` objects are added to a cache. This makes subsequent requests for the same run faster.

        Run caching is enabled by default.
        ...
        Notes
        -----
        - Disabling run caching read can be used to conserve RAM. However, it incurs a performance penalty when making successive requests for the same run.
        - When run caching is disabled, any cached `Run` objects are released.
        """

        return _ResultsAPI_Python.ResultsApi_CacheSettings_set_run_caching_enabled(run_caching_enabled)

    @staticmethod
    def set_data_type_for_reading(data_type_specifier):
        r"""
        Set the data type to use when reading variables.
        ...
        - Calling this method does not affect the precision of data already cached. It only affects the precision used when reading variables from output groups not yet read in the current session.
        - All variables belonging to the same output group will be read with the same precision.
        - The precision used for reading a specific output group is determined the first time a variable is read from the group.
        - The Software Performance output group is written as integer (4 byte signed int).
        """

        return _ResultsAPI_Python.ResultsApi_CacheSettings_set_data_type_for_reading(data_type_specifier)

    def __init__(self):
        r"""__init__(ResultsApi_CacheSettings self) -> ResultsApi_CacheSettings"""
        _ResultsAPI_Python.ResultsApi_CacheSettings_swiginit(self, _ResultsAPI_Python.new_ResultsApi_CacheSettings())
    __swig_destroy__ = _ResultsAPI_Python.delete_ResultsApi_CacheSettings

# Register ResultsApi_CacheSettings in _ResultsAPI_Python:
_ResultsAPI_Python.ResultsApi_CacheSettings_swigregister(ResultsApi_CacheSettings)
class ResultsApi_SearchSettings(object):
    r""" Contains global settings for the Results API relating to how runs are filtered in a request."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    @staticmethod
    def set_calculation_type_filter(calculation_type_filter):
        r"""
        Filter runs based on the calculation type.
        ...
        The default setting includes all calculation types.
        ...
        return _ResultsAPI_Python.ResultsApi_SearchSettings_set_calculation_type_filter(calculation_type_filter)

    @staticmethod
    def set_include_unsupported_calculations(include_unsupported_calculations):
        r"""
        Set whether to include runs with an unsupported calculation type in the results.

        The default setting is to include such runs.

        Unsupported calculation types include:

        - UltimateLoadsAnalysis
        - ExtremeLoadExtrapolation
        - WindTurbulence
        ...
        return _ResultsAPI_Python.ResultsApi_SearchSettings_set_include_unsupported_calculations(include_unsupported_calculations)

    @staticmethod
    def set_completion_state_filter(completion_state_filter):
        r"""
        Filter runs based on completion state.

        The default setting is to include all completion states.
        ...
        return _ResultsAPI_Python.ResultsApi_SearchSettings_set_completion_state_filter(completion_state_filter)

    @staticmethod
    def set_run_name_case_sensitivity(run_name_case_sensitivity):
        r"""
        Set whether to observe or ignore the character case when matching run names.
        ...
        return _ResultsAPI_Python.ResultsApi_SearchSettings_set_run_name_case_sensitivity(run_name_case_sensitivity)

    def __init__(self):
        r"""__init__(ResultsApi_SearchSettings self) -> ResultsApi_SearchSettings"""
        _ResultsAPI_Python.ResultsApi_SearchSettings_swiginit(self, _ResultsAPI_Python.new_ResultsApi_SearchSettings())
    __swig_destroy__ = _ResultsAPI_Python.delete_ResultsApi_SearchSettings

# Register ResultsApi_SearchSettings in _ResultsAPI_Python:
_ResultsAPI_Python.ResultsApi_SearchSettings_swigregister(ResultsApi_SearchSettings)
INDEPENDENT_VARIABLE_ID_PRIMARY_INDEPENDENT_VARIABLE = _ResultsAPI_Python.IndependentVariableId_PrimaryIndependentVariable
r"""
...
INDEPENDENT_VARIABLE_ID_SECONDARY_INDEPENDENT_VARIABLE = _ResultsAPI_Python.IndependentVariableId_SecondaryIndependentVariable
r"""
...
class IndependentVariable(object):
    ...
    def get_name(self) -> str:
        ...
        Notes
        -----
        - The name of the independent variable is indicated by the value of AXISLAB in the group header file.
        """

        return _ResultsAPI_Python.IndependentVariable_get_name(self)

    def get_siunit(self) -> str:
        r"""
        ...
        return _ResultsAPI_Python.IndependentVariable_get_siunit(self)
    ...
    def get_axis_type(self):
        ...
        -------
        int
            An integer constant indicating the axis type of the independent variable. Refer to individual `AXIS_TYPE_ID` constants for further information.
        """

        return _ResultsAPI_Python.IndependentVariable_get_axis_type(self)
    ...
    def get_number_of_values(self):
        ...
        - If the axis is an interval axis type, returns the number of data points, or 0 if the independent variable does not belong to an output group.
        - Use `IndependentVariable.get_axis_type` to enquire the axis type.
        """

        return _ResultsAPI_Python.IndependentVariable_get_number_of_values(self)
    ...
    def get_values_as_string(self) -> np.ndarray[str]:
        ...
        Notes
        -----
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_values_as_string_native_array` to avoid this penalty.
        """

        return np.array(self._get_values_as_string_native_array(), dtype=str, copy=False)
    ...
    def get_values_as_number(self) -> np.ndarray[np.float64]:
        ...
        Notes
        -----
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_values_as_number_native_array` to avoid this penalty.
        """
...
class Variable(object):
    ...
    - A `Variable` object may be converted to one of `Variable1D` or `Variable2D` (depending on its sub-type)
      using `Run.get_variable_1d` and `Run.get_variable_2d`.
    ...
    def get_name(self) -> str:
        r"""
        Gets the unabbreviated name of the variable.

        Returns
        -------
        str
            A string containing the unabbreviated name of the variable.
        """

        return _ResultsAPI_Python.Variable_get_name(self)
    ...
    def get_siunit(self) -> str:
        ...
        return _ResultsAPI_Python.Variable_get_siunit(self)

    def get_quantity_code(self) -> str:
        r"""
        ...
        return _ResultsAPI_Python.Variable_get_quantity_code(self)

    def get_number_of_independent_variables(self):
        r"""
        ...
        Notes
        -----
        - A one-dimensional `Variable1D` object represents a dependent variable (the variable under observation)
          with respect to one independent variable, such as time.
        - A two-dimensional `Variable2D` object represents a dependent variable (the variable under observation)
          with respect to two independent variables, such as time, and measurement location (e.g. distance along blade).
        """

        return _ResultsAPI_Python.Variable_get_number_of_independent_variables(self)

    def get_parent_group_name(self) -> str:
        r"""
        Gets the name of the parent output group.

        Returns
        -------
        str
            A string containing the name of the parent output group.

        Notes
        -----
        - The name of the parent output group is indicated by the value of GENLAB label in the header file.
        """

        return _ResultsAPI_Python.Variable_get_parent_group_name(self)

    def get_parent_group_number(self):
        r"""
        Gets the number of the parent output group.

        Returns
        -------
        int
            A positive integer indicating the number of the parent output group.

        Notes
        -----
        - The output group number is unique within a given run.
        - The output group number is used in the file extension of the output group.
        """

        return _ResultsAPI_Python.Variable_get_parent_group_number(self)

    def get_parent_group_header_file_full_path(self) -> str:
        r"""
        Gets the the full path to the parent output group header file.

        Returns
        -------
        str
            A string containing the full path to the parent output group header file.
        """

        return _ResultsAPI_Python.Variable_get_parent_group_header_file_full_path(self)

    def get_time_domain_simulation_length(self):
        r"""
        Gets the length in seconds of the time domain simulation that produced the variable.

        Returns
        -------
        float
            A double-precision floating-point value containing length in seconds of the time domain simulation.

        Notes
        -----
        - Applies only to time domain simulations; raises an exception if called for a non-time domain calculation.
        - The wall-clock duration of a calculation may be requested using `Run.get_execution_duration_seconds`.
        """

        return _ResultsAPI_Python.Variable_get_time_domain_simulation_length(self)

    def get_data_point_count(self):
        r"""
        Gets the number of data points recorded for the variable. In a time domain simulation, this is equivalent to
        the number of output timesteps.
        ...
        - For a `Variable2D`, returns the number of data points recorded for any given secondary independent
          variable (not the aggregate count of all secondary independent variables).
        """

        return _ResultsAPI_Python.Variable_get_data_point_count(self)
    ...
    def get_data_type(self):
        ...
        - Use `ResultsApi_CacheSettings` to set the data type to use globally.
        """

        return _ResultsAPI_Python.Variable_get_data_type(self)
    ...
    def get_data_format(self):
        ...
        return _ResultsAPI_Python.Variable_get_data_format(self)
    ...
    def get_independent_variables(self) -> np.ndarray[IndependentVariable]:
        ...
        Notes
        -----
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_independent_variables_native_array` to avoid this penalty.
        """

        return np.array(self._get_independent_variables_native_array(), copy=False)
...
class OutputGroup(IOutputSpecification):
    r""" Base class representing a Bladed output group for writing."""
    ...
    def get_path(self) -> str:
        ...
        return _ResultsAPI_Python.OutputGroup_get_path(self)
    ...
    def get_file_format(self):
        ...
        return _ResultsAPI_Python.OutputGroup_get_file_format(self)
    ...
    def get_group_name(self) -> str:
        ...
        return _ResultsAPI_Python.OutputGroup_get_group_name(self)
    ...
    def get_data_source(self) -> str:
        ...
        return _ResultsAPI_Python.OutputGroup_get_data_source(self)

    def get_group_config(self) -> str:
        r"""
        Gets the data config of the output group.

        Returns
        -------
        str
            A string containing the data config of the output group.
        """

        return _ResultsAPI_Python.OutputGroup_get_group_config(self)

    def get_variable_data_format(self):
        r"""
        ...
        return _ResultsAPI_Python.OutputGroup_get_variable_data_format(self)

    def get_data_file_path(self) -> str:
        r"""
        Gets the data file path output group.
        ...
        return _ResultsAPI_Python.OutputGroup_get_data_file_path(self)

    def set_tefile_creation(self, te_file_creation):
        r"""
        Sets whether to create a $TE file when writing the output group.

        Parameters
        ----------
        te_file_creation : int
            An integer constant indicating whether to create a $TE file. Default = `TEFILE_CREATION_CREATE`. Refer to individual `TEFILE_CREATION` constants for further information.

        Notes
        -----
        - Creating a $TE allows Bladed outputs to be consumed via the ResultsAPI.
        - The $TE file has the same filename as the output group.
        """

        return _ResultsAPI_Python.OutputGroup_set_tefile_creation(self, te_file_creation)
...
class Run(object):
    ...
    - Use `Run.get_all_groups` to obtain a contiguous array of `Group` objects describing the content of the run.
    """
    ...
    def get_name(self) -> str:
        ...
        Notes
        -----
        - The name returned is the filesystem name, not the group header file CONTENT value.
        """

        return _ResultsAPI_Python.Run_get_name(self)
    ...
    def get_directory(self) -> str:
        ...
        Notes
        -----
        - A canonicalised directory refers to the shortest absolute path to a directory.
          Canonicalisation allows result directories to be identified uniquely.
        - The path separator is portable across platforms.
        """

        return _ResultsAPI_Python.Run_get_directory(self)

    def get_termination_file_content(self) -> str:
        r"""
        ...
        return _ResultsAPI_Python.Run_get_termination_file_content(self)

    def get_termination_file_path(self) -> str:
        r"""
        ...
        return _ResultsAPI_Python.Run_get_termination_file_path(self)
    ...
    def get_message_file_content(self):
        ...
        return _ResultsAPI_Python.Run_get_message_file_content(self)

    def get_verification_file_content(self) -> str:
        r"""
        ...
        return _ResultsAPI_Python.Run_get_verification_file_content(self)
    ...
    def get_timestamp(self) -> str:
        ...
        return _ResultsAPI_Python.Run_get_timestamp(self)

    def get_execution_duration_seconds(self):
        r"""
        ...
        Notes
        -----
        - Run execution duration is calculated by comparing the modification time of the run termination ($TE)
          file against that of the run verification ($VE) file.
        - Raises an exception if the returned time is negative - this indicates the $VE file was modified after the run completed.
        """

        return _ResultsAPI_Python.Run_get_execution_duration_seconds(self)
    ...
    def get_completion_state(self):
        ...
        return _ResultsAPI_Python.Run_get_completion_state(self)
    ...
    def has_finished(self):
        ...
        -------
        bool
            A boolean indicating whether the run has finished. Use `Run.was_successful` for an indication of run success, or `Run.get_completion_state` for more precise state information.
        """

        return _ResultsAPI_Python.Run_has_finished(self)
    ...
    def was_successful(self):
        ...
        return _ResultsAPI_Python.Run_was_successful(self)

    def was_unsuccessful(self):
        r"""
        Indicates whether the run did not complete successfully.

        Returns
        -------
        bool
            A boolean indicating whether the run did not complete successfully.
        ...
        return _ResultsAPI_Python.Run_was_unsuccessful(self)

    def get_calculation_descriptive_name(self) -> str:
        r"""
        ...
        return _ResultsAPI_Python.Run_get_calculation_descriptive_name(self)
    ...
    def get_calculation_type(self):
        ...
        return _ResultsAPI_Python.Run_get_calculation_type(self)

    def is_turbine_simulation(self):
        r"""
        ...
        return _ResultsAPI_Python.Run_is_turbine_simulation(self)

    def is_supporting_calculation(self):
        r"""
        ...
        return _ResultsAPI_Python.Run_is_supporting_calculation(self)

    def is_post_processing_calculation(self):
        r"""
        ...
        return _ResultsAPI_Python.Run_is_post_processing_calculation(self)

    def is_calculation_type_supported(self):
        r"""
        ...
        Notes
        -----
        - An unsupported calculation type typically contains data in a format that is not currently readable
          by the Results API. Support for reading such formats may be added in a future release.
        ...
        return _ResultsAPI_Python.Run_is_calculation_type_supported(self)
    ...
    def contains_variable_1d(self, variable_name):
        ...
        - A one-dimensional variable object (`Variable1D`) object represents a dependent variable
          (the variable under observation) with respect to one independent variable, such as time.
        """
    ...
    def contains_variable_2d(self, variable_name):
        ...
        -----
        - Variable name comparison is case-insensitive.
        - A two-dimensional variable object (`Variable2D`) represents a dependent variable
          (the variable under observation) with respect to two independent variables, such as time, and measurement location (e.g. distance along blade).
        """
    ...
    def _get_variable(self, variable_name: str) -> Variable:
        ...
        -----
        - Variable name comparison is case-insensitive.
        - A `Variable` object is the base type of one-dimensional variable (`Variable1D`) and two-dimensional
          variable (`Variable2D`) objects. It may be used to request metadata common to both one-dimensional and two-dimensional variables.
    ...
    def _get_variable_from_specific_output_group(self, variable_name: str, specific_group_name: str) -> Variable:
        r"""
        Gets a base variable with the specified name and from the specified output group.
        ...
        specific_group_name : str
            The name of the output group containing the variable.
        ...
        - Improves lookup performance by targeting a single output group expected to contain the variable, and skipping other output groups.
        - A `Variable` object is the base type of one-dimensional variable (`Variable1D`) and two-dimensional variable (`Variable2D`) objects.
          It may be used to request metadata common to both one-dimensional and two-dimensional variables.
        - Use `Run.get_variable_1d` or `Run.get_variable_2d` as appropriate to obtain a variable that provides access to data.
        """

        return _ResultsAPI_Python.Run__get_variable_from_specific_output_group(self, variable_name, specific_group_name)
    ...
    def unload_variable(self, variable_name):
        ...
        Notes
        -----
        - Function may be used to conserve memory when operating on large data sets.
        - Variable name comparison is case-insensitive.
        """
    ...
    def unload_variable_from_specific_group(self, variable_name, specific_group_name):
        r"""
        Unloads a cached variable with the specified name and from the specified output group.
        ...
        - Variable name comparison is case-insensitive.
        - Group name comparison is case-insensitive.
        - Improves lookup performance by targeting a single output group expected to contain the variable,
          and skipping other output groups.
        """

        return _ResultsAPI_Python.Run_unload_variable_from_specific_group(self, variable_name, specific_group_name)

    def _get_all_groups_native_array(self) -> ArrayOfGroup:
        r"""
        Gets all output groups belonging to the run.
        ...
        return _ResultsAPI_Python.Run__get_all_groups_native_array(self)

    def get_group(self, group_name: str) -> Group:
        r"""
        Gets a specific output group in the run.

        Parameters
        ----------
        group_name : str
            The name of the output group to return.
        ...
        return _ResultsAPI_Python.Run_get_group(self, group_name)
    ...
    def get_variable_1d(self, variable_name: str) -> Variable1D_Float32 | Variable1D_Float64 | Variable1D_Int32:
        ...
        -----
        - Variable name comparison is case-insensitive.
        - A one-dimensional variable object represents a dependent variable (the variable under observation)
          with respect to one independent variable, such as time.
        """
    ...
    def get_variable_1d_from_specific_output_group(self, variable_name: str, specific_group_name: str) -> Variable1D_Float32 | Variable1D_Float64 | Variable1D_Int32:
        r"""
        Gets a one-dimensional variable with the specified name and from the specified output group.
        ...
        - Variable name comparison is case-insensitive.
        - Group name comparison is case-insensitive.
        - A one-dimensional variable object represents a dependent variable (the variable under
          observation) with respect to one independent variable, such as time.
        """

        variable = self._get_variable_from_specific_output_group(variable_name, specific_group_name)
        data_type = variable.get_data_type()
        if (data_type == VARIABLE_DATA_TYPE_FLOAT32):
            return self._get_variable_1d_from_specific_output_group_float32(variable_name, specific_group_name)
        elif (data_type == VARIABLE_DATA_TYPE_FLOAT64):
            return self._get_variable_1d_from_specific_output_group_float64(variable_name, specific_group_name)
        elif (data_type == VARIABLE_DATA_TYPE_INT32):
            return self._get_variable_1d_from_specific_output_group_int32(variable_name, specific_group_name)
        else:
            raise TypeError("Variable1D data type not supported: " + str(data_type))
    ...
    def get_variable_2d(self, variable_name: str) -> Variable2D_Float32 | Variable2D_Float64 | Variable2D_Int32:
        ...
        - Variable name comparison is case-insensitive.
        - Group name comparison is case-insensitive.
        - A two-dimensional variable object represents a dependent variable (the variable under observation)
          with respect to two independent variables, such as time, and measurement location (e.g. distance along blade).
        """
    ...
    def get_variable_2d_from_specific_output_group(self, variable_name: str, specific_group_name: str) -> Variable2D_Float32 | Variable2D_Float64 | Variable2D_Int32:
        r"""
        Gets a two-dimensional variable with the specified name and from the specified output group.
        ...
        data_type = variable.get_data_type()
        if (data_type == VARIABLE_DATA_TYPE_FLOAT32):
            return self._get_variable_2d_from_specific_output_group_float32(variable_name, specific_group_name)
        elif (data_type == VARIABLE_DATA_TYPE_FLOAT64):
            return self._get_variable_2d_from_specific_output_group_float64(variable_name, specific_group_name)
        elif (data_type == VARIABLE_DATA_TYPE_INT32):
            return self._get_variable_2d_from_specific_output_group_int32(variable_name, specific_group_name)
        else:
            raise TypeError("Variable2D data type not supported: " + str(data_type))

    # Wrapped vector to Numpy array conversion
    # Performs a copy but should be inexpensive as the underlying container is of type shared_ptr<Group>
    def get_all_groups(self) -> np.ndarray[Group]:
        r"""
        Gets all output groups belonging to the run.
        ...
        Notes
        -----
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_all_groups_native_array` to avoid this penalty.
        """

        return np.array(self._get_all_groups_native_array(), copy=False)
    ...
    def _get_variable_1d_float32(self, variable_name: str) -> Variable1D_Float32:
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_1d_float32(self, variable_name)
    ...
    def _get_variable_1d_float64(self, variable_name: str) -> Variable1D_Float64:
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_1d_float64(self, variable_name)
    ...
    def _get_variable_1d_int32(self, variable_name: str) -> Variable1D_Int32:
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_1d_int32(self, variable_name)

    def _get_variable_1d_from_specific_output_group_float32(self, variable_name: str, specific_group_name: str) -> Variable1D_Float32:
        r"""
        Gets a one-dimensional variable with the specified name and from the specified output group.
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_1d_from_specific_output_group_float32(self, variable_name, specific_group_name)

    def _get_variable_1d_from_specific_output_group_float64(self, variable_name: str, specific_group_name: str) -> Variable1D_Float64:
        r"""
        Gets a one-dimensional variable with the specified name and from the specified output group.
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_1d_from_specific_output_group_float64(self, variable_name, specific_group_name)

    def _get_variable_1d_from_specific_output_group_int32(self, variable_name: str, specific_group_name: str) -> Variable1D_Int32:
        r"""
        Gets a one-dimensional variable with the specified name and from the specified output group.
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_1d_from_specific_output_group_int32(self, variable_name, specific_group_name)
    ...
    def _get_variable_2d_float32(self, variable_name: str) -> Variable2D_Float32:
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_2d_float32(self, variable_name)
    ...
    def _get_variable_2d_float64(self, variable_name: str) -> Variable2D_Float64:
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_2d_float64(self, variable_name)
    ...
    def _get_variable_2d_int32(self, variable_name: str) -> Variable2D_Int32:
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_2d_int32(self, variable_name)

    def _get_variable_2d_from_specific_output_group_float32(self, variable_name: str, specific_group_name: str) -> Variable2D_Float32:
        r"""
        Gets a two-dimensional variable with the specified name and from the specified output group.
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_2d_from_specific_output_group_float32(self, variable_name, specific_group_name)

    def _get_variable_2d_from_specific_output_group_float64(self, variable_name: str, specific_group_name: str) -> Variable2D_Float64:
        r"""
        Gets a two-dimensional variable with the specified name and from the specified output group.
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_2d_from_specific_output_group_float64(self, variable_name, specific_group_name)

    def _get_variable_2d_from_specific_output_group_int32(self, variable_name: str, specific_group_name: str) -> Variable2D_Int32:
        r"""
        Gets a two-dimensional variable with the specified name and from the specified output group.
        ...
        return _ResultsAPI_Python.Run__RUNPREFIX_get_variable_2d_from_specific_output_group_int32(self, variable_name, specific_group_name)
...
class Group(object):
    r"""
    Class representing a Bladed output group.

    Notes
    -----
    - An output group contains a set of related variables, grouped together for convenience.
      For example, the output group 'Tower member loads - local coordinates' contains variables describing the
      components of load at selected member ends of a multi-member tower.
    - Provides access to dependent (`Variable`; `Variable1D`; `Variable2D`) and independent variable
      (`IndependentVariable`) objects.
    """
    ...
    def get_name(self) -> str:
        ...
        Notes
        -----
        - The name of the output group is indicated by the group header file GENLAB value.
        """

        return _ResultsAPI_Python.Group_get_name(self)

    def get_number(self):
        r"""
        Gets the number of the output group.

        Returns
        -------
        int
            A positive integer indicating the number of the output group.

        Notes
        -----
        - The output group number is unique within a given run.
        - The output group number is used in the output group's file extension.
        """

        return _ResultsAPI_Python.Group_get_number(self)
    ...
    def get_header_file_path(self) -> str:
        ...
        -----
        - A canonicalised directory refers to the shortest absolute path to a directory.
          Canonicalisation allows result directories to be uniquely identified.
        - The path separator is portable across platforms.
        """

        return _ResultsAPI_Python.Group_get_header_file_path(self)
    ...
    def get_number_of_variables(self):
        ...
        return _ResultsAPI_Python.Group_get_number_of_variables(self)
    ...
    def get_number_of_independent_variables(self):
        ...
        return _ResultsAPI_Python.Group_get_number_of_independent_variables(self)
    ...
    def get_variable(self, variable_name: str) -> Variable:
        ...
        -----
        - Variable name comparison is case-insensitive.
        - A `Variable` object is the base type of one-dimensional (`Variable1D`) and two-dimensional
          (`Variable2D`) objects. It may be used to request metadata common to both one-dimensional and two-dimensional variables.
        - Use `Run.get_variable_1d` or `Run.get_variable_2d` as appropriate to obtain a variable that provides access to data.
        """

        return _ResultsAPI_Python.Group_get_variable(self, variable_name)

    def _get_variable_names_native_array(self) -> ArrayOfString:
        r"""
        Gets the names of all variables belonging to the group.
        ...
        Notes
        -----
        - Dependent variable names are indicated by the group header file VARIAB value.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        - Enquire the length of the array using Python's built-in `len()` function.
        """
    ...
    def _get_independent_variables_native_array(self) -> ArrayOfIndependentVariable:
        ...
        Notes
        -----
        - An independent variable name is indicated by the group header file AXISLAB value.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        - Enquire the length of the array using Python's built-in `len()` function.
        """
    ...
    def get_calculation_short_name(self) -> str:
        r"""
        ...
        Notes
        -----
        - The calculation short name is indicated by the group header file CONTENT value.
        """

        return _ResultsAPI_Python.Group_get_calculation_short_name(self)
    ...
    def get_calculation_descriptive_name(self) -> str:
        ...
        return _ResultsAPI_Python.Group_get_calculation_descriptive_name(self)
    ...
    def get_calculation_type(self):
        ...
        return _ResultsAPI_Python.Group_get_calculation_type(self)

    def get_time_domain_simulation_length(self):
        r"""
        Gets the length in seconds of the time domain simulation that produced the group.
        ...
        -----
        - Applies only to time domain simulations; raises an exception if called for a non-time domain calculation.
        - Use `Run.get_execution_duration_seconds` to get the wall-clock duration of a calculation.
        """

        return _ResultsAPI_Python.Group_get_time_domain_simulation_length(self)
    ...
    def get_data_point_count(self):
        ...
        Notes
        -----
        - For a one-dimensional group (a group comprising one-dimensional variables), returns the number of data
          points recorded for any given variable.
        - For a two-dimensional group (a group comprising two-dimensional variables), returns the number of data
          points recorded for any given secondary independent variable (not the aggregate count of all secondary independent variables).
        """

        return _ResultsAPI_Python.Group_get_data_point_count(self)

    def get_variable_data_type(self):
        r"""
        Gets the data type of the group. This matches the data type of all variables in the group.
        ...
        return _ResultsAPI_Python.Group_get_variable_data_type(self)

    def get_variable_data_format(self):
        r"""
        Gets the data format of the group. This matches the data format of all variables in the group.
        ...
        return _ResultsAPI_Python.Group_get_variable_data_format(self)
    ...
    def get_variable_1d(self, variable_name: str) -> Variable1D_Float32 | Variable1D_Float64 | Variable1D_Int32:
        ...
        data_type = self.get_variable_data_type()
        if (data_type == VARIABLE_DATA_TYPE_FLOAT32):
            return self._get_variable_1d_float32(variable_name)
        elif (data_type == VARIABLE_DATA_TYPE_FLOAT64):
            return self._get_variable_1d_float64(variable_name)
    ...
    def _get_all_variables_1d_native_array(self) -> ArrayOfVariable1D_Float32 | ArrayOfVariable1D_Float64 | ArrayOfVariable1D_Int32:
        r"""
        ...
        Notes
        -----
        - The group must be one-dimensional (containing variables of subtype `Variable1D`) for the call to succeed.
        - Dependent variable names are indicated by the group header file VARIAB value.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        - Enquire the length of the array using Python's built-in `len()` function.
        """
        ...
        data_type = self.get_variable_data_type()
        if (data_type == VARIABLE_DATA_TYPE_FLOAT32):
            return np.array(self._get_all_variables_1d_float32_native_array(), copy=False)
        elif (data_type == VARIABLE_DATA_TYPE_FLOAT64):
            return np.array(self._get_all_variables_1d_float64_native_array(), copy=False)
        elif (data_type == VARIABLE_DATA_TYPE_INT32):
            return np.array(self._get_all_variables_1d_int32_native_array(), copy=False)
        else:
            raise TypeError("Variable1D data type not supported: " + str(data_type))

    # Wrapped vector to Numpy array conversion
    # Performs a copy but should be inexpensive as the underlying container is of type shared_ptr<Variable1D>
    def get_all_variables_1d(self) -> np.ndarray[Variable1D_Float32] | np.ndarray[Variable1D_Float64] | np.ndarray[Variable1D_Int32]:
        r"""
        Gets all one-dimensional variables belonging to the group.
        ...
        - The group must be one-dimensional (containing variables of subtype `Variable1D`) for the call to succeed.
        - Dependent variable names are indicated by the group header file VARIAB value.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_all_variables_1d_native_array` to avoid this penalty.
        """

        return np.array(self._get_all_variables_1d_native_array(), copy=False)
    ...
    # Native array, type agnostic
    def _get_all_variables_2d_native_array(self) -> ArrayOfVariable2D_Float32 | ArrayOfVariable2D_Float64 | ArrayOfVariable2D_Int32:
        r"""
        ...
        Notes
        -----
        - The group must be two-dimensional (containing variables of subtype `Variable2D`) for the call to succeed.
        - Dependent variable names are indicated by the group header file VARIAB value.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        - Enquire the length of the array using Python's built-in `len()` function.
        """
        ...
        data_type = self.get_variable_data_type()
        if (data_type == VARIABLE_DATA_TYPE_FLOAT32):
            return np.array(self._get_all_variables_2d_float32_native_array(), copy=False)
        elif (data_type == VARIABLE_DATA_TYPE_FLOAT64):
            return np.array(self._get_all_variables_2d_float64_native_array(), copy=False)
        elif (data_type == VARIABLE_DATA_TYPE_INT32):
            return np.array(self._get_all_variables_2d_int32_native_array(), copy=False)
        else:
            raise TypeError("Variable2D data type not supported: " + str(data_type))

    # Wrapped vector to Numpy array conversion
    # Performs a copy but should be inexpensive as the underlying container is of type shared_ptr<Variable2D>
    def get_all_variables_2d(self) -> np.ndarray[Variable2D_Float32] | np.ndarray[Variable2D_Float64] | np.ndarray[Variable2D_Int32]:
        r"""
        Gets all two-dimensional variables belonging to the group.
        ...
        - The group must be two-dimensional (containing variables of subtype `Variable2D`) for the call to succeed.
        - Dependent variable names are indicated by the group header file VARIAB value.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_all_variables_2d_native_array` to avoid this penalty.
        """

        return np.array(self._get_all_variables_2d_native_array(), copy=False)
    ...
    def get_variable_names(self) -> np.ndarray[str]:
        ...
        -----
        - Dependent variable names are indicated by the group header file VARIAB value.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_variable_names_native_array` to avoid this penalty.
        """

        return np.array(self._get_variable_names_native_array(), copy=False)
    ...
    def _get_variable_1d_float32(self, variable_name: str) -> Variable1D_Float32:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variable_1d_float32(self, variable_name)
    ...
    def _get_variable_1d_float64(self, variable_name: str) -> Variable1D_Float64:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variable_1d_float64(self, variable_name)
    ...
    def _get_variable_1d_int32(self, variable_name: str) -> Variable1D_Int32:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variable_1d_int32(self, variable_name)

    def _get_all_variables_1d_float32_native_array(self) -> ArrayOfVariable1D_Float32:
        r"""
        Gets all one-dimensional variables belonging to the group.
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_all_variables_1d_float32_native_array(self)

    def _get_all_variables_1d_float64_native_array(self) -> ArrayOfVariable1D_Float64:
        r"""
        Gets all one-dimensional variables belonging to the group.
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_all_variables_1d_float64_native_array(self)

    def _get_all_variables_1d_int32_native_array(self) -> ArrayOfVariable1D_Int32:
        r"""
        Gets all one-dimensional variables belonging to the group.
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_all_variables_1d_int32_native_array(self)
    ...
    def _get_variable_2d_float32(self, variable_name: str) -> Variable2D_Float32:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variable_2d_float32(self, variable_name)
    ...
    def _get_variable_2d_float64(self, variable_name: str) -> Variable2D_Float64:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variable_2d_float64(self, variable_name)
    ...
    def _get_variable_2d_int32(self, variable_name: str) -> Variable2D_Int32:
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_variable_2d_int32(self, variable_name)

    def _get_all_variables_2d_float32_native_array(self) -> ArrayOfVariable2D_Float32:
        r"""
        Gets all two-dimensional variables belonging to the group.
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_all_variables_2d_float32_native_array(self)

    def _get_all_variables_2d_float64_native_array(self) -> ArrayOfVariable2D_Float64:
        r"""
        Gets all two-dimensional variables belonging to the group.
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_all_variables_2d_float64_native_array(self)

    def _get_all_variables_2d_int32_native_array(self) -> ArrayOfVariable2D_Int32:
        r"""
        Gets all two-dimensional variables belonging to the group.
        ...
        return _ResultsAPI_Python.Group__GROUPPREFIX_get_all_variables_2d_int32_native_array(self)
...
class RunsIterator(object):
    ...
    def __init__(self, *args):
        ...
        **Function variant 1:**
        ...
        Notes
        -----
        - Use `ResultsApi_SearchSettings` to filter runs based on properties such as calculation type.
        - Run name comparison is case-insensitive by default. Use `ResultsApi_SearchSettings` to change the
        ...
        **Function variant 3:**
        ...
        Creates a new `RunsIterator` object to match all runs sequentially regardless of name.
        :param searchScope: An integer constant indicating whether to recursively include subdirectories in the search. Default = `SEARCH_SCOPE_RECURSIVE_SEARCH`. Refer to individual `SEARCH_SCOPE` constants for further information.
...
class RunsIteratorRegex(RunsIterator):
    ...
    def __init__(self, *args):
        ...
        *args : tuple
        ...
        -----
        - Use `ResultsApi_SearchSettings` to filter runs based on properties such as calculation type.
        - Run name comparison is case-insensitive by default. Use `ResultsApi_SearchSettings` to change the case sensitivity setting.
        """
...
class ResultsApi(object):
    ...
    - Each Bladed run is represented by a `Run` object.
      ...
      - A `Run` object also provides information about the Bladed output groups within the run.
    - Each variable is represented by a `Variable` object. A `Variable` may have either one or two dimensions, and is represented by the following sub-types:
      ...
      - A one-dimensional variable object (`Variable1D`) represents a dependent variable (the variable under observation) with respect to one independent variable, such as time.
      - A two-dimensional variable object (`Variable2D`) object represents a dependent variable (the variable under observation) with respect to two independent variables, such as time, and measurement location (e.g. distance along blade).
    """
    ...
    def _get_runs_native_array(*args) -> ArrayOfRun:
        ...
        *args : tuple
        ...
        Notes
        -----
        - Search may take a long time to complete depending on the number of runs, and on network performance if searching network drives.
    ...
    def clear_runs():
        ...
        Notes
        -----
        - Use `ResultsApi_CacheSettings` to disable or enable caching.
    ...
    def get_runs(root_directory: str, search_scope = SEARCH_SCOPE_RECURSIVE_SEARCH) -> np.ndarray[Run]:
        ...
        - To get runs with a specific name, use `ResultsApi.get_runs_matching_name` or `ResultsApi.get_runs_matching_name_regex`.
        - Use `ResultsApi_SearchSettings` to filter runs based on properties such as calculation type.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_runs_native_array` to avoid this penalty.
        """

        return np.array(ResultsApi._get_runs_native_array(root_directory, search_scope), copy=False)
    ...
    def get_runs_matching_name(root_directory: str, run_name: str, search_scope = SEARCH_SCOPE_RECURSIVE_SEARCH) -> np.ndarray[Run]:
        ...
        - Use `ResultsApi_SearchSettings` to filter runs based on properties such as calculation type.
        - Run name comparison is case-insensitive by default. Use `ResultsApi_SearchSettings` to change the case sensitivity setting.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_runs_matching_name_native_array` to avoid this penalty.
        """

        return np.array(ResultsApi._get_runs_matching_name_native_array(root_directory, run_name, search_scope), copy=False)
    ...
    def get_runs_matching_name_regex(root_directory: str, run_name_regex_pattern: str, search_scope = SEARCH_SCOPE_RECURSIVE_SEARCH) -> np.ndarray[Run]:
        ...
        - Use `ResultsApi_SearchSettings` to filter runs based on properties such as calculation type.
        - Run name comparison is case-insensitive by default. Use `ResultsApi_SearchSettings` to change the case sensitivity setting.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_runs_matching_name_regex_native_array` to avoid this penalty.
        """

        return np.array(ResultsApi._get_runs_matching_name_regex_native_array(root_directory, run_name_regex_pattern, search_scope), copy=False)
...
class Variable1D_Float32(Variable):
    ...
    def _get_data_native_array(self) -> ArrayOfFloat:
        ...
        - The type (and hence the precision) of the data may be enquired using `Variable.get_data_type`.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        - Enquire the length of the array using Python's built-in `len()` function.
        """
    ...
    def get_mean(self):
        ...
        -------
        float
            A double-precision floating-point value indicating the mean.
        """
    ...
    def get_minimum_contemporaneous(self, contemporaneous_variable_name):
        ...
        Notes
        -----
        - The minimum contemporaneous value refers to the value of the specified `Variable1D` that occurred
          when the current `Variable1D` reported its minimum value.
        - Variable name comparison is case-insensitive.
        """
    ...
    def get_maximum_contemporaneous(self, contemporaneous_variable_name):
        ...
        Notes
        -----
        - The maximum contemporaneous value refers to the value of the specified `Variable1D` that occurred
          when the current `Variable1D` reported its maximum value.
        - Variable name comparison is case-insensitive.
        """
    ...
    def get_data(self) -> np.ndarray[np.float32]:
        ...
        - The order of elements in the returned container matches the order in which they were written.
        - The type (and hence the precision) of the data may be enquired using `Variable.get_data_type`.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_data_native_array` to avoid this penalty.
        """
...
class Variable2D_Float32(Variable):
    ...
    def _get_data_at_value_native_array(self, *args) -> ArrayOfFloat:
        ...
        **Function variant 1:**
        ...
        Notes
        -----
        - Only returns data if the secondary independent variable axis has an interval value that matches the number specified.
        - In a time domain simulation, each point represents the value of the variable at an output timestep.
        - The order of elements in the returned container matches the order in which they were written.
        - The type (and hence the precision) of the data may be enquired using `Variable.get_data_type`.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        ...
        **Function variant 2:**
        ...
        Notes
        -----
        - Only returns data if the secondary independent variable axis has an interval value that matches the
          string specified, or its numeric equivalent.
        - In a time domain simulation, each point represents the value of the variable at an output timestep.
        - The order of elements in the returned container matches the order in which they were written.
        - The type (and hence the precision) of the data may be enquired using `Variable.get_data_type`.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
    ...
    def _get_data_at_index_native_array(self, secondary_independent_variable_index: int) -> ArrayOfFloat:
        ...
        secondary_independent_variable_index : int
            The secondary independent variable index to return data for.
        ...
        Notes
        -----
        - This function should be used when a string or numeric value key is not sufficient to uniquely identify the data.
          Examples include secondary independent variables with:

          - Duplicate values (string or numeric)
          - Numeric values containing floating-point artefacts. For example, the value 5.0000000 written to file as 5.0000001. Typically, floating-point artefacts are observed in results created in Bladed 4.7 and earlier.
        - Indices start at 0.
        - Only returns data if the secondary independent variable axis has an index matching the value specified.
        - In a time domain simulation, each point represents the value of the variable at an output timestep.
        - The order of elements in the returned container matches the order in which they were written.
        - The type (and hence the precision) of the data may be enquired using `Variable.get_data_type`.
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
    ...
    def _get_data_for_all_independent_variable_values_native_array(self) -> ArrayOfArrayOfFloat:
        ...
        Notes
        -----
        - The outer index of the returned container represents the secondary independent variable index.
        - The inner index of the returned container represents the primary independent variable index
          (in a time domain simulation, the primary independent variable represents time).
        - Access array elements using subscript operator (`[]`). Arrays are base 0.
        - Enquire the length of the array using Python's built-in `len()` function.
        """
    ...
    def get_mean_at_value(self, *args):
        ...
        **Function variant 2:**
        ...
        Notes
        -----
        - Only returns data if the secondary independent variable axis has an interval value that matches the string specified,
    ...
    def get_mean_at_index(self, secondary_independent_variable_index):
        ...
        ----------
        secondary_independent_variable_index : int
            The secondary independent variable index to return the mean value for.
    ...
    def get_minimum_contemporaneous_at_value(self, *args):
        ...
        **Function variant 1:**
        ...
        Notes
        -----
        - The minimum contemporaneous value refers to the value of the specified `Variable2D` and secondary independent variable that occurred
          when the current `Variable2D` reported its minimum value.
        - Variable name comparison is case-insensitive.
    ...
    def get_minimum_contemporaneous_at_index(self, contemporaneous_variable_name, secondary_independent_variable_index):
        ...
        contemporaneous_variable_name : str
            The name of the variable whose contemporaneous value will be sought.
        secondary_independent_variable_index : int
            The secondary independent variable index to return the minimum contemporaneous value for.
    ...
    def get_maximum_contemporaneous_at_value(self, *args):
        ...
        **Function variant 1:**
        ...
        Notes
        -----
        - The maximum contemporaneous value refers to the value of the specified `Variable2D` and secondary independent variable that occurred
          when the current `Variable2D` reported its maximum value.
        - Variable name comparison is case-insensitive.
    ...
    def get_maximum_contemporaneous_at_index(self, contemporaneous_variable_name, secondary_independent_variable_index):
        ...
        contemporaneous_variable_name : str
            The name of the variable whose contemporaneous value will be sought.
        secondary_independent_variable_index : int
            The secondary independent variable index to return the maximum contemporaneous value for.
    ...
    def _get_data_at_index_numpy_from_vector(self, index):
        r"""_get_data_at_index_numpy_from_vector(Variable2D_Float32 self, size_t const index) -> PyObject *"""
        return _ResultsAPI_Python.Variable2D_Float32__get_data_at_index_numpy_from_vector(self, index)
    ...
    def get_data_for_all_independent_variable_values(self) -> np.ndarray[np.float32]:
        ...
        - The inner index of the returned container represents the primary independent variable index
          (in a time domain simulation, the primary independent variable represents time).
        - This function returns a two-dimensional NumPy array which involves copying the underlying native data. This may adversely affect performance when dealing with large data sets. In performance-sensitive code, use native array returned by function `_get_data_for_all_independent_variable_values_native_array` to avoid the copy.
        """

        return np.array(self._get_data_for_all_independent_variable_values_native_array(), dtype=np.float32, copy=False)
    ...
    def get_data_at_value(self, *args) -> np.ndarray[np.float32]:
        ...
        **Function variant 1:**
        ...
        - The order of elements in the returned container matches the order in which they were written.
        - The type (and hence the precision) of the data may be enquired using `Variable.get_data_type`.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_data_at_value_native_array` to avoid this penalty.
    ...
    def get_data_at_index(self, secondary_independent_variable_index: int) -> np.ndarray[np.float32]:
        ...
        - The order of elements in the returned container matches the order in which they were written.
        - The type (and hence the precision) of the data may be enquired using `Variable.get_data_type`.
        - Requesting a NumPy array incurs a minor performance penalty which will not be noticeable in most cases. In highly performance-sensitive code, use native array returned by function `_get_data_at_index_native_array` to avoid this penalty.
        """
...
class Variable2D_Float64(Variable):
    ...
    def _get_data_at_index_numpy_from_vector(self, index):
        r"""_get_data_at_index_numpy_from_vector(Variable2D_Float64 self, size_t const index) -> PyObject *"""
        return _ResultsAPI_Python.Variable2D_Float64__get_data_at_index_numpy_from_vector(self, index)
    ...
    def get_data_for_all_independent_variable_values(self) -> np.ndarray[np.float64]:
        ...
        return np.array(self._get_data_for_all_independent_variable_values_native_array(), dtype=np.float64, copy=False)
...
class Variable2D_Int32(Variable):
    ...
    def _get_data_at_index_numpy_from_vector(self, index):
        r"""_get_data_at_index_numpy_from_vector(Variable2D_Int32 self, size_t const index) -> PyObject *"""
        return _ResultsAPI_Python.Variable2D_Int32__get_data_at_index_numpy_from_vector(self, index)
    ...
    def get_data_for_all_independent_variable_values(self) -> np.ndarray[np.int32]:
        ...
        return np.array(self._get_data_for_all_independent_variable_values_native_array(), dtype=np.int32, copy=False)
...
class OutputGroup1D_Float32(OutputGroup):
    r"""
    Class representing a one-dimensional Bladed output group for writing.
    ...
    def __init__(self, *args):
        ...
        *args : tuple
            ...
            - **arg3**
              (str) : The output group data source, indicated by the header CONTENT field. Enter 'UserDefined' for the group to have a calculation type equal to 'UserDefined'. This allows filtering on 'UserDefined' groups when seeking runs to distinguish them from runs created by Bladed.

            - **arg4**
              (str) : The output group config, indicated by the header CONFIG field. Typically one of `TRANSIENT`, `STATIONARY`, `LIST`, or `TABLE`.
    ...
    def add_variable_with_data(self, variable_name: str, siUnit: str, data: np.ndarray[np.float32]):
        r"""
        Adds a one-dimensional variable to the output group, including data.
        ...
        self._add_variable_with_data_native_array(variable_name, siUnit, native_array)
...
class OutputGroup1D_Float64(OutputGroup):
    ...
    def add_variable_with_data(self, variable_name: str, siUnit: str, data: np.ndarray[np.float64]):
        r"""
        Adds a one-dimensional variable to the output group, including data.
...
class OutputGroup1D_Int32(OutputGroup):
    ...
    def add_variable_with_data(self, variable_name: str, siUnit: str, data: np.ndarray[np.int32]):
        r"""
        Adds a one-dimensional variable to the output group, including data.
...
class OutputGroup2D_Float32(OutputGroup):
    r"""
    Class representing a two-dimensional Bladed output group for writing.

    A two-dimensional output group contains data for dependent variables with respect to two independent variables,
    such as time, and measurement location (e.g. distance along blade).
    """
