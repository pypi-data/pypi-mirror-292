...
from log.custom_format import CustomFormatter
...
def get_logger(module_name):
    ...
    console_handler.setLevel(logging.DEBUG)  # Customize the console level if needed
    console_handler.setFormatter(CustomFormatter(formatter))
