    ...
    def __connect_to_ngrok(self):
        try:
            if self.FW_version == 'v2':
                self._ngrok_connection = ngrok.connect(CONTY_DEFAULT_PORT_V2, "tcp")  # port, method
            elif self.FW_version == 'v3':
                self._ngrok_connection = ngrok.connect(CONTY_DEFAULT_PORT_V3, "tcp")  # port, method
