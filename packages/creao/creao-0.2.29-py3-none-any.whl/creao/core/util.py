...
def submit_pipeline_job(pipe_yaml:str, run_config_template:str, dataset:Dataset, username:str):
    """
    Submit a pipeline job to the server.
    :param pipeline_id: The ID of the pipeline.
    :param pipe_yaml: The YAML file for the pipeline.
    :param run_config_template: The template for the run configuration.
