...
from dexteritysdk.codegen.instruments.types import InitializeFixedIncomeParams
...
def initialize_fixed_income(
    fixed_income_metadata: Union[str, Pubkey, AccountMeta],
    ...
    if program_id is None:
        program_id = Pubkey.from_string("EF5kuCdtoPa6Y9J4YMut4YMBvWa17JAebpJCo5LHig9a")

    if isinstance(fixed_income_metadata, (str, Pubkey)):
