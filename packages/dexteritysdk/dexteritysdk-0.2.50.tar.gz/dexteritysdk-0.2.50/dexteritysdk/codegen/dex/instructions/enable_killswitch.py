...
# LOCK-BEGIN[ix_cls(enable_killswitch)]: DON'T MODIFY
@dataclass
class EnableKillswitchIx:
    program_id: Pubkey
    ...
    def to_instruction(self):
        ...
        buffer = BytesIO()
        buffer.write(InstructionTag.to_bytes(InstructionTag.ENABLE_KILLSWITCH))
...
# LOCK-BEGIN[ix_fn(enable_killswitch)]: DON'T MODIFY
