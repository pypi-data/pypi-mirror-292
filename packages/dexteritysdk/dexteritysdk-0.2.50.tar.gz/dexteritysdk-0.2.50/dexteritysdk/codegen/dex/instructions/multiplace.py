...
from dexteritysdk.codegen.dex.types import MultiplaceParams
...
# LOCK-BEGIN[ix_cls(multiplace)]: DON'T MODIFY
@dataclass
class MultiplaceIx:
    program_id: Pubkey
    ...
    def to_instruction(self):
        ...
        buffer = BytesIO()
        buffer.write(InstructionTag.to_bytes(InstructionTag.MULTIPLACE))
        buffer.write(BYTES_CATALOG.pack(MultiplaceParams, self.params))
...
# LOCK-BEGIN[ix_fn(multiplace)]: DON'T MODIFY
def multiplace(
