...
from dexteritysdk.codegen.dex.types import MultiplaceV2Params
...
# LOCK-BEGIN[ix_cls(multiplace_v2)]: DON'T MODIFY
@dataclass
class MultiplaceV2Ix:
    program_id: Pubkey
    ...
    def to_instruction(self):
        ...
        buffer = BytesIO()
        buffer.write(InstructionTag.to_bytes(InstructionTag.MULTIPLACE_V2))
        buffer.write(BYTES_CATALOG.pack(MultiplaceV2Params, self.params))
...
# LOCK-BEGIN[ix_fn(multiplace_v2)]: DON'T MODIFY
def multiplace_v2(
