...
from dexteritysdk.codegen.dex.types import NewOrderV2Params
...
# LOCK-BEGIN[ix_cls(new_order_v2)]: DON'T MODIFY
@dataclass
class NewOrderV2Ix:
    program_id: Pubkey
    ...
    def to_instruction(self):
        ...
        buffer = BytesIO()
        buffer.write(InstructionTag.to_bytes(InstructionTag.NEW_ORDER_V2))
        buffer.write(BYTES_CATALOG.pack(NewOrderV2Params, self.params))
...
# LOCK-BEGIN[ix_fn(new_order_v2)]: DON'T MODIFY
def new_order_v2(
