...
# Example usage
    ...
    async def get_option_chain_all(self, underlying_asset:str, strike_price=None, strike_price_lte=None, strike_price_gte=None, expiration_date=None, expiration_date_gte=None, expiration_date_lite=None, contract_type=None, order=None, limit=250, sort=None, pool=None, insert:bool=False):
        """
        ...
        """
        if underlying_asset.startswith(f"I:"):
            underlying_asset = underlying_asset.replace(f"I:", "")
