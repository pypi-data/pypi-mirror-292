...
_ErrorType = _uni[
    ...
    tc.MissingValueError, tc.IncorrectValueError, tc.NotInitializedError, tc.NotInvocableError, tc.NotComparableError, tc.NotIterableError, tc.NotReassignableError, tc.InitializedError
]
...
class Tense(NennaiAbroads, NennaiStringz, NennaiRandomize, Time, Math, tc.Positive[str], tc.Negative[str], tc.Invertible[str]):
    ...
    import uuid as __uu, warnings as __wa, re as __re, time as __ti, tkinter as __tk, inspect as __ins, bisect as __bi, ast as __ast # math as __ma
    import dis as __dis
    ...
    def disassemble(
        ...
        """
        \\@since 0.3.26rc3. See [`dis.dis()`](https://docs.python.org/3/library/dis.html#dis.dis)
        """
    ...
    def timeit(
        ...
        """
        \\@since 0.3.26rc3. See [`timeit.timeit()`](https://docs.python.org/3/library/timeit.html#timeit.timeit)
        ```ts \\
        "class method" in class Tense
        ```
    ...
    @_cm
    def bisect(self, seq: __tc.LenGetItemOperable[_T], item: _T_richComparable, low: int = 0, high: _opt[int] = None, key: _opt[_cal[[_T], _T_richComparable]] = None, mode: _BisectModeType = BISECT_RIGHT):
        ...
        if mode == self.BISECT_LEFT:
            ...
            raise err(s)
    @_cm
    def insort(self, seq: __tc.LenGetItemOperable[_T], item: _T_richComparable, low: int = 0, high: _opt[int] = None, key: _opt[_cal[[_T], _T_richComparable]] = None, mode: _InsortModeType = INSORT_RIGHT):
    ...
    @__tc.deprecated("This method is deprecated since 0.3.25. Consider manually setting errors instead.")
