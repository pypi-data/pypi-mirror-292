...
class Timeline(QGraphicsRectItem):
    ...
    def add_occurrence(self, occurrence):
        ...
        # FIXME: [SAVING] Do not set flag when adding occurrences. Only set it when a *new* one is created.
    ...
    def edit_properties(self):
        ...
        if dialog.result() == dialog.DialogCode.Accepted:
            self.title.text = self.name_edit.text()
...
class TimelineTitle(QGraphicsRectItem):
    ...
    # FIXME: [CONSTANTS] In methods draw_rect and draw_text, do not hardcode the
    ...
    def draw_text(self, painter):
        ...
        # FIXME: [CONSTANTS] Do not hardcode the value "3"
