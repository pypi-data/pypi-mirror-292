from pydantic.v1 import Extra, HttpUrl, EmailStr
...
class Company(JsonModel):
    ...
    products: Optional[List[str]] = Field([], description="List of references to products offered by the company")
    services: Optional[List[str]] = Field([], description="List of references to services offered by the company")
