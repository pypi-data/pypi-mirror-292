...
class BaseReactAgent(BaseAgent, ABC):
    ...
    def build_agent(self, llm: BaseChatModel, tools: list[Tool], prompt_template: ChatPromptTemplate, **kwargs) -> Runnable:
        """
    ...
    def build_system_prompt_template(self) -> SystemMessagePromptTemplate:
        ...
        system_prompt_template = SystemMessagePromptTemplate(prompt=PromptTemplate(
    ...
    def build_executor_input(self, query: str, session_id: str, filters: dict[str, any]) -> dict[str, any]:
