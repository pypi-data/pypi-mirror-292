...
from serpent_lang.configuration.settings import engine_settings
from serpent_lang.graphs.agent_node import AgentNode
from serpent_lang.util import llm_factory
from serpent_lang.models.llm_factory import AzureOpenAIChatSettings
...
class BaseGraphEngine(ABC):
    ...
    def run(self, query: str, session_id: str, filters: dict[str, any] = None) -> str:
        filters |= {}
        ...
        llm: BaseChatModel = llm_factory.get_llm(AzureOpenAIChatSettings(
            azure_deployment=engine_settings.openai_chat_engine,
        ...
        for agent in self.get_agents():
            ...
            agent_action = agent_node.create_action(
                query=query,
    ...
    def build_prompt_template(self, options: list[str], workers: list[str]) -> BasePromptTemplate:
