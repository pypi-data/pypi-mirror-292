...
from serpent_lang.models.model_settings import AzureOpenAIEmbeddingSettings
...
class CosmosVCoreRetriever(BaseModel):
    ...
    def __init__(self, **data) -> None:
        ...
        embedding = llm_factory.get_llm(AzureOpenAIEmbeddingSettings(
    ...
    def get_data_threshold(self, query: str, k: Optional[int] = 5, score_threshold: Optional[float] = 0.0):
        """
        ...
        :return: The data
        """
        return self._vector_store.similarity_search_with_score(query=query, k=k, score_threshold=score_threshold)
