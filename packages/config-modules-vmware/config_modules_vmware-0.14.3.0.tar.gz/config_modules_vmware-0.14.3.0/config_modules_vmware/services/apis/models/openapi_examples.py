...
get_schema_vc_request_payload_example = {
    "summary": "default",
    "description": "Sample request body",
    "value": {
        "target": {
...
get_schema_vc_200_response_example = {
    "description": "Successful get schema response.",
    "content": {
        "application/json": {
            "example": {
                ...
                "id": "null",
                "name": "Get Schema",
                "timestamp": "2024-08-05T22:46:05.210604",
                "description": "Schema",
                "status": "SUCCESS",
                "result": {"json_schema": {"sample": "test"}},
                "errors": "null",
                "target": {"hostname": "10.168.160.16", "type": "vcenter"},
            }
        }
    },
}
get_schema_vc_500_response_example = {
    ...
    "content": {
        "application/json": {
            "example": {
                "schema_version": "1.0-DRAFT",
                "name": "Get Schema",
                "timestamp": "2024-08-06T20:34:06.343944",
                ...
                "errors": [
                    {
                        ...
                        "source": {
                            "server": "192.168.1.1",
                            "type": "ConfigModules",
                            "endpoint": "/config-modules/api/vcenter/schema/v1/get",
                        },
                        "error": {"message": "unable to reach vc"},
                    }
                ],
                "target": {"hostname": "vcenter-1.vsphere.local", "type": "vcenter"},
            }
        }
    },
}
