...
VC_PROFILE_DOMAIN_CONFIGURATION_URL = "api/domain/v1/configuration"
VC_PROFILE_DOMAIN_CONFIGURATION_SCHEMA_URL = "api/domain/v1/configuration/schema"
VC_PROFILE_DOMAIN_CONFIGURATION_CHECK_COMPLIANCE_URL = (
    "api/domain/v1/configuration?action=check-compliance&vmw-task=true"
)
