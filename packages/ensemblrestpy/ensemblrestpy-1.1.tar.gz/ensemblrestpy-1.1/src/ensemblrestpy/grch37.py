from functools import singledispatchmethod, singledispatch, partial, partialmethod
...
if __name__ == "__main__":
    ...
    pprint.pprint(vep_region_human("6:26093141", "A"))
    pprint.pprint(vep_region(["6 26093141 rs1800562 G A ...", "6 26091179 rs1799945 C G ..."], "human"))
    pprint.pprint(vep_region_human(["6 26093141 rs1800562 G A ...", "6 26091179 rs1799945 C G ..."]))
    ensembl = Ensembl()
    ...
    pprint.pprint(ensembl.vep_region_human("6:26093141", "A"))
    pprint.pprint(ensembl.vep_region(["6 26093141 rs1800562 G A ...", "6 26091179 rs1799945 C G ..."], "human"))
    pprint.pprint(ensembl.vep_region_human(["6 26093141 rs1800562 G A ...", "6 26091179 rs1799945 C G ..."]))
