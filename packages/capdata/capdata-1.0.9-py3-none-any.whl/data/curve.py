...
def get_bond_yield_curve(curve, start, end, freq='d', window=None):
...
def get_bond_spread_curve(curve, start, end, freq='d', window=None):
    data_json = {'curve': curve, 'start': start, 'end': end, 'freq': freq, 'window': window}
...
def get_ir_yield_curve(curve, start, end, freq='d', window=None):
    data_json = {'curve': curve, 'start': start, 'end': end, 'freq': freq, 'window': window}
...
def get_dividend_curve(curve, start, end, freq='d', window=None):
    data_json = {'curve': curve, 'start': start, 'end': end, 'freq': freq, 'window': window}
