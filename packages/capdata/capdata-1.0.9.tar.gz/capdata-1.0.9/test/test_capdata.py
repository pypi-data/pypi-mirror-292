...
class TestApiFunctions(unittest.TestCase):
    ...
    def test_get_bond_yield_curve(self):
        curve_data = capdata.get_bond_yield_curve("CN_TREAS_MKT", '2024-05-27 00:00:00', '2024-05-27 18:00:00', '1m')
    ...
    def test_get_ir_yield_curve(self):
        curve_data = capdata.get_ir_yield_curve("CNY_FR_007", '2024-05-22 00:00:00', '2024-05-27 18:00:00', 'd')
        if curve_data is not None:
            for data in curve_data:
                print(data)
        else:
