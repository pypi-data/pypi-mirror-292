...
class Emaildashfake_com(_Generatoremail_etc):
    """An API Wrapper around the https://email-fake.com/ website. Has potential to fail, work with retries in get_inbox"""
    ...
    def __init__(self, name: str=None, domain:str=None, exclude: list[str]=None):
        ...
        """
        super().__init__(base_url="https://email-fake.com/", name=name, domain=domain, exclude=exclude)
