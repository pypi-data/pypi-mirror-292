...
def normalize_message(message, channel_id=None, sender=None, recipients=None, subtype=None, len_limit=None, file_display_name=None, context=None,
    ...
    Accepts a message, a channel_id, a sender, the recipients, a subtype, the len_limit, a file_display_name, the context, the text, the title, the card button, and the file/url path.
