...
from PySide6.QtWidgets import QMessageBox, QCheckBox, QScrollArea, QSystemTrayIcon
from PySide6.QtGui import QPalette, QIcon, QClipboard
...
class MainGUI(QMainWindow):
    ...
    def copy_exp_id(self):
        ...
        cb.setText(self.experiment.experiment_id, mode=QClipboard.Mode.Clipboard)
