...
COLORMAPS = {
    ...
    3: {
        "lut": [(255, 0, 0), (0, 0, 255), (0, 255, 255), (0, 255, 0), (255, 255, 0), (255, 0, 0)],
        "active roi": "#f5f5f5",
        "inactive roi": "#303030",
    },
    4: {"lut": [(255, 255, 255), (0, 0, 0)], "active roi": "#fe642e", "inactive roi": "#8856a7"},
}
...
def get_colormaps(n):
    ...
    for k, color_dict in COLORMAPS.items():
        ...
        colormaps[str(k)] = {
            "lut": pg.ColorMap(pos, color).getLookupTable(1.0, 0.0, n),
