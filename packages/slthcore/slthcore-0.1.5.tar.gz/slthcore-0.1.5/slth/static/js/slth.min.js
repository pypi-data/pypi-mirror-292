...
`).map(function(i,o){return t.jsx("div",{children:i},Math.random())});return e}return typeof e=="object"&&e.type?t.jsx(x,{data:e}):typeof e=="object"&&Array.isArray(e)?e.length==0?"-":typeof e[0]=="object"&&e[0].type!=null?t.jsx(t.Fragment,{children:e.map(function(i){return t.jsx(x,{data:i},Math.random())})}):t.jsx("ul",{style:{padding:0,marginLeft:17},children:e.map(function(i){return t.jsx("li",{children:i},Math.random())})}):typeof e=="object"&&JSON.stringify(Object.keys(e))==JSON.stringify(["id","text"])?e.text:JSON.stringify(e)}function ce(){document.querySelector(".layer")==null&&P.createRoot(document.body.appendChild(document.createElement("div"))).render(t.jsx(Oe,{}))}function we(e,n){se(),ce(),window.reloader=n;for(var a=document.getElementsByTagName("dialog"),r=0;r<a.length;r++)a[r].style.display="none";P.createRoot(document.body.appendChild(document.createElement("div"))).render(t.jsx(_e,{url:O(e)}))}function Ae(e){se(),ce(),P.createRoot(document.body.appendChild(document.createElement("div"))).render(t.jsx(Fe,{url:O(e)}))}function J(e){e!=null&&showMessage(e);for(var n=document.getElementsByTagName("dialog"),a=0;a<n.length;a++)if(a==n.length-1){var r=n[a];r.close(),r.classList.remove("opened"),r.remove(),a==0?(document.querySelector(".layer").style.display="none",window.reloader&&window.reloader()):n[a-1].style.display="block"}}function Re(e){se(),ce(),P.createRoot(document.body.appendChild(document.createElement("div"))).render(t.jsx(ze,{actions:e}))}function Oe(e){const n={backgroundColor:"black",bottom:0,left:0,position:"fixed",right:0,top:0,opacity:.7,display:"none"};return t.jsx("div",{className:"layer",onClick:function(){J()},style:n})}function _e(e){const[n,a]=N.useState(null),[r,i]=N.useState(0);N.useEffect(()=>{o(O(e.url)),document.querySelector(".layer").style.display="block"},[]);function o(s){q("GET",O(s),function(u){a(u),i(r+1)})}function d(){const s={maxWidth:800},u={textAlign:"right",cursor:"pointer",marginTop:-15};if(n)return t.jsxs("div",{style:s,children:[t.jsx("div",{style:u,children:t.jsx(E,{icon:"x",onClick:()=>J()})}),t.jsx(x,{data:n})]})}const c={minWidth:window.innerWidth<800?"calc(100% - 60px)":800,display:n?"block":"none",maxWidth:800,top:window.scrollY+40,border:0};return t.jsx("dialog",{style:c,children:d()},r)}function Fe(e){var n=Math.random();N.useEffect(()=>{document.querySelector(".layer").style.display="block";var r=document.getElementById(n);r.style.top=document.documentElement.scrollTop+100},[]);function a(){const r={minWidth:window.innerWidth<800?"calc(100% - 60px)":800,display:"block",maxWidth:800,top:window.scrollY+40,border:0},i={float:"right",cursor:"pointer",marginTop:-20};return t.jsxs("dialog",{style:r,id:n,children:[t.jsx("div",{style:i,children:t.jsx(E,{icon:"x",onClick:()=>J()})}),t.jsx("iframe",{src:O(e.url),width:"100%",height:500,style:{border:0}})]})}return a()}function ze(e){const n=Math.random();N.useEffect(()=>{document.querySelector(".layer").style.display="block"},[]);function a(){const o={width:"100%",borderBottom:"solid 1px #DDDD",padding:20};return t.jsx("div",{align:"center",style:{},children:e.actions.map(function(d){return t.jsx("div",{style:o,onClick:r,children:t.jsx(z,{data:d,strech:!0})},Math.random())})})}function r(){const o=document.getElementById(n);o.close(),o.classList.remove("opened"),o.remove(),document.querySelector(".layer").style.display="none"}const i={width:"auto",display:"block",position:"fixed",bottom:0,border:0,padding:0};return t.jsx("dialog",{id:n,style:i,children:a()})}function I(e){return e!=null&&(e=e.toString().replace("-","").normalize("NFD").replace("_","").toLowerCase()),e}const xe={};function A(e){let n="",a=window.document.styleSheets[0];e.split("}").forEach(r=>{let i=(r+"}").replace(/\r?\n|\r/g,"");n=n===""?i:n+i,n.split("{").length===n.split("}").length&&xe[n]==null&&(a.insertRule(n,a.cssRules.length),n="",xe[n]=!0)})}function z(e){const n=e.id||Math.random(),[a,r]=N.useState(e.data.name);function i(c){c.preventDefault();var s=e.data.url;e.data.urlfunc&&(s=e.data.urlfunc()),e.onClick?(a&&r("Aguarde...."),e.onClick(c)):e.data.modal==!1?window.load(X(s)):we(s)}function o(){return e.strech?e.data.name:e.data.icon?e.compact||!e.data.name||window.innerWidth<800?t.jsx(E,{icon:e.data.icon}):t.jsxs(t.Fragment,{children:[t.jsx(E,{icon:e.data.icon,style:{paddingRight:10}}),e.data.name||""]}):e.data.name}function d(){A(`
    ...
    `),t.jsxs("div",{className:"dropdown",children:[t.jsx("div",{onClick:a,"data-label":I(e.dataLabel),children:e.children}),e.actions&&e.actions.length>0&&t.jsx("ul",{onMouseLeave:r,children:e.actions.map(o=>t.jsx("li",{children:t.jsx(z,{data:o,style:{padding:0,whiteSpace:"normal"}})},Math.random()))})]})}return i()}function F({id:e,href:n,modal:a,imodal:r,children:i,onClick:o,dataLabel:d,style:c}){const s=n&&n.indexOf("/media/")<0?X(n):n;function u(m){s.indexOf("http")==0?document.location.href=s:(m.preventDefault(),a?we(s):r?Ae(s):window.load(s))}function l(){return t.jsx("a",{id:e,onClick:o||u,href:s||"#","data-label":I(d),style:c,children:i})}return l()}function Y(e){function n(){const r={display:"grid",gridGap:0,gridTemplateColumns:"repeat(auto-fit, minmax("+(e.width||200)+"px, 1fr))",alignItems:e.alignItems||"end"};return t.jsx("div",{style:r,children:e.children},Math.random())}return n()}function Q(e){function n(){return e.data.url?t.jsx(We,{data:e.data}):t.jsx(je,{data:e.data})}return n()}function je(e){function n(){if(e.data.label)return t.jsxs(t.Fragment,{children:[t.jsx("strong",{children:e.data.label}),":",t.jsx("br",{})]})}function a(){return e.data.url&&e.data.url.indexOf("only=")<0?t.jsx(F,{href:e.data.url,children:t.jsxs(t.Fragment,{children:[H(e.data.value),t.jsx(E,{icon:"external-link",style:{marginLeft:10}})]})}):H(e.data.value)}function r(){const i={minWidth:e.width+"%",marginTop:5,marginBottom:5};return t.jsxs("div",{style:i,children:[n(),a()]})}return r()}function We(e){const n=Math.random(),[a,r]=N.useState(e.data);function i(d){q("GET",d,function(c){r(c)})}function o(){return window[n]=()=>i(e.data.url),t.jsx("div",{className:e.data.url&&"reloadable",id:n,children:t.jsx(je,{data:a,width:100})})}return o()}function ie(e){function n(){return t.jsx("div",{style:{verticalAlign:"center",textAlign:"right",lineHeight:"3rem"},children:e.data.map(function(a){return t.jsx(z,{data:a,default:!0,compact:!(window.innerWidth>800)},Math.random())})})}return n()}function ue(e){function n(){return e.data.map(function(a){if(Array.isArray(a))return t.jsx(Y,{width:300,alignItems:"start",children:a.map(r=>t.jsx(Q,{data:r,width:100/a.length},Math.random()))},Math.random());if(a.label!="ID"&&(e.exclude==null||a.label!=e.exclude))return t.jsx("div",{children:t.jsx(Q,{data:a,width:100})},Math.random())})}return n()}function He(e){function n(){const o={marginTop:5,marginBottom:5};return t.jsx("h3",{style:o,children:e.data.title})}function a(){return t.jsx(ue,{data:e.data.data})}function r(){return t.jsx(ie,{data:e.data.actions})}function i(){const o={border:"solid 1px #DDD",padding:10,borderStyle:"dashed"};return t.jsxs("div",{style:o,children:[n(),a(),r()]})}return i()}function Pe(e){A(`
    .cards{
      padding: 10px;
  ...
  `);function n(){return t.jsx("h3",{children:e.data.title})}function a(){return t.jsx(ue,{data:e.data.data})}function r(){return t.jsx(ie,{data:e.data.actions})}function i(){return t.jsxs("div",{className:"cards",children:[n(),a(),r()]})}return i()}function Ue(e){function n(){const d={paddingTop:15,marginBottom:10,color:"#1151b3"};return t.jsx("div",{style:d,children:t.jsx("strong",{children:e.data.title})})}function a(){return t.jsx(ue,{data:e.data.data,exclude:e.data.data[1].label})}function r(){const d={position:"absolute",width:140,marginLeft:-128,display:"flex",justifyContent:"space-between",marginTop:10,alignItems:"flex-end"},c={maxWidth:100},s={width:20,height:20,border:"3px solid #1151b3",backgroundColor:"white",borderRadius:"50%"};return t.jsxs("div",{style:d,children:[t.jsx("div",{className:"bold",style:c,children:e.data.data[1].value}),t.jsx("div",{style:s})]})}function i(){return t.jsx(ie,{data:e.data.actions})}function o(){const d={borderBottom:"solid 1px #DDD",padding:0,borderBottomStyle:"dashed",marginLeft:140,borderLeft:"3px solid #1151b3",marginBottom:-10},c={marginLeft:20};return t.jsxs("div",{style:d,children:[r(),t.jsxs("div",{style:c,children:[n(),a(),i()]})]})}return o()}function Ge(e){const n=Math.random(),[a,r]=N.useState(e.data);A(`
    .object-fieldset{
      margin-top: 10px;
    }
  `);function i(){return t.jsx(ke,{data:a})}function o(){const u={backgroundColor:"white",padding:15,marginBottom:15};return t.jsx("div",{style:u,children:d()})}function d(){return Array.isArray(a.data)?a.data.length==0?t.jsx("div",{children:"Nenhum registro encontrado."}):a.data.map(function(u){return Array.isArray(u)?t.jsx(Y,{width:300,children:u.map(l=>t.jsx(Q,{data:l,width:100/u.length},Math.random()))},Math.random()):t.jsx("div",{children:t.jsx(Q,{data:u,width:100})},Math.random())}):t.jsx(x,{data:a.data})}function c(u){q("GET",u,function(l){r(l)})}function s(){return e.data.url?(window[n]=()=>c(e.data.url),t.jsxs("div",{className:e.data.url?"reloadable object-fieldset":"object-fieldset",id:n,children:[i(),o()]})):t.jsxs("div",{className:"object-fieldset",children:[i(),o()]})}return s()}function Ye(e){const n=Math.random(),[a,r]=N.useState(e.data.actions);function i(){const c=e.data.url.indexOf("?")<0?"?":"&";return e.data.url+c+"only=actions"}function o(){q("GET",i(),function(c){r(c)})}function d(){return window[n]=()=>o(),t.jsx("div",{className:"reloadable",id:n,children:a.map(function(c){return t.jsx(z,{data:c,default:!0},Math.random())})})}return d()}function Xe(e){function n(){A(`
      .object-title {
        display: flex;
  ...
  `);const[n,a]=N.useState(0);function r(){return t.jsx("div",{className:"noscroll",style:{display:"inline-block",textAlign:"center",width:"100%",margin:"auto",marginBottom:20,overflowX:"auto"},children:e.data.map(function(i,o){return t.jsx(F,{href:i.url,style:{padding:5,fontWeight:n==o?"bold":"normal",borderBottom:n==o?"solid 3px #2670e8":"solid 3px inherite",textDecoration:"none",color:"#0c326f",margin:15},onClick:function(d){d.preventDefault(),a(o),e.loadContent(i.url)},dataLabel:I(i.title),children:i.title},Math.random())})})}return r()}function Qe(e){var n=Math.random();const[a,r]=N.useState(e.data.data[0]);function i(){return e.data.title!="Top"&&t.jsx("h2",{"data-label":I(e.data.title),children:e.data.title})}function o(){return t.jsx(ie,{data:e.data.actions})}function d(){return t.jsx(Je,{data:e.data.data,loadContent:u})}function c(){var m={...a};m.title=null;const f={padding:0};return t.jsx("div",{style:f,children:t.jsx(x,{data:m},Math.random())})}function s(){const m={width:"50%",margin:"auto",border:"solid 0.5px #DDD",marginTop:30,marginBottom:30};return t.jsx("div",{style:m})}function u(m){q("GET",m,function(f){r(f)})}function l(){return window[n]=()=>u(a.url),e.data.data.length>0&&t.jsxs("div",{className:"reloadable",id:n,children:[i(),o(),d(),c(),s()]})}return l()}function Ke(){document.querySelectorAll(".reloadable").forEach(function(e){window[e.id]()})}function _({id:e,onClick:n,icon:a,label:r,display:i,primary:o,compact:d,spin:c}){function s(){return a?d||!r?t.jsx(E,{icon:a}):t.jsxs(t.Fragment,{children:[t.jsx(De,{style:{marginRight:10,display:"none"}}),t.jsx(E,{icon:a,style:{marginRight:10}}),r||""]}):r}function u(){A(`
      .button{
        padding: 12px;
        text-decoration: none;
        white-space: nowrap;
    ...
    `);const l={display:i||"block"};return o?(l.backgroundColor=p.colors.primary,l.color="white"):(l.border="solid 1px "+p.colors.primary,l.color=p.colors.primary),t.jsx("a",{id:e,className:"button",style:l,"data-label":I(r||a),onClick:m=>{m.preventDefault(),a&&c&&(m.target.dataset.spinning=a,m.target.querySelector("i.fa-spin").style.display="inline-block",m.target.querySelector("i.fa-"+a).style.display="none"),n(m)},children:s()})}return u()}function Ze(e){return N.useEffect(()=>{e.data.autoreload&&setTimeout(window.reload,e.data.autoreload)},[]),t.jsx("div",{dangerouslySetInnerHTML:{__html:e.data.content}})}function et(e){return t.jsx("img",{src:e.data.src,style:{width:"100%"}})}function tt(e){const n={width:"100%",textAlign:"center"};return t.jsx("div",{style:n,children:t.jsx("img",{src:e.data.src||e.data.placeholder,style:{width:e.data.width,height:e.data.height,borderRadius:e.data.round?"50%":0}})})}function nt(e){return e.data.latitude&&e.data.longitude&&t.jsx("iframe",{width:e.data.width||"100%",height:e.data.height||"400px",id:"gmap_canvas",src:"https://maps.google.com/maps?q="+e.data.latitude+","+e.data.longitude+"&t=&z=13&ie=UTF8&iwloc=&output=embed",frameBorder:"0",scrolling:"no",marginHeight:"0",marginWidth:"0"})}function at(e){function n(o){return e.data.icon?o.done?t.jsx(E,{style:{marginTop:6},icon:e.data.icon}):t.jsx("span",{children:" "}):t.jsx("div",{style:{marginTop:6},children:o.number})}function a(o){return{border:"3px solid "+p.colors.primary,borderRadius:"50%",background:o.done?p.colors.primary:"white",color:o.done?"white":p.colors.primary,textAlign:"center",width:50,height:50,margin:"auto",fontSize:"1.5rem"}}function r(o){return{listStyleType:"none",display:"flex",justifyContent:"center",minWidth:o.length*100}}function i(){const o={width:"100%",margin:"auto",overflowX:"auto","&::WebkitScrollbar":{width:0}},d={width:100,marginWidth:100,textAlign:"center"},c={position:"relative",borderBottom:"2px solid #1151b3",top:-28,width:45,left:77};return t.jsx("div",{children:t.jsx("div",{style:o,children:t.jsx("ul",{style:r(e.data.steps),children:e.data.steps.map((s,u)=>t.jsxs("li",{style:d,children:[t.jsx("div",{style:a(s),children:n(s)}),u<e.data.steps.length-1&&t.jsx("div",{style:c}),t.jsx("div",{children:s.name})]},Math.random()))})})})}return i()}function rt(e){function n(){const a={display:"inline-block",width:"100%",backgroundColor:"#DDD",borderRadius:5,marginTop:5},r={marginLeft:10},i={display:"block",paddingTop:2,paddingBottom:2,color:"white",borderRadius:5,width:e.data.value+"%",backgroundColor:p.colors[e.data.style]};return t.jsx("span",{style:a,children:t.jsx("span",{style:i,children:t.jsxs("span",{style:r,children:[e.data.value,"%"]})})})}return n()}function it(e){function n(){return e.data.color=p.colors[e.data.style],t.jsx(Se,{data:e.data})}return n()}function Se(e){function n(){const a={color:"white",width:"fit-content",borderRadius:0,textWrap:"nowrap",padding:10,whiteSpace:"nowrap",backgroundColor:e.data.color,display:"inline-flex",border:"solid 3px white",lineHeight:"1rem"};return t.jsxs("div",{style:a,children:[e.data.icon&&t.jsx(E,{icon:e.data.icon,style:{marginRight:5}}),e.data.label]})}return n()}function ot(e){function n(){const a={padding:20,marginLeft:-20,marginRight:-20,textAlign:"center",backgroundColor:"#f8f8f8"},r={padding:20,display:"inline-flex",flexDirection:"column",width:250,height:250,backgroundColor:"white",boxShadow:"0px 15px 10px -15px #DDD",margin:10,textDecoration:"none"},i={marginTop:30,fontSize:"3rem",color:p.colors.auxiliary},o={marginTop:40,fontWeight:"bold",fontSize:"1.2rem",textTransform:"uppercase",height:70,color:p.colors.primary};return e.data.items.length?t.jsxs("div",{style:a,children:[t.jsx("h2",{"data-label":I(e.data.title),style:{color:p.colors.primary},children:e.data.title}),t.jsx("div",{children:e.data.items.map(d=>t.jsxs(F,{href:d.url,style:r,dataLabel:d.label,children:[t.jsx("div",{children:t.jsx(E,{style:i,icon:d.icon})}),t.jsx("div",{style:o,children:d.label})]},Math.random()))})]}):null}return n()}function lt(e){function n(){return t.jsx("div",{style:{backgroundColor:"black",color:"white",padding:"10px",minHeight:"300px",fontFamily:"monospace, monospace",marginBottom:"30px"},children:e.data.output.split(`
`).map(a=>t.jsx("div",{children:a},Math.random()))})}return n()}function dt(e){function n(){return e.data.url?t.jsx("div",{style:{maxWidth:"100%"},children:t.jsx(F,{href:e.data.url,imodal:!!e.data.modal,children:e.data.icon?t.jsx(E,{icon:e.data.icon}):e.data.url})}):t.jsx("span",{children:"-"})}return n()}function st(e){function n(){return t.jsx("iframe",{src:e.data.url,width:"100%",height:500,style:{border:0}})}return n()}function ct(e){const n=Math.random();N.useEffect(()=>{new QRCode(document.getElementById(n),{text:e.data.text,width:128,height:128,colorDark:"#333333",colorLight:"#ffffff",correctLevel:QRCode.CorrectLevel.H})},[]);function a(){return t.jsx("div",{id:n})}return a()}function ut(e){function n(){const a={color:"white",backgroundColor:p.colors.highlight,margin:-20,textAlign:"center",paddingTop:20,paddingBottom:70},r={fontSize:"4rem",fontWeight:"bold",marginTop:25},i={fontSize:"1.2rem",maxWidth:200,margin:"auto"};if(e.data)return t.jsxs("div",{className:"indicators",style:a,children:[t.jsx("h1",{"data-label":I(e.data.title),children:e.data.title}),t.jsx(Y,{width:300,children:e.data.items.map(o=>t.jsxs("div",{children:[t.jsx("div",{style:r,children:H(o.value)}),t.jsx("div",{style:i,children:o.name})]},Math.random()))},Math.random()),t.jsx("div",{className:"actions",children:e.data.actions.map(o=>t.jsx(F,{href:O(o.url),label:o.label,modal:o.modal,children:o.label},Math.random()))})]})}return n()}function ht(e){function n(){return t.jsx(Y,{width:400,children:e.data.items.map((a,r)=>t.jsx("div",{children:t.jsx(x,{data:a})},Math.random()))})}return n()}function mt(e){function n(){return t.jsxs("div",{children:[t.jsx("h2",{align:"center",children:e.data.title}),t.jsx("div",{style:{fontSize:"8rem",textAlign:"center",color:"#5470c6"},children:e.data.value})]})}return n()}function Ce(e){const n=Math.random();var a=!1;const r="rgb(219, 237, 255)",i="rgb(89, 154, 242)",o="rgb(246, 123, 135)",d="rgb(92, 160, 93)",c=[],s=[],u=["DOM","SEG","TER","QAR","QUI","SEX","SAB"],[l,m]=N.useState(e.data);A(`
    .scheduler{
      width: 100%;
      max-width: 100%;
    }
