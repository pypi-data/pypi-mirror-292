...
class EntitiesModule(BaseModule):
    @api_call(url="/trpc/entities.list", method="get",
    ...
    @api_call(url="/trpc/entities.oneById", method="get",
    ...
    @api_call(url="/trpc/entities.create", method="post",
              return_type=entities_schemas.Entity,
    ...
    @api_call(url="/trpc/entities.update", method="post",
              return_type=entities_schemas.Entity,
    ...
    @api_call(url="/trpc/entities.remove", method="post",
              return_type=entities_schemas.Entity,
