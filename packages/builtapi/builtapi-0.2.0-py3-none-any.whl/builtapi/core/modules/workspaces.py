...
class WorkspacesModule(BaseModule):
    @api_call(url="/trpc/workspaces.list", method="get",
    ...
    @api_call(url="/trpc/workspaces.oneById", method="get",
    ...
    @api_call(url="/trpc/workspaces.create", method="post",
              return_type=workspaces_schemas.Workspace,
    ...
    @api_call(url="/trpc/workspaces.update", method="post",
              return_type=workspaces_schemas.Workspace,
    ...
    @api_call(url="/trpc/workspaces.remove", method="post",
              return_type=workspaces_schemas.Workspace,
    ...
    @api_call(url="/trpc/workspaces.leave", method="post",
              return_type=workspaces_schemas.Workspace,
