...
class MembersModule(BaseModule):
    ...
    @api_call(url="/trpc/members.list", method="get",
    ...
    @api_call(url="/trpc/members.oneById", method="get",
    ...
    @api_call(url="/trpc/members.current", method="get",
              return_type=members_schemas.Member, schema_class=members_schemas.CurrentMemberSchema)
    def current(self):
        return {}

    @api_call(url="/trpc/members.create", method="post",
    ...
    @api_call(url="/trpc/members.update", method="post",
              return_type=members_schemas.Member,
    ...
    @api_call(url="/trpc/members.remove", method="post",
