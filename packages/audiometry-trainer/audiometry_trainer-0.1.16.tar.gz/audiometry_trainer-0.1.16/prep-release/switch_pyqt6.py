...
rootDir = "/media/ntfsShared/lin_home/auditory/code/audiometry_trainer/"
thisDir = os.getcwd()

#read the current pyqt version
f = open(rootDir+'audiometry_trainer/pyqtver.py', 'r')
...
f = open(rootDir + 'audiometry_trainer/pyqtver.py', 'w')
