...
class LinePrice(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["address_id", b"address_id", "extents", b"extents", "mass", b"mass", "method_id", b"method_id", "operations", b"operations", "outcome", b"outcome", "part_id", b"part_id", "quantity", b"quantity", "shop_id", b"shop_id", "stock", b"stock", "total", b"total", "unit", b"unit"]) -> None: ...
