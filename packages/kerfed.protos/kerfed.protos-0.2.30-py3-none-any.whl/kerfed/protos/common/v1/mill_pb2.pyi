...
class CutMill(google.protobuf.message.Message):
    ...
    @property
    def tool(self) -> kerfed.protos.common.v1.tool_pb2.Tool:
    ...
    def __init__(
        ...
        *,
        volume: builtins.float = ...,
        radius: builtins.float = ...,
        tool: kerfed.protos.common.v1.tool_pb2.Tool | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["tool", b"tool"]) -> builtins.bool: ...
