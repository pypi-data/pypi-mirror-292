...
class MirrorPlugin(Plugin):
    ...
    def activate(self, poetry: Poetry, io: IO):
        ...
        pypi_mirror_disable_cache = os.environ.get('POETRY_PYPI_MIRROR_DISABLE_CACHE')
        ...
        if pypi_mirror_disable_cache is not None:
            disable_cache = strtobool(pypi_mirror_disable_cache)
        ...
        if not disable_log:
            io.write_line(f'\033[38;5;192m[Plugin]: The default {DEFAULT_REPO_NAME} source is set to: {pypi_mirror_url}\033[0m')
