...
def signup(ctx: click.Context):
    ...
    rich_console.print("👋 Welcome!")
    rich_console.print(
        "Follow this link to get started with Hashboard and create a new project:"
    )
    rich_console.print()
    rich_console.print(f"{HASHBOARD_BASE_URI}/getAccess", style="underline")
    rich_console.print()
    rich_console.print(
