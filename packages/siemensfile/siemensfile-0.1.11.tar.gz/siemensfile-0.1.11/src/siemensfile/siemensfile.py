...
# Agregar la ruta a PYTHONPATH
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../twixtools/twixtools')))

from twixtools import read_twix # Si está en twixtools.py dentro del módulo
import numpy as np
import pandas as pd
import shutil
import traceback
from utils import ifftnd, extraer_metadata_recursivamente, save_image, rms_comb
