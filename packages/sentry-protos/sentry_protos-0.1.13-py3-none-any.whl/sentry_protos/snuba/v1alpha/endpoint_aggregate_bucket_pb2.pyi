...
class AggregateBucketRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["aggregate", b"aggregate", "filter", b"filter", "granularity_secs", b"granularity_secs", "meta", b"meta", "metric_name", b"metric_name"]) -> None: ...
