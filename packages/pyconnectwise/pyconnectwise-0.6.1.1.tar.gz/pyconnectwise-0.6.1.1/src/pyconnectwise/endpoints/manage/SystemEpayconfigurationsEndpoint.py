...
class SystemEpayconfigurationsEndpoint(
    ...
    def id(self, _id: int) -> SystemEpayconfigurationsIdEndpoint:
        """
    ...
    def post(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> EPayConfiguration:
        """
