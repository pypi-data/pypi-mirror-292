...
class ProcurementSubcategoriesIdInfoEndpoint(
    ...
    def paginated(
        ...
        return PaginatedResponse(
            super()._make_request("GET", params=params), SubCategoryInfo, self, page, page_size, params
        )

    def get(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> SubCategoryInfo:
        """
