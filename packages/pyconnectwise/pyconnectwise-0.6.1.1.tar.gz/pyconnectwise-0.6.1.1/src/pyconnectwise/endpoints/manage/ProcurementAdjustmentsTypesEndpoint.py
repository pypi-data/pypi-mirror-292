...
class ProcurementAdjustmentsTypesEndpoint(
    ...
    def id(self, _id: int) -> ProcurementAdjustmentsTypesIdEndpoint:
        """
    ...
    def post(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> AdjustmentType:
        """
