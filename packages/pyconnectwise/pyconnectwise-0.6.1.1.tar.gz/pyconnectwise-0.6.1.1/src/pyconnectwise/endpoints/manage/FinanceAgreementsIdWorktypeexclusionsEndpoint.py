...
class FinanceAgreementsIdWorktypeexclusionsEndpoint(
    ...
    def __init__(self, client: "ConnectWiseClient", parent_endpoint: ConnectWiseEndpoint = None) -> None:
        ConnectWiseEndpoint.__init__(self, client, "workTypeExclusions", parent_endpoint=parent_endpoint)
    ...
    def id(self, _id: int) -> FinanceAgreementsIdWorktypeexclusionsIdEndpoint:
        """
    ...
    def paginated(
        ...
        return PaginatedResponse(
            super()._make_request("GET", params=params), AgreementWorkTypeExclusion, self, page, page_size, params
        )
