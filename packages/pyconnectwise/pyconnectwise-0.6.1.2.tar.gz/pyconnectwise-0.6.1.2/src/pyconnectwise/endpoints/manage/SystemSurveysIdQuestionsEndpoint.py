...
class SystemSurveysIdQuestionsEndpoint(
    ...
    def id(self, _id: int) -> SystemSurveysIdQuestionsIdEndpoint:
        """
    ...
    def post(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> SurveyQuestion:
        """
