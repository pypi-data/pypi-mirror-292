...
class ProcurementRmastatusesIdInfoEndpoint(
    ...
    def paginated(
        ...
        return PaginatedResponse(
            super()._make_request("GET", params=params), RmaStatusInfo, self, page, page_size, params
        )

    def get(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> RmaStatusInfo:
        """
