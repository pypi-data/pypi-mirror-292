...
class SalesSalesteamsIdMembersEndpoint(
    ...
    def id(self, _id: int) -> SalesSalesteamsIdMembersIdEndpoint:
        """
    ...
    def post(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> SalesTeamMember:
        """
