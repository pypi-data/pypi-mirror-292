...
class FinanceInvoicetemplatesEndpoint(
    ...
    def id(self, _id: int) -> FinanceInvoicetemplatesIdEndpoint:
        """
    ...
    def post(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> InvoiceTemplate:
        """
