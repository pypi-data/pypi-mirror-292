...
class SystemUserdefinedfieldsEndpoint(
    ...
    def id(self, _id: int) -> SystemUserdefinedfieldsIdEndpoint:
        """
    ...
    def post(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> UserDefinedField:
        """
