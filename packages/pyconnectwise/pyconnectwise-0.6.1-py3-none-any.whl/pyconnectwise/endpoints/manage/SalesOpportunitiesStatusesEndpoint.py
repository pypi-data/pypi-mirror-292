...
class SalesOpportunitiesStatusesEndpoint(
    ...
    def id(self, _id: int) -> SalesOpportunitiesStatusesIdEndpoint:
        """
    ...
    def post(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> OpportunityStatus:
        """
