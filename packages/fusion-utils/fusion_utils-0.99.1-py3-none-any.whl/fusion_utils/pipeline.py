...
def execute_all(self):
    ...
    try:
        ...
        if self.errors:
            ...
            self._send_completion_email(total_execution_time)
            # Raise final exception after completion email has been sent
            raise RuntimeError("Pipeline execution failed due to errors.")
        else:
            total_execution_time = sum(stage_durations)
            self._send_completion_email(total_execution_time)