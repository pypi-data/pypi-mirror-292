...
class InvalidBenchmarkingDatasetFormat(WMLClientError, ValueError):
    def __init__(self, e: Exception):
        WMLClientError.__init__(
            self,
            f"Parsing of benchmarking dataset file finished with failure. "
            + "Format of the file was incorrect.",
            reason=str(e),
        )
