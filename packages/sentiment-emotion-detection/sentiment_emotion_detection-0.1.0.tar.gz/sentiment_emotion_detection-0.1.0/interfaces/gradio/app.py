    ...
    with gr.Blocks(theme=gr.themes.Soft()) as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                advice_output = gr.Textbox(label="Personalized Advice")
        ...
        gr.Examples(
            ...
            inputs=text_input,
            outputs=[sentiment_output, detailed_output, emotion_output, detailed_emotion_output, plot_output, emotion_plot_output, fun_fact_output, tweet_url_output, advice_output],
