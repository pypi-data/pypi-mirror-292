...
from pub_utils_hhb.pub_time_util import now
...
def accurate_sleep(s: float = 0, ms: int = 0):
    """
    accurate sleep for seconds and milliseconds
    ...
    while now(unit='ms') < sleep_end_ms:
        pass
