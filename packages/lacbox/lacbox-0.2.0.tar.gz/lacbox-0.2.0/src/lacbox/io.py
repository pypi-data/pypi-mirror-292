...
_ST_NAMES = ["s",
             ...
             "A", "pitch",
             "x_e",	"y_e"]
_AERO_GAIN_NAMES = ["theta_deg", "dq/dtheta_kNm/deg", "fit_kNm/deg",
                    "dq/domega_kNm/(rad/s)", "fit_kNm/(rad/s)"]
...
if __name__ == '__main__':
    ctrl_path = 'C:/Users/rink/git/G-teaching/lac-course-private/dtu-10mw/res_hawc2s/dtu_10mw_hawc2s_ctrltune_ctrl_tuning.txt'
    ctrl_dict = load_ctrl_txt(ctrl_path)
    import matplotlib.pyplot as plt
    aero_gains = ctrl_dict['aero_gains']
    aero_gains.plot()
    plt.show()
