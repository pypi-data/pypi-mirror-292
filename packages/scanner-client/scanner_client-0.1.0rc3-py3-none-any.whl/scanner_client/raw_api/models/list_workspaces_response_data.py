...
T = TypeVar("T", bound="ListWorkspacesResponseData")


@_attrs_define
class ListWorkspacesResponseData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_workspaces_response_data = cls(
            workspaces=workspaces,
        )

        list_workspaces_response_data.additional_properties = d
        return list_workspaces_response_data
