...
class OptimizeConfig(BaseModel):
    ...
    __properties = ["name", "datasetCategory", "classificationType", "targetLatency", "targetDevice", "compiler", "precision", "trainingCycles", "tuningMaxTrials", "tuningWorkers", "minMACCS", "maxMACCS", "tuningAlgorithm", "notificationOnCompletion", "tunerSpaceOptions", "space"]
