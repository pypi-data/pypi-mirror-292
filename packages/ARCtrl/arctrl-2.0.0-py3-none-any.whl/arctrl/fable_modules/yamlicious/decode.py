...
def _expr389() -> TypeInfo:
    return class_type("YAMLicious.Decode.Getter", None, Getter)


class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow377(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr376(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow377()
        def _arrow381(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr380(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow381()
        def _arrow388(__unit: None=None) -> IOverflowGetter:
            _this_2: Any = self
            class ObjectExpr387(IOverflowGetter):
        ...
        self.overflow: IOverflowGetter = _arrow388()
