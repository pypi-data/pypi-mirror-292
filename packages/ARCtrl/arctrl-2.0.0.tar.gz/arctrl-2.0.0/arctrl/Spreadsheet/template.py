...
Metadata_Template_TemplateInfo_reflection = _expr1204
...
def Metadata_Template_TemplateInfo_ToSparseTable_48C39BE1(template: Template) -> SparseTable:
    ...
    def _arrow1205(__unit: None=None, template: Any=template) -> str:
    ...
    add_to_dict(matrix.Matrix, ("Id", 1), "" if (_arrow1205().find("MISSING_IDENTIFIER_") == 0) else _arrow1206())
    ...
    class ObjectExpr1208:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1207(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr1208())), matrix.ColumnCount)
...
def Template_fromFsWorkbook(doc: FsWorkbook) -> Template:
    ...
    def _arrow1218(__unit: None=None, doc: Any=doc) -> ArcTable:
    ...
    return Template_fromParts(template_info, pattern_input[1], pattern_input[2], pattern_input[3], _arrow1218(), now())
