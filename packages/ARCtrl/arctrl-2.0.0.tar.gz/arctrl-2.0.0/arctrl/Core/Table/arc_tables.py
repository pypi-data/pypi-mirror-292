...
class ArcTables:
    def __init__(self, init_tables: Array[ArcTable]) -> None:
        ...
        self.tables: Array[ArcTable] = _expr623()
    ...
    def update_reference_tables_by_sheets(reference_tables: ArcTables, sheet_tables: ArcTables, keep_unused_ref_tables: bool | None=None) -> ArcTables:
        ...
        def _arrow618(__unit: None=None) -> IEnumerable_1[ArcTable]:
            ...
            def _arrow614(__unit: None=None) -> Array[ArcTable]:
            ...
            class ObjectExpr616:
                @property
                def Equals(self) -> Callable[[str, str], bool]:
                    def _arrow615(x_2: str, y_1: str) -> bool:
                        return x_2 == y_1
            ...
            s: Array[ArcTable] = map_3(mapping_4, map_3(mapping_3, Array_groupBy(projection, map_3(mapping_2, _arrow614(), None), ObjectExpr616()), None), None)
        ...
        return ArcTables(list(_arrow618()))
