...
class ArcTable:
    ...
    def init(name: str) -> ArcTable:
        ...
        return ArcTable(name, [], Dictionary([], ObjectExpr613()))
    ...
    def create_from_headers(name: str, headers: Array[CompositeHeader]) -> ArcTable:
        ...
        return ArcTable.create(name, headers, Dictionary([], ObjectExpr617()))
    ...
    def validate(raise_exception: bool | None=None) -> Callable[[ArcTable], bool]:
        def _arrow619(table: ArcTable) -> bool:
    ...
    def Columns(self, __unit: None=None) -> Array[CompositeColumn]:
        this: ArcTable = self
        def _arrow621(__unit: None=None) -> IEnumerable_1[CompositeColumn]:
            def _arrow620(i: int) -> CompositeColumn:
                return this.GetColumn(i)

            return map(_arrow620, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow621))
    ...
    def Copy(self, __unit: None=None) -> ArcTable:
        ...
        return ArcTable.create(this.Name, list(this.Headers), Dictionary(this.Values, ObjectExpr622()))
    ...
    def try_get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell | None]:
        def _arrow624(table: ArcTable) -> CompositeCell | None:
