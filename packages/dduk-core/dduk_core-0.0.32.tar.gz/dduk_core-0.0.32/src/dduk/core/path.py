...
class Path:
	...
	# - 단, 윈도우 서비스 프로세스일 경우 FindUserProfilePath() 는 System 폴더를 가리키고 있을 수 있음.
	# - 그 경우 경로는 다음과 같음 : C:\WINDOWS\system32\config\systemprofile
	# - 따라서 사용 안하는 것을 추천.
	#--------------------------------------------------------------------------------
	@staticmethod
	def GetUserProfilePath() -> str:
	...
	#--------------------------------------------------------------------------------
	@staticmethod
	def GetUserTemporaryPath() -> str:
		platformType : PlatformType = GetPlatformType()
		userProfilePath = Path.GetUserProfilePath()
	...
	#--------------------------------------------------------------------------------
	@staticmethod
	def GetAllUsersTemporaryPath() -> str:
		platformType : PlatformType = GetPlatformType()
