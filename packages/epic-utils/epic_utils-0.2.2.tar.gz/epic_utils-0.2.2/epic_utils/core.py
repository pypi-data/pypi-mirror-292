...
class Vector2Int():
    ...
    def __add__(self, value):
        if ErrorHandler.isType(value, Vector2Int):
...
class Vector3():
    ...
    def __eq__(self, other):
        if ErrorHandler.isType(other, Vector3):
    ...
    def __add__(self, value):
        if ErrorHandler.isType(value, Vector3):
...
class Vector3Int():
    ...
    def __eq__(self, other):
        if ErrorHandler.isType(other, Vector3Int):
            return self.x == other.x and self.y == other.y and self.z == other.z
        return self.x == other and self.y == other and self.z == other
    def __neg__(self):
    ...
    def __add__(self, value):
        if ErrorHandler.isType(value, Vector3Int):
