...
class TablePaginator:
    ...
    def paginate(self, request, context, results, length=15):
        ...
        paginator = Paginator(results, self.size) if results else None

        self.last = paginator.num_pages if paginator else 1
        ...
        self.count = results.count() if results else 0
        ...
        return paginator.page(self.page) if paginator else None
