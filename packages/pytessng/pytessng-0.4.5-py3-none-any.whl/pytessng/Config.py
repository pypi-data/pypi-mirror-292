...
class PathConfig:
    ...
    # (2) ico图标的路径
    ICON_FILE_PATH: str = os.path.join(THIS_FILE_PATH, "Files", "Ico", "TESSNG.ico")
    # (3) 说明书的路径
    INSTRUCTION_FILE_PATH: str = os.path.join(THIS_FILE_PATH, "Files", "Doc", "用户使用手册.pdf")
    # (4) 样例文件的路径
    ...
    OPEN_DIR_PATH: str = os.path.join(WORKSPACE_PATH, "Examples")  # 是在样例文件夹
    # (7) 导出轨迹数据保存为Json的路径
    DEFAULT_SAVE_TRAJ_DIR_PATH: str = os.path.join(WORKSPACE_PATH, "Data", "traj_data")
    # (8) 导出信号灯数据保存为Json的路径
    DEFAULT_SAVE_SIGNAL_DIR_PATH: str = os.path.join(WORKSPACE_PATH, "Data", "traj_data")
    # (9) OSM数据保存的路径
    DEFAULT_SAVE_OSM_DIR_PATH: str = os.path.join(WORKSPACE_PATH, "Data", "osm_data")
