...
def temp_handle(phases: list):
    mapping = {'北左': 1, '北直': 2, '北右': 3, '北行人1': 4, '东左': 5, '东直': 6, '东右': 7, '东行人1': 8, '南左': 9, '南直': 10, '南右': 11, '南行人1': 12, '西左': 13, '西直': 14, '西右': 15, '西行人1': 16, '北掉': 17, '东掉': 18, '南掉': 19, '西掉': 20, '北行人2': 21, '东行人2': 22, '南行人2': 23, '西行人2': 24, '北非机动车': 25, '东非机动车': 26, '南非机动车': 27, '西非机动车': 28, '扩展1': 61, '扩展2': 62, '扩展3': 63, '扩展4': 64, '东北左': 33, '东北直': 34, '东北右': 35, '东北行人1': 36, '东南左': 37, '东南直': 38, '东南右': 39, '东南行人1': 40, '西南左': 41, '西南直': 42, '西南右': 43, '西南行人1': 44, '西北左': 45, '西北直': 46, '西北右': 47, '西北行人1': 48, '东北掉头': 49, '东南掉头': 50, '西南掉头': 51, '西北掉头': 52, '东北行人2': 53, '东南行人2': 54, '西南行人2': 55, '西北行人2': 56, '东北非机动车': 57, '东南非机动车': 58, '西南非机动车': 59, '西北非机动车': 60}
    for phase in phases:
        direction = phase["direction"]
        number = mapping[direction]
        phase["name"] = f"{number}-{direction}"
