...
class IVehicleDriving(Shiboken.Object):
    ...
    def distToEndpoint(self, fromVehiHead:bool=..., bOnCentLine:bool=...) -> float: ...
...
class NetInterface(Shiboken.Object):
    ...
    def createGuidArrow(self, pLane:Tessng.ILane, length:float, distToTerminal:float, arrowType:Tessng.Online.GuideArrowType) -> Tessng.IGuidArrow: ...
    def createLimitedZone(self, param:Tessng.Online.DynaLimitedZoneParam) -> Tessng.ILimitedZone: ...
    ...
    def createReduceSpeedArea(self, name:str, location:float, areaLength:float, roadId:int, laneNumber:int, toLaneNumber:int, fromTime:int, toTime:int, lSpeedVehiType:typing.Sequence) -> Tessng.IReduceSpeedArea: ...
    ...
    def moveLinks(self, lLink:typing.Sequence, offset:PySide2.QtCore.QPointF) -> None: ...
    ...
    def updateLimitedZone(self, param:Tessng.Online.DynaLimitedZoneParam) -> bool: ...
    def updateLink(self, link:Tessng._Link, lLane:typing.Sequence=..., lPoint:typing.Sequence=...) -> Tessng.ILink: ...
    def updateLink3DWithPoints(self, pILink:Tessng.ILink, lV3d:typing.Sequence) -> None: ...
    def updateLinkAndLane3DWithPoints(self, pILink:Tessng.ILink, lCenterLineV3:typing.Sequence, lanesWithPoints:typing.Sequence) -> None: ...
    def updateLinkV3z(self, pILink:Tessng.ILink, lV3z:typing.Sequence) -> None: ...
    def updateRoadWorkZone(self, param:Tessng.Online.DynaRoadWorkZoneParam) -> bool: ...
...
class Online(Shiboken.Object):
    ...
    class ReduceSpeedVehicleType(Shiboken.Object):
        avgSpeed: getset_descriptor # value = <attribute 'avgSpeed' of 'Tessng.Online.ReduceSpeedVehicleType' objects>
        speedSD: getset_descriptor # value = <attribute 'speedSD' of 'Tessng.Online.ReduceSpeedVehicleType' objects>
        vehicleTypeCode: getset_descriptor # value = <attribute 'vehicleTypeCode' of 'Tessng.Online.ReduceSpeedVehicleType' objects>

        @typing.overload
        def __init__(self, ReduceSpeedVehicleType:Tessng.Online.ReduceSpeedVehicleType) -> None: ...
...
class SimuInterface(Shiboken.Object):
    ...
    def getVehisStatus(self, batchNumber:int=...) -> typing.List: ...
