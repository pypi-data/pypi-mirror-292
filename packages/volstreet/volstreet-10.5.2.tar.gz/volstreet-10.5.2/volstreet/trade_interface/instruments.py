...
class Strangle:
    ...
    @classmethod
    def from_options(cls, call_option: Option, put_option: Option):
        instance = cls(
            call_option.strike,
            put_option.strike,
            call_option.underlying,
            call_option.expiry,
        )
        instance.call_option = call_option
        instance.put_option = put_option
        return instance
...
def _set_underlying_attributes(instance, underlying: str):
    ...
    if config.backtest_mode:
        instance.freeze_qty_in_shares = 10000000000
    elif not symbol_df.empty:
