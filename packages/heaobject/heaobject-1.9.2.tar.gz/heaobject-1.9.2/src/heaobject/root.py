...
class PermissionContext(Generic[DesktopObjectTypeVar]):
    """
    ...
    async def get_permissions(self, obj: DesktopObjectTypeVar) -> list[Permission]:
        """
    ...
    async def get_permissions_as_share(self, obj: DesktopObjectTypeVar) -> Share:
        """
    ...
    async def has_permissions(self, obj: DesktopObjectTypeVar, perms: Sequence[Permission] | PermissionGroup):
        """
    ...
    async def is_read_only(self, obj: DesktopObjectTypeVar) -> bool:
        """
    ...
    async def get_attribute_permissions(self, obj: DesktopObjectTypeVar, attr: str) -> list[Permission]:
        """
    ...
    async def has_attribute_permissions(self, obj: DesktopObjectTypeVar, attr: str, perms: Sequence[Permission] | PermissionGroup) -> bool:
        """
    ...
    async def is_attribute_read_only(self, obj: DesktopObjectTypeVar, attr: str) -> bool:
        """
...
class ViewerPermissionContext(PermissionContext[DesktopObjectTypeVar], Generic[DesktopObjectTypeVar]):
    async def get_permissions(self, obj: DesktopObjectTypeVar) -> List[root.Permission]:
        return [Permission.VIEWER]
...
class DesktopObject(HEAObject, abc.ABC):
    ...
    def instance_id(self) -> str | None:
        ...
        storage time, like the id attribute. Prior to storage, its value will be None."""
        pass
    ...
    @abc.abstractmethod
    async def get_permissions(self: DesktopObjectTypeVar, context: PermissionContext[DesktopObjectTypeVar]) -> list[Permission]:
        """
        Gets permissions for this object for the current permissions context.
    ...
    @abc.abstractmethod
    async def get_permissions_as_share(self: DesktopObjectTypeVar, context: PermissionContext[DesktopObjectTypeVar]) -> Share:
        """
        Gets a Share representing the permissions for the current permissions context.
    ...
    @abc.abstractmethod
    async def has_permissions(self: DesktopObjectTypeVar, perms: Sequence[Permission] | PermissionGroup, context: PermissionContext[DesktopObjectTypeVar]) -> bool:
        """
    ...
    @abc.abstractmethod
    async def is_read_only(self: DesktopObjectTypeVar, context: PermissionContext[DesktopObjectTypeVar]) -> bool:
        """
    ...
    @abc.abstractmethod
    async def get_attribute_permissions(self: DesktopObjectTypeVar, attr: str, context: PermissionContext[DesktopObjectTypeVar]) -> list[Permission]:
        """
        Gets the permissions for the specified attribute of this object given a permission context.
    ...
    @abc.abstractmethod
    async def get_all_attribute_permissions(self: DesktopObjectTypeVar, context: PermissionContext[DesktopObjectTypeVar]) -> dict[str, list[Permission]]:
        """
    ...
    @abc.abstractmethod
    async def has_attribute_permissions(self: DesktopObjectTypeVar, attr: str, perms: Sequence[Permission] | PermissionGroup, context: PermissionContext[DesktopObjectTypeVar]) -> bool:
        """
    ...
    @abc.abstractmethod
    async def is_attribute_read_only(self: DesktopObjectTypeVar, attr: str, context: PermissionContext[DesktopObjectTypeVar]) -> bool:
        """
    ...
    @abc.abstractmethod
    async def _default_get_attribute_permissions(self: DesktopObjectTypeVar, context: PermissionContext[DesktopObjectTypeVar], attr: str) -> list[Permission]:
        """
...
class AbstractDesktopObject(AbstractHEAObject, DesktopObject, abc.ABC):
    ...
    async def get_all_attribute_permissions(self: DesktopObjectTypeVar, context: PermissionContext[DesktopObjectTypeVar]) -> dict[str, list[Permission]]:
        return {attr: await self.get_attribute_permissions(attr, context) for attr in self.get_all_attributes()}
