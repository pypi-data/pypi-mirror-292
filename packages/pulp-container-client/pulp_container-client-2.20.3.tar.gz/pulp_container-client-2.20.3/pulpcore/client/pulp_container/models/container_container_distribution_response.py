...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_last_updated=None, repository=None, name=None, base_path=None, content_guard=None, pulp_href=None, pulp_labels=None, hidden=False, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
