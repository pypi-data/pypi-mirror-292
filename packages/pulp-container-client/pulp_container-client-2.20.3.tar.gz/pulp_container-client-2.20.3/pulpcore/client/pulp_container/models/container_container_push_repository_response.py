...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, latest_version_href=None, description=None, pulp_last_updated=None, versions_href=None, retain_repo_versions=None, name=None, manifest_signing_service=None, pulp_href=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
