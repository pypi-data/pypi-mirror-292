...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, description=None, retain_repo_versions=None, name=None, manifest_signing_service=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
