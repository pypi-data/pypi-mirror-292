...
# CompoundingType
def to_compounding_type(src: str):
    '''
...
# PricingModelName
def to_pricing_model_name(src: str):
    '''
...
# PricingMethodName
def to_pricing_method_name(src: str):
    '''
...
def to_finite_difference_method(src: str):
    '''
...
# RiskGranularity
def to_risk_granularity(src: str):
    '''
...
def to_ir_yield_curve_building_method(src: str):
    '''
...
# IrYieldCurveType
def to_ir_yield_curve_type(src: str):
    '''
