...
import time
from app_sdk_zxw.SDK_硬件读写.进制转换 import *
from app_sdk_zxw.SDK_硬件读写.crc16 import crc16
from app_sdk_zxw.SDK_硬件读写.串口_网口_通讯封装.串口读写.serial封装 import rw串口操作
from app_sdk_zxw.SDK_硬件读写.串口_网口_通讯封装.串口读写.app应用级封装 import serial串口读写设备
