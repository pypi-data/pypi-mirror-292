...
from fastapi_rtk import g, metadatas, session_manager
...
async def run_async_migrations() -> None:
    ...
    session_manager.init_db(MAIN_DATABASE, BINDS)
    ...
    for name, metadata in target_metadata.items():
        logger.info("Migrating database %s" % name)
        async with session_manager.connect(name.replace("default", "")) as connection:
