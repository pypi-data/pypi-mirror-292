...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"listener": "listener", "priority": "priority"},
)
class AllocatePriorityProps:
    def __init__(
        ...
        *,
        ...
        :param listener: (experimental) The listener to allocate the priority to.
    ...
    def listener(
        ...
        '''(experimental) The listener to allocate the priority to.
...
class ApplicationListenerPriorityAllocator(
    ...
    def of(
        ...
        '''(experimental) Returns the singleton instance of the ApplicationListenerPriorityAllocator for the stack.

        :param scope: The scope of the construct.

        :return: The singleton instance of the ApplicationListenerPriorityAllocator for the stack.

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b7d4611365f8f653021e0a43014c0f1c4a01bde690b08eaa33fac1d5649b4238)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
        return typing.cast("ApplicationListenerPriorityAllocator", jsii.sinvoke(cls, "of", [scope]))
    ...
    def allocate_priority(
        ...
        *,
        ...
        '''(experimental) Allocates a priority to an application listener rule.
        ...
        if __debug__:
            ...
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = AllocatePriorityProps(listener=listener, priority=priority)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"priority_initial_value": "priorityInitialValue"},
)
...
class EntrypointProps:
    def __init__(
        ...
        *,
        ...
        priority_allocator: typing.Optional[typing.Union[ApplicationListenerPriorityAllocatorProps, typing.Dict[builtins.str, typing.Any]]] = None,
        security_group_name: typing.Optional[builtins.str] = None,
    ) -> None:
        ...
        if isinstance(priority_allocator, dict):
            priority_allocator = ApplicationListenerPriorityAllocatorProps(**priority_allocator)
        if __debug__:
    ...
    def priority_allocator(
        self,
    ) -> typing.Optional[ApplicationListenerPriorityAllocatorProps]:
        '''(experimental) Customize the priority allocator for the entrypoint.

        :stability: experimental
        '''
        result = self._values.get("priority_allocator")
        return typing.cast(typing.Optional[ApplicationListenerPriorityAllocatorProps], result)
...
def _typecheckingstub__b7d4611365f8f653021e0a43014c0f1c4a01bde690b08eaa33fac1d5649b4238(
    scope: _constructs_77d1e7e8.Construct,
) -> None:
    """Type checking stubs"""
    pass
