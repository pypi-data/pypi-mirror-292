...
from resource_graph.altimeter.core.graph.exceptions import (
...
from resource_graph.altimeter.core.graph import SCALAR_TYPES
from resource_graph.altimeter.core.graph.field.util import camel_case_to_snake_case
from resource_graph.altimeter.core.graph.links import LinkCollection
...
class ListField(Field):
    ...
    Examples:
        A list of strings:
            >>> from resource_graph.altimeter.core.graph.field.scalar_field import EmbeddedScalarField
...
class AnonymousListField(Field):
    ...
    Examples:
        A DictField containing an AnonymousListField:
            >>> from resource_graph.altimeter.core.graph.field.dict_field import DictField
            >>> from resource_graph.altimeter.core.graph.field.scalar_field import EmbeddedScalarField
