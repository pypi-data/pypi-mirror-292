...
from resource_graph.altimeter.aws.resource.elbv2 import ELBV2ResourceSpec
...
class LoadBalancerResourceSpec(ELBV2ResourceSpec):
    ...
    schema = Schema(
        ...
        AnonymousDictField(
            "State", ScalarField("Code", alti_key="load_balancer_state")
        ),
        ScalarField("Type"),
        ListField(
            "AvailabilityZones",
            EmbeddedDictField(
                ...
                TransientResourceLinkField(
                    "SubnetId", SubnetResourceSpec, optional=True
                ),
                ListField(
        ...
        ScalarField("AccessLogsEnabled", optional=True),
        TransientResourceLinkField(
            "AccessLogsS3Bucket",
