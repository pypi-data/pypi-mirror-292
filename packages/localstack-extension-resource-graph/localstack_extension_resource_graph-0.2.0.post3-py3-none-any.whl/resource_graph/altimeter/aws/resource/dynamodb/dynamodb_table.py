...
from resource_graph.altimeter.aws.resource.dynamodb import DynamoDBResourceSpec
...
class DynamoDbTableResourceSpec(DynamoDBResourceSpec):
    ...
    schema = Schema(
        ...
        AnonymousDictField(
            ...
            ScalarField("NumberOfDecreasesToday", optional=True),
        ),
        ...
        AnonymousDictField(
            "BillingModeSummary", ScalarField("BillingMode"), optional=True
        ),
        AnonymousDictField(
            "BillingModeSummary",
        ...
        AnonymousDictField(
            "ContinuousBackupsDescription", ScalarField("ContinuousBackupsStatus")
        ),
        AnonymousDictField(
    ...
    @classmethod
    def list_from_aws(
        cls: Type["DynamoDbTableResourceSpec"],
        client: BaseClient,
        account_id: str,
        region: str,
    ) -> ListFromAWSResult:
...
def get_continuous_backup_table_data(client: BaseClient, table_name: str) -> Dict:
    ...
    backup_data = {
        "ContinuousBackupsDescription": resp.get("ContinuousBackupsDescription", None)
    }
    return backup_data
