...
from resource_graph.altimeter.core.resource.exceptions import (
...
from resource_graph.altimeter.core.graph.links import Link, LinkCollection
...
class ResourceSpec(abc.ABC):
    ...
    def merge_resources(resource_id: str, resources: List[Resource]) -> Resource:
        ...
        if len(full_type_names) > 1:
            ...
            spec_classes_resources: DefaultDict[Type[ResourceSpec], List[Resource]] = (
                defaultdict(list)
            )
            ...
            for resource in resources:
                ...
                spec_classes: List[Type[ResourceSpec]] = (
                    ResourceSpec.get_by_full_type_name(full_type_name)
                )
