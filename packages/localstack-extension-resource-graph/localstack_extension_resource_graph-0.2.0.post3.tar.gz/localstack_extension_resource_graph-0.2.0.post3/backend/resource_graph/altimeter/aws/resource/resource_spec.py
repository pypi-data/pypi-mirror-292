...
from resource_graph.altimeter.core.graph.exceptions import SchemaParseException
from resource_graph.altimeter.core.graph.links import LinkCollection, ResourceLink
...
class AWSResourceSpec(ResourceSpec):
    ...
    def _list_from_aws_result_to_resources(
        ...
        for arn, resource_dict in list_from_aws_result.resources.items():
            ...
            link_collection = (
                partial_resource_link_collection
                + LinkCollection.from_links(account_region_links)
            )
