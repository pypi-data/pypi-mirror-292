...
from resource_graph.altimeter.aws.scan.scan_plan import AccountScanPlan, ScanPlan
from resource_graph.altimeter.aws.scan.account_scan_manifest import AccountScanManifest
...
class AWSScanMuxer(abc.ABC):
    ...
    def scan(self, scan_plan: ScanPlan) -> Generator[AccountScanManifest, None, None]:
        ...
        with logger.bind(
            ...
            for account_scan_try in range(
                self.config.concurrency.max_account_scan_tries
            ):
