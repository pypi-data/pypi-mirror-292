...
class AviaryModelConfigV2(object):
    ...
    def __init__(self, base_model_id=None, model_id=None, generation=None, cloud_id=None, project_id=None, lora_mirror_config=None, full_param_mirror_config=None, local_vars_configuration=None):  # noqa: E501
