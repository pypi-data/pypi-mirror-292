...
ListCommitsResponse = _reflection.GeneratedProtocolMessageType('ListCommitsResponse', (_message.Message,), dict(
...
ListAllCommitsRequest = _reflection.GeneratedProtocolMessageType('ListAllCommitsRequest', (_message.Message,), dict(
...
ListAllCommitsResponse = _reflection.GeneratedProtocolMessageType('ListAllCommitsResponse', (_message.Message,), dict(
...
CountDivergingCommitsRequest = _reflection.GeneratedProtocolMessageType('CountDivergingCommitsRequest', (_message.Message,), dict(
...
CountDivergingCommitsResponse = _reflection.GeneratedProtocolMessageType('CountDivergingCommitsResponse', (_message.Message,), dict(
...
ListCommitsByRefNameRequest = _reflection.GeneratedProtocolMessageType('ListCommitsByRefNameRequest', (_message.Message,), dict(
...
ListCommitsByRefNameResponse = _reflection.GeneratedProtocolMessageType('ListCommitsByRefNameResponse', (_message.Message,), dict(

  CommitForRef = _reflection.GeneratedProtocolMessageType('CommitForRef', (_message.Message,), dict(
...
CheckObjectsExistRequest = _reflection.GeneratedProtocolMessageType('CheckObjectsExistRequest', (_message.Message,), dict(
...
CheckObjectsExistResponse = _reflection.GeneratedProtocolMessageType('CheckObjectsExistResponse', (_message.Message,), dict(

  RevisionExistence = _reflection.GeneratedProtocolMessageType('RevisionExistence', (_message.Message,), dict(
...
_LISTCOMMITSREQUEST.fields_by_name['repository'].has_options = True
_LISTCOMMITSREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_LISTALLCOMMITSREQUEST.fields_by_name['repository'].has_options = True
_LISTALLCOMMITSREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_COMMITSTATSREQUEST.fields_by_name['repository'].has_options = True
_COMMITSTATSREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_COMMITISANCESTORREQUEST.fields_by_name['repository'].has_options = True
_COMMITISANCESTORREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_TREEENTRYREQUEST.fields_by_name['repository'].has_options = True
_TREEENTRYREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_COUNTCOMMITSREQUEST.fields_by_name['repository'].has_options = True
_COUNTCOMMITSREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_COUNTDIVERGINGCOMMITSREQUEST.fields_by_name['repository'].has_options = True
_COUNTDIVERGINGCOMMITSREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_GETTREEENTRIESREQUEST.fields_by_name['repository'].has_options = True
_GETTREEENTRIESREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_LISTFILESREQUEST.fields_by_name['repository'].has_options = True
_LISTFILESREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_FINDCOMMITREQUEST.fields_by_name['repository'].has_options = True
_FINDCOMMITREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_LISTCOMMITSBYOIDREQUEST.fields_by_name['repository'].has_options = True
_LISTCOMMITSBYOIDREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_LISTCOMMITSBYREFNAMEREQUEST.fields_by_name['repository'].has_options = True
_LISTCOMMITSBYREFNAMEREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_FINDALLCOMMITSREQUEST.fields_by_name['repository'].has_options = True
_FINDALLCOMMITSREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_FINDCOMMITSREQUEST.fields_by_name['repository'].has_options = True
_FINDCOMMITSREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_COMMITLANGUAGESREQUEST.fields_by_name['repository'].has_options = True
_COMMITLANGUAGESREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_RAWBLAMEREQUEST.fields_by_name['repository'].has_options = True
_RAWBLAMEREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_LASTCOMMITFORPATHREQUEST.fields_by_name['repository'].has_options = True
_LASTCOMMITFORPATHREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_LISTLASTCOMMITSFORTREEREQUEST.fields_by_name['repository'].has_options = True
_LISTLASTCOMMITSFORTREEREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_LISTLASTCOMMITSFORTREEREQUEST.fields_by_name['literal_pathspec'].has_options = True
_LISTLASTCOMMITSFORTREEREQUEST.fields_by_name['literal_pathspec']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_COMMITSBYMESSAGEREQUEST.fields_by_name['repository'].has_options = True
_COMMITSBYMESSAGEREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_FILTERSHASWITHSIGNATURESREQUEST.fields_by_name['repository'].has_options = True
_FILTERSHASWITHSIGNATURESREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_EXTRACTCOMMITSIGNATUREREQUEST.fields_by_name['repository'].has_options = True
_EXTRACTCOMMITSIGNATUREREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_GETCOMMITSIGNATURESREQUEST.fields_by_name['repository'].has_options = True
_GETCOMMITSIGNATURESREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_GETCOMMITMESSAGESREQUEST.fields_by_name['repository'].has_options = True
_GETCOMMITMESSAGESREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
_CHECKOBJECTSEXISTREQUEST.fields_by_name['repository'].has_options = True
_CHECKOBJECTSEXISTREQUEST.fields_by_name['repository']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\230\306,\001'))
