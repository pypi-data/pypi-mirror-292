...
class _WorkerSide(BaseWorkerAlgorithm):
    ...
    def run(
        ...
        for _batch_idx, batch in enumerate(self.test_dataloader):
            ...
            if isinstance(input_[0], tuple):  # type: ignore[unreachable] # Reason: see above # noqa: B950
                input_ = [item[0] for item in input_]  # type: ignore[unreachable] # Reason: see above # noqa: B950
