...
from bitfount.config import _MULTITHREADING_DEBUG
...
async def await_threading_event(
    ...
    Returns:
        ...
        `False` otherwise.
    """
    if _MULTITHREADING_DEBUG and timeout is None and polling_timeout is NO_POLLING:
        _logger.warning(
...
async def async_lock(
    ...
    """
    if _MULTITHREADING_DEBUG and polling_timeout is NO_POLLING:
        _logger.warning(
