...
from bitfount.config import BITFOUNT_PROXY_CERT_DIR
...
def _create_pem_bundle(pems: str) -> Path:
    ...
    Writes to a TMP_DIR file, unless BITFOUNT_PROXY_CERT_DIR is set.
    ...
    """
    cert_dir: Path
    if BITFOUNT_PROXY_CERT_DIR:
        cert_dir = BITFOUNT_PROXY_CERT_DIR
