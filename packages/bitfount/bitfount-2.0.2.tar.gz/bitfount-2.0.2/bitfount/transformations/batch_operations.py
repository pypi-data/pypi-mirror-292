...
import albumentations.augmentations as albumentations_augmentations  # type: ignore[import-untyped] # Reason: only used for vars extraction, don't need type hints # noqa: B950
import albumentations.pytorch as albumentations_pytorch  # type: ignore[import-untyped] # Reason: only used for vars extraction, don't need type hints # noqa: B950
import attr
