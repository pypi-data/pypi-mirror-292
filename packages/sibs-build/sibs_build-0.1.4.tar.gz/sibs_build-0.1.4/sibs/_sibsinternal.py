...
def compilecmd(cmd: str) -> str:
    ...
    cmd = cmd.replace("$CXXL", f"gcc {sibsopt_cflags} {sibsopt_cxxflags}")
        ...
        for arg in sys.argv[1:]:
            if arg.startswith("--"):
                if arg == "--nohashdir" or arg == "--nocmakepersist":
                    ...
                    print("Usage:")
                    print("python -m sibs (directory) (--nocmakepersist/--nohashdir --nohcache/--nopersist --cflags=... --ccflags=... --ldflags=... --cxxflags=... --cxxlflags=... --cclflags=... --arflags=... --help)")
                    print("Options:")
