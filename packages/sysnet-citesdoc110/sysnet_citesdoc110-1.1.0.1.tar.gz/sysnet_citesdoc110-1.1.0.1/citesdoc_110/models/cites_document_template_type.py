...
class CitesDocumentTemplateType(object):
    ...
    def __init__(self, doc_code=None, name=None, template_type='PDF', has_enclosure=False, template_first=None, template_enclosure=None, enclosure_size=0):  # noqa: E501
