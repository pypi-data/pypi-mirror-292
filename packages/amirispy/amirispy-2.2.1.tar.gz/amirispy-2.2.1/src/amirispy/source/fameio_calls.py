...
from fameio.source.cli.convert_results import handle_args as handle_output_args
from fameio.source.cli.options import Options, ResolveOptions, MergingOptions, TimeOptions
...
def override_eligible_defaults(defaults: Dict, overrides: str) -> Dict:
    ...
    try:
        ...
        if "merge-times" not in argument_list:
            argument_list.append("merge-times")
