...
def build(setup_kwargs: Dict[str, Any]) -> None:
    ...
    src_dir = Path(skbuild.constants.CMAKE_INSTALL_DIR()) / "echaimlib"
    dest_dir = Path("src/echaim")
    # Delete C-extensions copied in previous runs, just in case.
    remove_files(dest_dir, "**/*libechaim*")
    # Copy built C-extensions back to the project.
    copy_files(src_dir, dest_dir, "**/*libechaim*")
