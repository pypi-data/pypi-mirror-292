...
from scripts.custom_model import SingleDense, TwoConOneDense
...
def main():
    ...
    train_system_configuration = TrainSystemConfiguration(preprocessing_processes_per_train_process=1)
