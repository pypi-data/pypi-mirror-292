...
Refer to the Terraform Registry for docs: [`akeyless_rotated_secret_cassandra`](https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra).
'''
import abc
import builtins
import datetime
...
class RotatedSecretCassandra(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra akeyless_rotated_secret_cassandra}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra akeyless_rotated_secret_cassandra} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Secret name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#name RotatedSecretCassandra#name}
        :param rotator_type: The rotator type [target/password]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotator_type RotatedSecretCassandra#rotator_type}
        :param target_name: The target name to associate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#target_name RotatedSecretCassandra#target_name}
        :param authentication_credentials: The credentials to connect with [use-self-creds/use-target-creds]. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#authentication_credentials RotatedSecretCassandra#authentication_credentials}
        :param auto_rotate: Whether to automatically rotate every --rotation-interval days, or disable existing automatic rotation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#auto_rotate RotatedSecretCassandra#auto_rotate}
        :param description: Description of the object. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#description RotatedSecretCassandra#description}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#id RotatedSecretCassandra#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param key: The name of a key that is used to encrypt the secret value (if empty, the account default protectionKey key will be used). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#key RotatedSecretCassandra#key}
        :param password_length: The length of the password to be generated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#password_length RotatedSecretCassandra#password_length}
        :param rotated_password: rotated-username password (relevant only for rotator-type=password). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotated_password RotatedSecretCassandra#rotated_password}
        :param rotated_username: username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it's own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type=password). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotated_username RotatedSecretCassandra#rotated_username}
        :param rotation_hour: The Hour of the rotation in UTC. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotation_hour RotatedSecretCassandra#rotation_hour}
        :param rotation_interval: The number of days to wait between every automatic rotation (1-365),custom rotator interval will be set in minutes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotation_interval RotatedSecretCassandra#rotation_interval}
        :param tags: List of the tags attached to this secret. To specify multiple tags use argument multiple times: -t Tag1 -t Tag2 Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#tags RotatedSecretCassandra#tags}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RotatedSecretCassandra that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#import import section} in the documentation of this resource for the id to use
...
class RotatedSecretCassandraConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#name RotatedSecretCassandra#name}
        '''
    ...
    def rotator_type(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotator_type RotatedSecretCassandra#rotator_type}
        '''
    ...
    def target_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#target_name RotatedSecretCassandra#target_name}
        '''
    ...
    def authentication_credentials(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#authentication_credentials RotatedSecretCassandra#authentication_credentials}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#description RotatedSecretCassandra#description}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#id RotatedSecretCassandra#id}.
    ...
    def key(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#key RotatedSecretCassandra#key}
        '''
    ...
    def password_length(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#password_length RotatedSecretCassandra#password_length}
        '''
    ...
    def rotated_password(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotated_password RotatedSecretCassandra#rotated_password}
        '''
    ...
    def rotated_username(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotated_username RotatedSecretCassandra#rotated_username}
        '''
    ...
    def rotation_hour(self) -> typing.Optional[jsii.Number]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotation_hour RotatedSecretCassandra#rotation_hour}
        '''
    ...
    def rotation_interval(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#rotation_interval RotatedSecretCassandra#rotation_interval}
        '''
    ...
    def tags(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.7.2/docs/resources/rotated_secret_cassandra#tags RotatedSecretCassandra#tags}
        '''
