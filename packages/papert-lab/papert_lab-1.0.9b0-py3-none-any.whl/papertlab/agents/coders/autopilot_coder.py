...
class AutopilotCoder(Coder):
    ...
    def __init__(self, main_model, io, from_coder=None, **kwargs):
        ...
        # Add a check for main_model being None
        commit_message_models = main_model.commit_message_models() if main_model else None
        super().__init__(main_model, io, models=commit_message_models, **kwargs)
