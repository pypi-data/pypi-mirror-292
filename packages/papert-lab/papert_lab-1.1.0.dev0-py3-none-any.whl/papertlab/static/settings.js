...
const Settings = () => {
    ...
    const handleSave = async () => {
        try {
            ...
            showNotification('Failed to save API keys. Please try again.', false);
        }
    };
    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="flex-grow relative">
                ...
                {notification && (
                    <div className={`fixed bottom-4 right-4 p-4 rounded-md ${notification.isSuccess ? 'bg-green-500' : 'bg-red-500'} text-white`}>
