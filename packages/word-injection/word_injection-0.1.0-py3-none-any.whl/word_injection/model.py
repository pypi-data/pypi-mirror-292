...
class ExtendableSentenceTransformer(SentenceTransformer):
    ...
    def get_input_token_embeddings(self) -> torch.Tensor:
        """
        Get the input embeddings for all tokens.
        :return:
        """
        return self[0].auto_model.embeddings.word_embeddings.weight.detach().clone()
