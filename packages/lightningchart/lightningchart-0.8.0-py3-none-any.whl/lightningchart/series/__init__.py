...
from lightningchart import charts, convert_to_list
...
class BetaXYFeatures(Series):
    ...
    def set_line_color_lookup_table(
            self,
            steps: list[dict],
    ...
    def set_point_color_lookup_table(
            self,
...
class SeriesWithAddValues(Series):
    ...
    def add_values(
        ...
        if intensity_values and not isinstance(intensity_values, list):
            intensity_values = convert_to_list(intensity_values)
...
class SeriesWithAddIntensityValues(Series):
    ...
    def add_intensity_values(self, new_data_points: list[list[int | float]]):
        ...
        if not isinstance(new_data_points, list):
            new_data_points = convert_to_list(new_data_points)
