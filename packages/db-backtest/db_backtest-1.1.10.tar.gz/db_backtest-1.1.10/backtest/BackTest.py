...
class BackTest_DF(object):
    ...
    def __init__(self, signal,close_hfq,initial_money,coupon_interest_rate,turnover_rate,stamp_rate,other_close=None,chengfen_filepath=None):

        '''
        signal: 交易信号,可以是list或者dataframe
                包括日期、交易方向、股票代码、数量、价格
                交易方向：
                1: 买入
                2: 卖出
                3: 融资买入
