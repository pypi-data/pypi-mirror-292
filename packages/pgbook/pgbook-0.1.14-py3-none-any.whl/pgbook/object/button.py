...
class TextButton(BaseButton):
    ...
    def draw(self,screen):
        super().rect.height=self.text.textbook.get_rect().height
        super().rect.width=self.text.textbook.get_rect().width
        super().connect_page(screen)
