...
class BaseText:
    ...
    def new_date(self,text='Some Text',color=(255,255,255),textsize=24,textfile=None):
        ...
        if textfile==None:
            font_path = pkg_resources.resource_filename('pgbook', 'static/fonts/NotoFont.ttf',textsize)
        else:
            font_path=textfile
        self.font= pygame.font.Font(font_path)
        self.textbook = self.font.render(self.text, True, self.textcolor, background=None)