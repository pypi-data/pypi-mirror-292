...
from burr.tracking.client import StreamState, StateKey
from burr.tracking.common.models import (
    ...
    EndEntryModel,
    EndSpanModel,
    PointerModel, InitializeStreamModel, EndStreamModel, FirstItemStreamModel,
)
...
class S3TrackingClient(SyncTrackingClient):
    ...
    def pre_start_stream(self, *, action: str, sequence_id: int, app_id: str, partition_key: Optional[str], **future_kwargs: Any):
    ...
    def post_stream_item(self, *, item: Any, item_index: int, stream_initialize_time: datetime.datetime, first_stream_item_start_time: datetime.datetime, action: str, sequence_id: int, app_id: str,
                         partition_key: Optional[str], **future_kwargs: Any):
    ...
    def post_end_stream(self, *, action: str, sequence_id: int, app_id: str, partition_key: Optional[str], **future_kwargs: Any):
        stream_state = self.stream_state[app_id, action, partition_key]
        self.submit_log_event(
            EndStreamModel(
                action_sequence_id=sequence_id,
