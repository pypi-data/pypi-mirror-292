...
class Condition(Function):
    ...
    def lmda(self, fn: Callable, state_keys: List[str] = None):
        """Returns a condition that evaluates the given function. This can optionally declare
        the keys that the function will read from state. If not provided, it will attempt to
        parse the function signature for keyword arguments.
        ...
        :return:
        """
        state_keys = ... # TODO -- derive + error check
        return Condition(state_keys, fn, name=fn.__name__)
