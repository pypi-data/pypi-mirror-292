...
class KBBot:
    ...
    def system_prompt(self):
        ...
        - Respond in the json format {{ "answer": "", refs: ["<ref1>", "<ref2>"] }}. Where "answer" is the answer and "refs" are the reference urls.
        """
    ...
    def chat(
        ...
        response = self.llm_client.chat(messages=messages, tools=self.tools, response_format={ type: "json_object" })
