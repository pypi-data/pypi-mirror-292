...
"""
    ...
    pip3 cache purge
    pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple Fr1997v011==2.0.3
"""
...
class XhsJike:
    ...
    def xhs_app_url_302(self, url):
        # Updated pattern to match new formats like /B/Yvww60, /C/Yvww60, and old format /s4dqRB
        pattern = r'://xhslink\.com(/?[A-Za-z0-9]+/[A-Za-z0-9]{6})|://xhslink\.com/([A-Za-z0-9]{6})'
        match = re.search(pattern, url)

        if match:
            # If the first part matches, use it; otherwise, use the second part
            if match.group(1):
