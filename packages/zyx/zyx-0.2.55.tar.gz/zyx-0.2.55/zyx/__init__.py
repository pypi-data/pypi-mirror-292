...
def chat():
    ...
    parser.add_argument("--provider", type=str, help="The provider instance to handle the chat logic")
    parser.add_argument("--messages", type=str, help="The messages to send to the model")
    parser.add_argument("--model", type=str, default="gpt-4o-mini", help="The model to use for completions")
    parser.add_argument("--tools", nargs="+", help="The tools to use for completions")
    parser.add_argument("--run-tools", type=bool, default=True, help="Whether to run the tools")
    parser.add_argument("--response-model", type=str, help="The Pydantic response model to use for completions")
    parser.add_argument("--mode", type=str, default="tools", help="The mode to use for completions")
    ...
    parser.add_argument("--organization", type=str, help="The organization to use for the API")
    parser.add_argument("--top-p", type=float, help="The top-p value for completions")
    parser.add_argument("--temperature", type=float, help="The temperature value for completions")
    parser.add_argument("--max-tokens", type=int, help="The maximum number of tokens for completions")
    parser.add_argument("--max-retries", type=int, default=3, help="The maximum number of retries for completions")
    parser.add_argument("--verbose", type=bool, default=False, help="Whether to print verbose output")
    parser.add_argument("--background", type=str, default="midnight_black", help="Background color of the app")
    parser.add_argument("--text", type=str, default="steel_grey", help="Text color in the chat display")
    parser.add_argument("--input-field", type=str, default="ocean_blue", help="Color of the input field")
