...
from typing import Callable, List, Optional, Union, Generator, Literal
...
def completion(
    ...
    optimizer: Optional[Literal["costar"]] = "costar",
    mode: Optional[ClientModeParams] = "md_json",
    base_url: Optional[str] = None,
    api_key: Optional[str] = None,
    organization: Optional[str] = None,
    ...
    **kwargs,
    ...
    @tenacity.retry(stop=tenacity.stop_after_attempt(2), retry=tenacity.retry_if_exception_type(Exception))
