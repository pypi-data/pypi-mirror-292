...
from zdppy_excel.xml.functions import iterparse

# package imports
from zdppy_excel.cell import Cell, MergedCell
from zdppy_excel.cell.text import Text
from zdppy_excel.worksheet.dimensions import (
    ColumnDimension,
    RowDimension,
...
from zdppy_excel.formatting.formatting import ConditionalFormatting
from zdppy_excel.formula.translate import Translator
from zdppy_excel.utils import (
    get_column_letter,
    coordinate_to_tuple,
    )
from zdppy_excel.utils.datetime import from_excel, from_ISO8601, WINDOWS_EPOCH
from zdppy_excel.descriptors.excel import ExtensionList
from zdppy_excel.cell.rich_text import CellRichText
...
class WorksheetReader(object):
    ...
    def bind_merged_cells(self):
        from zdppy_excel.worksheet.cell_range import MultiCellRange
        from zdppy_excel.worksheet.merge import MergedCellRange
