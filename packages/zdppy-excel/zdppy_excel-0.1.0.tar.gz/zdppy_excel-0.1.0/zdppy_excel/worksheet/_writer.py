...
from zdppy_excel.xml.functions import xmlfile
from zdppy_excel.xml.constants import SHEET_MAIN_NS

from zdppy_excel.comments.comment_sheet import CommentRecord
from zdppy_excel.packaging.relationship import Relationship, RelationshipList
from zdppy_excel.styles.differential import DifferentialStyle
...
from zdppy_excel.cell._writer import write_cell
...
def create_temporary_file(suffix=''):
    fobj = NamedTemporaryFile(mode='w+', suffix=suffix,
                              prefix='zdppy_excel.', delete=False)
    filename = fobj.name
    fobj.close()
...
class WorksheetWriter:
    ...
    def write_sort(self):
        ...
        zdppy_excel never reads it from existing files
        """
        pass
