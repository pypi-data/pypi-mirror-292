...
class Dataset:
    ...
    def publish_to_highlighter(
        ...
        for split_name in self.data_files_df.split.unique():
            ...
            class DatasetType(HLBaseModel):
                id: int

            class CreateDatasetPayload(HLBaseModel):
                dataset: Optional[DatasetType] = None
                errors: list

            class DatasetPayload(HLBaseModel):
                dataset: Optional[DatasetType] = None
                errors: Optional[list] = None

            class SubsAndHashes(HLBaseModel):
                id: int
                hash_signature: str
