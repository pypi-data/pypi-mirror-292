...
import typing
__all__ = ['ABBIRB1200590', 'ABBIRB1300714', 'ABBIRB1600612', 'ABBIRB460060205', 'ABBIRB6700150320', 'ABBYuMiIRB14000', 'CustomRobot', 'DualArm', 'FanucLR10iA10', 'FanucLRMate200iD7L', 'FanucM20iB25', 'FanucM710iC45M', 'FrankaPanda', 'KinovaGen37DoF', 'KukaIiwa7', 'KukaKR6R700sixx', 'KukaKR70R2100', 'MecademicMeca500', 'UfactoryXArm7', 'UniversalUR10', 'UniversalUR10e', 'UniversalUR20', 'UniversalUR5e', 'YaskawaGP12', 'YaskawaGP50', 'YaskawaHC10', 'YaskawaHC20']
...
class CustomRobot(jacobi.RobotArm):
    ...
    Prismatic: typing.ClassVar[CustomRobot.JointType]  # value = <JointType.Prismatic: 2>
    Revolute: typing.ClassVar[CustomRobot.JointType]  # value = <JointType.Revolute: 0>
    joint_axes: list[typing_extensions.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]]
