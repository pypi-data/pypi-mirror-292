...
def main():
    ...
    pyhtmlify_parser = subparsers.add_parser(
        "--version",
        help="Shows version on pyhtmlify.",
        description="Shows the current version  of pyhtmlify is installed."
    )
    ...
    if args.command == "--version":
        print("pyhtmlify: version 0.1.2a2")