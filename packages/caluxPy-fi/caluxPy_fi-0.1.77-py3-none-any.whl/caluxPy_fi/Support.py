...
class Support ():
    ...
    def periodicityConversion(per, mode):
        modes = {
            'normal': {'anual': 1, 'a': 1, '6': 1, 'vencimiento': 1, 'v': 1, '7': 1, 'semestral': 2, 's': 2, '5': 2,
                       'cuatrimestral': 3, 'c': 3, '4': 3, 'trimestral': 4, 't': 4, '3': 4, 'bimensual': 6, 'b': 6, '2': 6,
                       'mensual': 12, 'm': 12, '1': 12},
            'amortization': {'anual': 12, 'a': 12, '6': 12, 'vencimiento': 12, 'v': 12, '7': 12, 'semestral': 6, 's': 6, '5': 6,
                             'cuatrimestral': 4, 'c': 4, '4': 4, 'trimestral': 3, 't': 3, '3': 3, 'bimensual': 2, 'b': 2, '2': 2,
                             'mensual': 1, 'm': 1, '1': 1}
        }
        return modes[mode].get(per, 1), per
