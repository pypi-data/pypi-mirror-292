...
DESC_NOTE = 'Note: All arguments following the export options are optional. If an argument is omitted, a default path will be automatically generated based on the provided positional arguments.'
