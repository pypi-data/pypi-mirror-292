...
async def cloud_chat(
    ...
    if(chat_history):
        question = f"""Given the following conversation and a follow up question, rephrase the follow up question to be a standalone question, in its original language and answer to the question.
            Chat History:
            {chat_history}
            Follow Up Input: {question}
            """
