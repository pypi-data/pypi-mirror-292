# TODO: Delete this one when we create the customization general
# method, including texts, colors, position, etc.
# We will make a detailed description of each available greenscreen
# so we read that description, download the file from Google Drive
# and start using it and replacing texts or any customizable
# element they have.
#
# I keep this one by now because it is custom and I want to use it
# as inspiration while I build the general greenscreen detail
# system.
...
class YoutubeVideoGreenScreen:
    ...
    def __init__(self, title):
        filename = download_file_from_google_drive(YOUTUBE_VIDEO_GREEN_SCREEN_GOOGLE_DRIVE_DOWNLOAD_URL, create_tmp_filename('tmp.jpg'))
