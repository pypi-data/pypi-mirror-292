...
# TODO: Improve this and allow passing a frame_number only, as I know
# the fps by the provided video.
# TODO: Make this work with frames (I know video duration and fps
# so I can calculate it)
def extract_frame_from_video(video_input: Union[VideoFileClip, str], time: float, output_filename: str = None):
    """
    ...
    return video_input.get_frame(t = time)