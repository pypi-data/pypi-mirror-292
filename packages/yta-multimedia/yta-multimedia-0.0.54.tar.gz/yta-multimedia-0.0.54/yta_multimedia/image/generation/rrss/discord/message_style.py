...
class DiscordMessageImageGenerator():
    ...
    def __build_string_json(self, username: str, user_avatar_url: str, message: str):
        """
    ...
    def generate(self, username: str, user_avatar_url: str, message: str, badge_text: str = None, datetime_text: str = None, output_filename: str = None):
        """
        ...
        json_string = self.__build_string_json(username, user_avatar_url, message)
