...
class AdsConnection:
    ...
    """
    def __init__(self, DataDirectory : str, Uid : str, Pwd : str):
        """__init__
        ...
        try:
            self._connection = pyodbc.connect('DRIVER={Advantage StreamlineSQL ODBC};DataDirectory='+self._datadirectory+';UID='+self._uid+';PWD='+self._pwd+';TrimTrailingSpaces=TRUE;ServerType=REMOTE;')
