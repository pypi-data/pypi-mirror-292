...
class AgentConfig(Mapping):
    ...
    def should_apply_policy_rewrites(self):
        return self.should_rewrite and self.get("agent.python.policy_rewrite")

    @cached_property
    def should_enable_sys_monitoring(self):
        return self.get("agent.python.enable_sys_monitoring")
    ...
    def application_activity_polling_interval(self):
        return self.get("agent.polling.app_activity_ms")
