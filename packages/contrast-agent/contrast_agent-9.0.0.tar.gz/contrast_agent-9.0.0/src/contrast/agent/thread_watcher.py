...
def _check_server_settings_poll(threads_by_name, reporting_client):
    # PERF: this is a critical section (inside of a lock). Be mindful!
    ...
    settings.establish_server_settings_poll(reporting_client)
...
def _check_reporting_client(threads_by_name, agent_state_module):
    ...
    agent_state_module.reporting_client = ReportingClient()
