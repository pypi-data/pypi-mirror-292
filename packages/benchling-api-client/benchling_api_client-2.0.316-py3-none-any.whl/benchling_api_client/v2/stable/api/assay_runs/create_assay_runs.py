...
def _parse_response(*, response: httpx.Response) -> Optional[AssayRunsBulkCreateResponse]:
...
def _build_response(*, response: httpx.Response) -> Response[AssayRunsBulkCreateResponse]:
    return Response(
...
def sync_detailed(
    *,
    client: Client,
    json_body: AssayRunsBulkCreateRequest,
) -> Response[AssayRunsBulkCreateResponse]:
    kwargs = _get_kwargs(
        client=client,
        json_body=json_body,
    )
...
def sync(
    *,
    client: Client,
    json_body: AssayRunsBulkCreateRequest,
) -> Optional[AssayRunsBulkCreateResponse]:
