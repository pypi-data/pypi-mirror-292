...
from ..models.event_created_webhook_v0_beta_type import EventCreatedWebhookV0BetaType
...
T = TypeVar("T", bound="EventCreatedWebhookV0Beta")


@attr.s(auto_attribs=True, repr=False)
class EventCreatedWebhookV0Beta:
    """  """
    ...
    _type: EventCreatedWebhookV0BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EventCreatedWebhookV0Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EventCreatedWebhookV0BetaType:
            _type = d.pop("type")
            try:
                type = EventCreatedWebhookV0BetaType(_type)
            except ValueError:
                type = EventCreatedWebhookV0BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EventCreatedWebhookV0BetaType, UNSET)
        ...
        event_created_webhook_v0_beta = cls(
            event=event,
            type=type,
        ...
        event_created_webhook_v0_beta.additional_properties = d
        return event_created_webhook_v0_beta
    ...
    @property
    def type(self) -> EventCreatedWebhookV0BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EventCreatedWebhookV0BetaType) -> None:
        self._type = value
