...
cli.add_typer(
    app,
    name="app",
    help="Manage apps. See a list of apps, app details and scale apps. Run `cerebrium app --help` for usage information.",
)
cli.add_typer(
    project_app,
    name="project",
    help="Manage projects. Run `cerebrium project --help` for usage information.",
)
