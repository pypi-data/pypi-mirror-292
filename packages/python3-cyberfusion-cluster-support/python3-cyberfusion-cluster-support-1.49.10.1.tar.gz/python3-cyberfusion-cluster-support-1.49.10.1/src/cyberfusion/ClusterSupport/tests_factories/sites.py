...
class SiteFactory(BaseBackendFactory):
    ...
    netbox_admin_prefix_ipv4_id = factory.Faker(
        "random_int", min=500, max=2000
    )
    netbox_admin_prefix_ipv6_id = factory.Faker(
        "random_int", min=500, max=2000
    )
    ...
    netbox_default_vm_cluster_id = factory.Faker(
        "random_int", min=500, max=2000
    )
    netbox_borg_server_vm_cluster_id = factory.Faker(
        "random_int", min=500, max=2000
    )
