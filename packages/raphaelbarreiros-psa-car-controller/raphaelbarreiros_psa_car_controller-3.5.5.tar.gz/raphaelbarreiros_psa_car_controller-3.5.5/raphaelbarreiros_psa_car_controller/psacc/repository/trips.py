...
from raphaelbarreiros_psa_car_controller.psacc.application.trip_parser import TripParser

from raphaelbarreiros_psa_car_controller.psacc.model.trip import Trip
