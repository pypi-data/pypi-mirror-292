...
import raphaelbarreiros_psa_car_controller
from oauth2_client.credentials_manager import OAuthError

from .charge_control import ChargeControls
from .charging import Charging
from raphaelbarreiros_psa_car_controller.psacc.repository.config_repository import ConfigRepository
from raphaelbarreiros_psa_car_controller.psacc.repository.db import Database
from raphaelbarreiros_psa_car_controller.psacc.utils.utils import Singleton
from .psa_client import PSAClient
from raphaelbarreiros_psa_car_controller.common.mylogger import my_logger
from raphaelbarreiros_psa_car_controller.psa.otp.otp import CONFIG_NAME as OTP_CONFIG_NAME, ConfigException
...
def parse_args():
    ...
    parser.add_argument('--version', action='version', version='PSACC {}'.format(raphaelbarreiros_psa_car_controller.__version__))
