...
def run_periorbital_pipeline(img=None, img_path=None, full_face=False, model='combined', img_name='default', user_data_dict=None, user_segmentation_mask=None, user_merged_mask=None):
    """
