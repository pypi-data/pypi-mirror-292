...
def output(text:str|list,style:str="",end:str="\n",sep:str=" ",animation:bool=True,delay:float=0.01,use_rich:bool=True,\
delay_between_lines:float=0.0)->None:
    if isinstance(text,str):

        if animation:
            for letter in text: #Print the main text
                if use_rich:
            ...
            if use_rich: #Print the end
                console.print(style=style,end=end)
            else:
                print(end=end)
        ...
        if animation:
            for line in text: #Print each line
                for letter in line: #Print each letter
            ...
            for line in text:
                if use_rich:
                    console.print(line,style=style,end=sep)
                else:
                    print(line,end=sep)
        ...
        raise ValueError("The argument 'text' must be a string or a list.")