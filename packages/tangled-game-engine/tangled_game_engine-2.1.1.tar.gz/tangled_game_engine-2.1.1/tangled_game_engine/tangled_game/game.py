...
class Game:
    ...
    def __get_player_node(self, player_index: int = 0) -> int:
        """
    ...
    def is_game_over(self) -> bool:
        ...
        if any(edge.state == Edge.State.NONE for edge in self.edges):
            return False
        return self.__get_player_node(1) != -1 and self.__get_player_node(2) != -1
    ...
    def get_game_state(self) -> Dict[str, any]:
        ...
        game_state = {
            ...
            "player1_node":  self.__get_player_node(1),
            "player2_node": self.__get_player_node(2),
        }
        return game_state
