...
def sparta_64293ed5da(user_obj):
	B=user_obj
	...
	return A
def sparta_a6bc8d1873(json_data,user_obj):
...
def sparta_e4d2b0bf9b(json_data,user_obj):
...
def sparta_18cd5c89d8(json_data,user_obj):
	...
	return{_C:1}
def sparta_e4f6e01e93(json_data,user_obj):
