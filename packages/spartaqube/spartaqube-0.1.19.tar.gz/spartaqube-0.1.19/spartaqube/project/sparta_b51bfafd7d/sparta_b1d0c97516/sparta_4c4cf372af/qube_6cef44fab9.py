...
plot_example"""}]
def sparta_be9a0fe0da():return sparta_a664dec1f4(type=_N)
def sparta_4f55a42203():return sparta_a664dec1f4(type='gauge2')
def sparta_4f14e5144f():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
