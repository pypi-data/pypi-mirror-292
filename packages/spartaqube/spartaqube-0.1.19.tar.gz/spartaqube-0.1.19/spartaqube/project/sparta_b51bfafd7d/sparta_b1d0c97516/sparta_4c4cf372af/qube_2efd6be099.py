...
def sparta_c70062bee5(type='candlestick'):
...
plot_example"""}]
def sparta_a664dec1f4(type='line2'):
	if conf_settings.IS_DEV:A=_E
	else:A=_F
...
plot_example"""}]
def sparta_9c0e76bc12():return sparta_a664dec1f4('line2')
def sparta_af999f98a7():return sparta_a664dec1f4('bar2')
def sparta_afe54cebd4():return sparta_a664dec1f4('area2')
def sparta_845bdd58d7():return sparta_a664dec1f4('lollipop2')
def sparta_59727813d9():
