...
def sparta_c35c8ec67c(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_588e96ca3d(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_06b14865f8(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_588e96ca3d(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_588e96ca3d(currentPath,typeexplorer=None):
...
def sparta_f9ab15769d(currentPath):
