...
def sparta_24fd6cf313(is_owner=_A):return{_F:is_owner,_B:_E,_C:_E,_D:_E}
def sparta_a3ab2600d8():return{_F:_A,_B:_A,_C:_A,_D:_A}
def sparta_17c582155a(user_obj,portfolio_obj):
	B=portfolio_obj;A=user_obj
	if B.user==A:return sparta_24fd6cf313(_E)
	F=qube_5b0b590e98.sparta_e0dadb187d(A);E=[A.userGroup for A in F]
	...
	if D.count()==0:return sparta_a3ab2600d8()
	G=D[0];C=G.ShareRights
	if C.is_delete:return sparta_a3ab2600d8()
	return{_F:_A,_B:C.is_admin,_C:C.has_write_rights,_D:C.has_reshare_rights}
def sparta_04db2b69a9(user_obj,universe_obj):
	B=universe_obj;A=user_obj
	if B.user==A:return sparta_24fd6cf313()
	F=qube_5b0b590e98.sparta_e0dadb187d(A);E=[A.userGroup for A in F]
