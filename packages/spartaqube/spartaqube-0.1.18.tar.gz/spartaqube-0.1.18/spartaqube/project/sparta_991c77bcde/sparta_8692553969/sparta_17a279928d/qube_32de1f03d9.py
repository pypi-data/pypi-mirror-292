...
def sparta_8b57b99b8d(type='candlestick'):
...
plot_example"""}]
def sparta_f168ee99a4(type='line2'):
	if conf_settings.IS_DEV:A=_E
	else:A=_F
...
plot_example"""}]
def sparta_bd7c0708f7():return sparta_f168ee99a4('line2')
def sparta_f7ca37526b():return sparta_f168ee99a4('bar2')
def sparta_318a8275c7():return sparta_f168ee99a4('area2')
def sparta_faaa2259a0():return sparta_f168ee99a4('lollipop2')
def sparta_034d58734a():
