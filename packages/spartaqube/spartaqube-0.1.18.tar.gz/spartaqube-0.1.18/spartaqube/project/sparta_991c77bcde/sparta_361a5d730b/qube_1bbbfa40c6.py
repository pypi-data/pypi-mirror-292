...
def sparta_ab1b8c545c(user_obj):
	B=user_obj
	...
	return A
def sparta_e38639aa97(json_data,user_obj):
...
def sparta_521550b2f0(json_data,user_obj):
...
def sparta_4da6b5d3ea(json_data,user_obj):
	...
	return{_C:1}
def sparta_e1f941ce97(json_data,user_obj):
