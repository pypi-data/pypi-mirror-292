...
from project.sparta_cc504a7958.sparta_b2d3ad9dcb import qube_55cb827e7c,qube_14b4780e54
...
print(channels_ver)
def sparta_02508597df(this_class):
	A=this_class
	if channels_major<=2:return A
	else:return A.as_asgi()
urlpatterns=[url('ws/notebookWS',sparta_02508597df(qube_55cb827e7c.NotebookWS)),url('ws/wssConnectorWS',sparta_02508597df(qube_14b4780e54.WssConnectorWS))]
