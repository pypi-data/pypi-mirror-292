...
from project.sparta_85717823e1.sparta_81c4ad6ab2.qube_3f80c83af4 import IPythonKernel as IPythonKernel
from project.sparta_85717823e1.sparta_81c4ad6ab2.qube_20a053593c import sparta_f17681ea03
	...
	def receive(A,text_data):
		...
		if len(M)>0:
			...
			if B=='init-socket'or B=='reconnect-kernel':E={G:1,F:B};A.start_kernel();D=json.dumps(E);A.send(text_data=D);return
				...
				O=[];P=[]
				for I in C[S]:
					X=A.kernel_obj.get_workspace_variable(kernel_variable=I);J=sparta_9d9c760226(X,variable_name=I);print('workspace_variable_df');print(J);print(type(J))
					try:O.append(sparta_5b3f451ffa(J));P.append(I)
					except:pass
