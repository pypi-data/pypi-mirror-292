...
def sparta_7e21f65576(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_0057866282(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_2b2e6e58e6(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_0057866282(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_0057866282(currentPath,typeexplorer=None):
...
def sparta_ac940d8c33(currentPath):
