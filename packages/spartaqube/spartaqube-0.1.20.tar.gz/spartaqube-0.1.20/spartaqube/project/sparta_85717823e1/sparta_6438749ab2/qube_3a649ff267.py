...
import pytz
UTC=pytz.utc
def sparta_9e0e73f959():0
def sparta_3888c572d1():
...
def sparta_1663e5965b():
	...
	return A
def sparta_ed3ef60168():
	F='res'
	try:
		C=sparta_1663e5965b();A=sparta_3888c572d1();D=AppVersioning.objects.all();E=datetime.now().astimezone(UTC)
