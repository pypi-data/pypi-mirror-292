...
def sparta_583ed403a9(type='candlestick'):
...
plot_example"""}]
def sparta_2bc34f46b0(type='line2'):
	if conf_settings.IS_DEV:A=_E
	else:A=_F
...
plot_example"""}]
def sparta_69028d9572():return sparta_2bc34f46b0('line2')
def sparta_240e08087f():return sparta_2bc34f46b0('bar2')
def sparta_da963614bd():return sparta_2bc34f46b0('area2')
def sparta_ff5a0d9f5c():return sparta_2bc34f46b0('lollipop2')
def sparta_8c0a3e8f84():
