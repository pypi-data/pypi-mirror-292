...
plot_example"""}]
def sparta_6fb083fb78():return sparta_2bc34f46b0(type=_N)
def sparta_3f18281299():return sparta_2bc34f46b0(type='gauge2')
def sparta_82b12b74d1():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
