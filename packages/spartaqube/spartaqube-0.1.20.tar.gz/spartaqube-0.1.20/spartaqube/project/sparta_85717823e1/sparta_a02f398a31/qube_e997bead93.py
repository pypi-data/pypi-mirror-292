...
def sparta_0af22e3cff(user_obj):
	B=user_obj
	...
	return A
def sparta_ab7fae5130(json_data,user_obj):
...
def sparta_1b8c01f019(json_data,user_obj):
...
def sparta_5b774a2750(json_data,user_obj):
	...
	return{_C:1}
def sparta_8d1aaa872a(json_data,user_obj):
