...
Options:
  --algorithm='': the algorithm to use (default: RS512)
  --issuer='': the token issuer (required)
  --subject='': the token subject (required)
  --expiration='': the token expiration date in YYYY/MM/DD format (required)
  --output-file='': the output file (default: stdout)
