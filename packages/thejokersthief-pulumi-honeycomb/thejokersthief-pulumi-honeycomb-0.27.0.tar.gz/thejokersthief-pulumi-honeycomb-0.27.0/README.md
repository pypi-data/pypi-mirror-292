...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `honeycomb` with the `NAME` of your provider.
   - find and replace all instances of the boilerplate `thejokersthief` with the `ORG` of your provider.
   - replace all instances of the `github.com/thejokersthief/pulumi-honeycomb` repository with the `REPOSITORY` location
...
- binary: pulumi-resource-honeycomb
  ...
  ignore: []
  ldflags:
  - -X github.com/thejokersthief/pulumi-honeycomb/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-honeycomb_darwin_amd64_v1
│   └── pulumi-resource-honeycomb
├── pulumi-honeycomb_darwin_arm64
│   └── pulumi-resource-honeycomb
├── pulumi-honeycomb_linux_amd64_v1
│   └── pulumi-resource-honeycomb
├── pulumi-honeycomb_linux_arm64
│   └── pulumi-resource-honeycomb
├── pulumi-honeycomb_windows_amd64_v1
│   └── pulumi-resource-honeycomb.exe
└── pulumi-honeycomb_windows_arm64
    └── pulumi-resource-honeycomb.exe
```
