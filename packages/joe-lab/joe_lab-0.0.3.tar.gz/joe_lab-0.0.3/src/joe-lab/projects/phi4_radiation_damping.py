...
import joe-lab.joe as joe
import joe-lab.models as joe_models
import joe-lab.initial_states as joe_initial_states
from joe-lab.visualization import nice_multiplot
from joe-lab.utils import integrate
...
def L2prod(u1, u2, length=length, N=N):
    ...
    return integrate(u1*u2, length, N) 
