...
class ChatPython:
    ...
    def __init__(self, model="llama-3.1-70b-versatile", temperature=1, max_tokens=1000, top_p=1):
        ...
        self.prompt = ''
        self.file_name = ''
        # Set the root directory to the current working directory where the script is executed
    ...
    def write_code_to_file(self, path):
        ...
        Args:
            path (str): The directory path where the file should be saved. This is relative to the current working directory.
        """
