...
def handle_shared_args(parser):
    ...
    parser.add_argument('--n_small', metavar='12', type=int, default=12, help='Smallest sample size for the subgroups. If "--no_clusters" option is used, it will be overwritten to the higher value of either 0.75 times the case group size or 12 for filtering purposes.')
