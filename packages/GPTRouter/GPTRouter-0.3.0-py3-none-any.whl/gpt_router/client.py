...
class GPTRouterClient:
    ...
    def add_metadata_info(
        ...
        payload.update(
            {
                "metadata": metadata,
                "tag": model_router_metadata.tag if model_router_metadata else None,
                "createdByUserId": model_router_metadata.created_by_user_id,
                "historyId": str(model_router_metadata.history_id) if model_router_metadata.history_id else None,
            }
        )
