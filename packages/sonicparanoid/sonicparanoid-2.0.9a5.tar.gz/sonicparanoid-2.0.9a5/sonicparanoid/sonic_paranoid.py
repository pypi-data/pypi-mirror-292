...
def check_blast_installation(root, info: tuple[str, str], sysOS: str, is_macos: bool = False, debug=False) -> None:
    """Check if blastp and makeblastdb were installed installed."""
    correctVer: str = info[0]
    webpage: str = info[1]
...
def check_dmnd_installation(root, info: tuple[str, str], sysOS: str, is_macos: bool = False, debug=False) -> None:
...
def check_mmseqs_installation(root, info: tuple[str, str], sysOS: str, is_macos: bool = False, debug=False) -> None:
...
def check_mcl_installation(currentDir:str, info: tuple[str, str], sysOS: str, is_macos: bool = False, debug=False) -> bool:
