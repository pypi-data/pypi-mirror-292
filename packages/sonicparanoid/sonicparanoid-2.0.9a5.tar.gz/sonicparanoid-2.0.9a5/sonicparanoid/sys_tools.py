...
def get_binaries_info() -> dict[str, tuple[str, str]]:
    ...
    bin2info: dict[str, tuple[str, str]] = {}
    # Blast
    correctVer: str = "2.15.0+" # as of SonicParanoid 2.0.9
    ...
    correctVer = "45111b641859ed0ddd875b94d6fd1aef1a675b7e" # as of SonicParanoid 2.0.8
