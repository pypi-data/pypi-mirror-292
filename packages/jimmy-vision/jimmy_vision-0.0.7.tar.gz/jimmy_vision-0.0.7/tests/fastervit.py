...
class PosEmbMLPSwinv1D(nn.Module):
    ...
    def forward(self, input_tensor):
        print("[POS EMBED] x.shape", input_tensor.shape)
...
"""
X0 torch.Size([2, 64, 56, 56])
X0 torch.Size([2, 128, 28, 28])
CT0 torch.Size([2, 16, 256])
X0 torch.Size([2, 256, 14, 14])
X1 torch.Size([8, 49, 256])
    _ct_dewindow_in torch.Size([2, 16, 256])
    _ct_dewindow_out torch.Size([2, 16, 256])
    _ct_window_in torch.Size([2, 16, 256])
    _ct_window_out torch.Size([2, 2, 2, 2, 2, 256])
X2 torch.Size([8, 49, 256])
CT torch.Size([2, 16, 256])
    _ct_dewindow_in torch.Size([2, 16, 256])
    _ct_dewindow_out torch.Size([2, 16, 256])
    _ct_window_in torch.Size([2, 16, 256])
    _ct_window_out torch.Size([2, 2, 2, 2, 2, 256])
...
X2 torch.Size([8, 49, 256])
CT torch.Size([2, 16, 256])
X3 torch.Size([2, 256, 14, 14])
X0 torch.Size([2, 512, 7, 7])
X1 torch.Size([2, 49, 512])
X3 torch.Size([2, 512, 7, 7]
"""
