...
class AppendixAParser:
    ...
    def set_cell_text(self, cell: Any):
        ...
        self.processed_texts = [
            self._process_text_element(element.text) for element in self.text_elements if element.text
        ]
        self.joined_processed_texts = " ".join(self.processed_texts)
    ...
    def get_cell_text(self, cell: Any) -> str:
        ...
        processed_texts = [self._process_text_element(element.text) for element in text_elements if element.text]
