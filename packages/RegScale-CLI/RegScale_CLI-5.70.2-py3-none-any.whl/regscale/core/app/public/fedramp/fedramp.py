...
@regscale_id()
@regscale_module()
def import_fedramp_poam_template(file_path: click.Path, regscale_id: int, regscale_module: str) -> None:
    """
    ...
    POAM(file_path=file_path, module_id=regscale_id, module=regscale_module)
