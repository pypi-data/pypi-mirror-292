...
def set_control_loop_freq_div(server_ip, position_loop_freq_div, velocity_loop_freq_div, current_loop_freq_div):
    data = {
        "method": "SET",
        ...
        "current_loop_freq_div": current_loop_freq_div
    }
